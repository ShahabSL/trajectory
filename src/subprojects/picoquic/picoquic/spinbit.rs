...
#[no_mangle]
pub unsafe extern "C" fn picoquic_spinbit_basic_incoming(
    mut cnx: *mut picoquic_cnx_t,
    mut path_x: *mut picoquic_path_t,
    mut ph: *mut picoquic_packet_header,
) {
    (*path_x).set_current_spin(
        ((*ph).spin() as ::core::ffi::c_int ^ (*cnx).client_mode() as ::core::ffi::c_int)
            as ::core::ffi::c_uint as ::core::ffi::c_uint,
    );
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_spinbit_basic_outgoing(mut cnx: *mut picoquic_cnx_t) -> uint8_t {
    let mut spin_bit: uint8_t = (((**(*cnx).path.offset(0 as ::core::ffi::c_int as isize))
        .current_spin() as ::core::ffi::c_int)
        << 5 as ::core::ffi::c_int) as uint8_t;
    return spin_bit;
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_spinbit_null_incoming(
    mut cnx: *mut picoquic_cnx_t,
    mut path_x: *mut picoquic_path_t,
    mut ph: *mut picoquic_packet_header,
) {
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_spinbit_null_outgoing(mut cnx: *mut picoquic_cnx_t) -> uint8_t {
    return 0 as uint8_t;
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_spinbit_random_incoming(
    mut cnx: *mut picoquic_cnx_t,
    mut path_x: *mut picoquic_path_t,
    mut ph: *mut picoquic_packet_header,
) {
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_spinbit_random_outgoing(mut cnx: *mut picoquic_cnx_t) -> uint8_t {
    return (picoquic_public_random_64() & 0x20 as uint64_t) as uint8_t;
}
#[no_mangle]
pub static mut picoquic_spin_function_table: [picoquic_spinbit_def_t; 3] = unsafe {
    [
        st_picoquic_spinbit_def_t {
            spinbit_incoming: Some(
                picoquic_spinbit_basic_incoming
            ...
            spinbit_outgoing: Some(
                picoquic_spinbit_basic_outgoing
                    as unsafe extern "C" fn(*mut picoquic_cnx_t) -> uint8_t,
            ),
        },
        st_picoquic_spinbit_def_t {
            spinbit_incoming: Some(
                picoquic_spinbit_random_incoming
                    as unsafe extern "C" fn(
                        *mut picoquic_cnx_t,
                        *mut picoquic_path_t,
                        *mut picoquic_packet_header,
            ...
            spinbit_outgoing: Some(
                picoquic_spinbit_random_outgoing
                    as unsafe extern "C" fn(*mut picoquic_cnx_t) -> uint8_t,
            ),
        },
        st_picoquic_spinbit_def_t {
            spinbit_incoming: Some(
                picoquic_spinbit_null_incoming
                    as unsafe extern "C" fn(
                        *mut picoquic_cnx_t,
                        *mut picoquic_path_t,
                        *mut picoquic_packet_header,
            ...
            spinbit_outgoing: Some(
                picoquic_spinbit_null_outgoing
                    as unsafe extern "C" fn(*mut picoquic_cnx_t) -> uint8_t,
            ),
        },
    ]
