...
extern "C" {
    ...
    fn picoquic_remember_issued_ticket(
        quic: *mut picoquic_quic_t,
        ticket_id: uint64_t,
        rtt: uint64_t,
        cwin: uint64_t,
    ...
    fn picoquic_get_tls_time(quic: *mut picoquic_quic_t) -> uint64_t;
...
pub const picoquic_tp_0rtt_cwin_remote: C2Rust_Unnamed = 9;
pub const picoquic_tp_0rtt_rtt_remote: C2Rust_Unnamed = 8;
pub const picoquic_tp_0rtt_cwin_local: C2Rust_Unnamed = 7;
pub const picoquic_tp_0rtt_rtt_local: C2Rust_Unnamed = 6;
pub const picoquic_tp_0rtt_max_streams_id_unidir: C2Rust_Unnamed = 5;
pub const picoquic_tp_0rtt_max_streams_id_bidir: C2Rust_Unnamed = 4;
pub const picoquic_tp_0rtt_max_stream_data_uni: C2Rust_Unnamed = 3;
pub const picoquic_tp_0rtt_max_stream_data_bidi_remote: C2Rust_Unnamed = 2;
pub const picoquic_tp_0rtt_max_stream_data_bidi_local: C2Rust_Unnamed = 1;
pub const picoquic_tp_0rtt_max_data: C2Rust_Unnamed = 0;
...
pub const PICOQUIC_ERROR_INVALID_TICKET: ::core::ffi::c_int =
    PICOQUIC_ERROR_CLASS + 23 as ::core::ffi::c_int;
pub const PICOQUIC_ERROR_INVALID_FILE: ::core::ffi::c_int =
    PICOQUIC_ERROR_CLASS + 24 as ::core::ffi::c_int;
...
pub const PICOQUIC_NB_TP_0RTT: ::core::ffi::c_int = 10 as ::core::ffi::c_int;
pub const NULL: *mut ::core::ffi::c_void =
    ::core::ptr::null::<::core::ffi::c_void>() as *mut ::core::ffi::c_void;
pub const ENOENT: ::core::ffi::c_int = 2 as ::core::ffi::c_int;
#[no_mangle]
pub unsafe extern "C" fn picoquic_format_ticket(
    mut time_valid_until: uint64_t,
    mut sni: *const ::core::ffi::c_char,
    mut sni_length: uint16_t,
    mut alpn: *const ::core::ffi::c_char,
    mut alpn_length: uint16_t,
    mut version: uint32_t,
    mut ip_addr: *const uint8_t,
    mut ip_addr_length: uint8_t,
    mut ip_addr_client: *const uint8_t,
    mut ip_addr_client_length: uint8_t,
    mut ticket: *mut uint8_t,
    mut ticket_length: uint16_t,
    mut tp: *const picoquic_tp_t,
) -> *mut picoquic_stored_ticket_t {
    let mut ticket_size: size_t = (::core::mem::size_of::<picoquic_stored_ticket_t>() as size_t)
        .wrapping_add(sni_length as size_t)
        .wrapping_add(1 as size_t)
        .wrapping_add(alpn_length as size_t)
        .wrapping_add(1 as size_t)
        .wrapping_add(ticket_length as size_t)
        .wrapping_add(1 as size_t)
        .wrapping_add((2 as ::core::ffi::c_int * PICOQUIC_STORED_IP_MAX) as size_t);
    let mut stored: *mut picoquic_stored_ticket_t =
        malloc(ticket_size) as *mut picoquic_stored_ticket_t;
    if !stored.is_null() {
        let mut next_p: *mut ::core::ffi::c_char = (stored as *mut ::core::ffi::c_char)
            .offset(::core::mem::size_of::<picoquic_stored_ticket_t>() as usize as isize);
        memset(
            stored as *mut ::core::ffi::c_void,
            0 as ::core::ffi::c_int,
            ticket_size,
        );
        ...
        memcpy(
            next_p as *mut ::core::ffi::c_void,
            sni as *const ::core::ffi::c_void,
            sni_length as size_t,
        );
        next_p = next_p.offset(sni_length as ::core::ffi::c_int as isize);
        let c2rust_fresh2 = next_p;
        next_p = next_p.offset(1);
        *c2rust_fresh2 = 0 as ::core::ffi::c_char;
        (*stored).alpn = next_p;
        (*stored).alpn_length = alpn_length;
        memcpy(
            next_p as *mut ::core::ffi::c_void,
            alpn as *const ::core::ffi::c_void,
            alpn_length as size_t,
        );
        next_p = next_p.offset(alpn_length as ::core::ffi::c_int as isize);
        let c2rust_fresh3 = next_p;
        next_p = next_p.offset(1);
        *c2rust_fresh3 = 0 as ::core::ffi::c_char;
        (*stored).version = version;
        (*stored).ip_addr = next_p as *mut uint8_t;
        if ip_addr.is_null() || ip_addr_length as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
            (*stored).ip_addr_length = 0 as uint8_t;
        } else {
        ...
        next_p = next_p.offset(PICOQUIC_STORED_IP_MAX as isize);
        (*stored).ip_addr_client = next_p as *mut uint8_t;
        if ip_addr_client.is_null()
            || ip_addr_client_length as ::core::ffi::c_int == 0 as ::core::ffi::c_int
        {
            (*stored).ip_addr_length = 0 as uint8_t;
        } else {
            if ip_addr_client_length as ::core::ffi::c_int > PICOQUIC_STORED_IP_MAX {
                ip_addr_client_length = PICOQUIC_STORED_IP_MAX as uint8_t;
            }
            (*stored).ip_addr_client_length = ip_addr_client_length;
            memcpy(
                next_p as *mut ::core::ffi::c_void,
                ip_addr_client as *const ::core::ffi::c_void,
                ip_addr_client_length as size_t,
            );
        }
        next_p = next_p.offset(PICOQUIC_STORED_IP_MAX as isize);
        if !tp.is_null() {
            (*stored).tp_0rtt[picoquic_tp_0rtt_max_data as ::core::ffi::c_int as usize] =
                (*tp).initial_max_data;
            (*stored).tp_0rtt
        ...
        (*stored).ticket = next_p as *mut uint8_t;
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_serialize_ticket(
    mut ticket: *const picoquic_stored_ticket_t,
    ...
    let mut required_length: size_t = 0;
    required_length = ((8 as ::core::ffi::c_int
        + 2 as ::core::ffi::c_int
        + 2 as ::core::ffi::c_int
        + 2 as ::core::ffi::c_int
        + 4 as ::core::ffi::c_int
        ...
        .wrapping_add((*ticket).sni_length as size_t)
        .wrapping_add((*ticket).alpn_length as size_t)
        .wrapping_add((*ticket).ticket_length as size_t)
        .wrapping_add((*ticket).ip_addr_length as size_t)
        .wrapping_add((*ticket).ip_addr_client_length as size_t)
        .wrapping_add((8 as ::core::ffi::c_int * PICOQUIC_NB_TP_0RTT) as size_t);
    if required_length > bytes_max {
        ...
        *consumed = 0 as size_t;
        ...
        picoformat_64(
            ...
            (*ticket).time_valid_until,
        );
        byte_index = byte_index.wrapping_add(8 as size_t);
        picoformat_16(bytes.offset(byte_index as isize), (*ticket).sni_length);
        byte_index = byte_index.wrapping_add(2 as size_t);
        memcpy(
            bytes.offset(byte_index as isize) as *mut ::core::ffi::c_void,
            (*ticket).sni as *const ::core::ffi::c_void,
            (*ticket).sni_length as size_t,
        );
        byte_index = byte_index.wrapping_add((*ticket).sni_length as size_t);
        picoformat_16(bytes.offset(byte_index as isize), (*ticket).alpn_length);
        byte_index = byte_index.wrapping_add(2 as size_t);
        memcpy(
            bytes.offset(byte_index as isize) as *mut ::core::ffi::c_void,
            (*ticket).alpn as *const ::core::ffi::c_void,
            (*ticket).alpn_length as size_t,
        );
        byte_index = byte_index.wrapping_add((*ticket).alpn_length as size_t);
        picoformat_32(bytes.offset(byte_index as isize), (*ticket).version);
        byte_index = byte_index.wrapping_add(4 as size_t);
        let c2rust_fresh0 = byte_index;
        byte_index = byte_index.wrapping_add(1);
        *bytes.offset(c2rust_fresh0 as isize) = (*ticket).ip_addr_length;
        if (*ticket).ip_addr_length as ::core::ffi::c_int > 0 as ::core::ffi::c_int {
            memcpy(
                bytes.offset(byte_index as isize) as *mut ::core::ffi::c_void,
                (*ticket).ip_addr as *const ::core::ffi::c_void,
                (*ticket).ip_addr_length as size_t,
            );
            byte_index = byte_index.wrapping_add((*ticket).ip_addr_length as size_t);
        }
        let c2rust_fresh1 = byte_index;
        byte_index = byte_index.wrapping_add(1);
        *bytes.offset(c2rust_fresh1 as isize) = (*ticket).ip_addr_client_length;
        if (*ticket).ip_addr_client_length as ::core::ffi::c_int > 0 as ::core::ffi::c_int {
            memcpy(
                bytes.offset(byte_index as isize) as *mut ::core::ffi::c_void,
                (*ticket).ip_addr_client as *const ::core::ffi::c_void,
                (*ticket).ip_addr_client_length as size_t,
            );
            byte_index = byte_index.wrapping_add((*ticket).ip_addr_client_length as size_t);
        }
        let mut i: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
        while i < PICOQUIC_NB_TP_0RTT {
            picoformat_64(
                bytes.offset(byte_index as isize),
                (*ticket).tp_0rtt[i as usize],
            );
            byte_index = byte_index.wrapping_add(8 as size_t);
            i += 1;
        }
        picoformat_16(bytes.offset(byte_index as isize), (*ticket).ticket_length);
        byte_index = byte_index.wrapping_add(2 as size_t);
        memcpy(
            bytes.offset(byte_index as isize) as *mut ::core::ffi::c_void,
            (*ticket).ticket as *const ::core::ffi::c_void,
            (*ticket).ticket_length as size_t,
        );
        byte_index = byte_index.wrapping_add((*ticket).ticket_length as size_t);
        *consumed = byte_index;
    }
    return ret;
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_deserialize_ticket(
    mut ticket: *mut *mut picoquic_stored_ticket_t,
    mut bytes: *mut uint8_t,
    mut bytes_max: size_t,
    mut consumed: *mut size_t,
) -> ::core::ffi::c_int {
    let mut ret: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut time_valid_until: uint64_t = 0 as uint64_t;
    let mut required_length: size_t = (8 as ::core::ffi::c_int
        + 2 as ::core::ffi::c_int
        + 2 as ::core::ffi::c_int
        + 4 as ::core::ffi::c_int
        + 1 as ::core::ffi::c_int
        + 1 as ::core::ffi::c_int
        + PICOQUIC_NB_TP_0RTT * 8 as ::core::ffi::c_int
        + 2 as ::core::ffi::c_int) as size_t;
    let mut byte_index: size_t = 0 as size_t;
    let mut sni_index: size_t = 0 as size_t;
    let mut alpn_index: size_t = 0 as size_t;
    let mut ip_addr_index: size_t = 0 as size_t;
    let mut ip_addr_client_index: size_t = 0 as size_t;
    let mut ticket_index: size_t = 0 as size_t;
    let mut sni_length: uint16_t = 0 as uint16_t;
    let mut alpn_length: uint16_t = 0 as uint16_t;
    let mut version: uint32_t = 0 as uint32_t;
    let mut ticket_length: uint16_t = 0 as uint16_t;
    let mut ip_addr_length: uint8_t = 0 as uint8_t;
    let mut ip_addr_client_length: uint8_t = 0 as uint8_t;
    let mut tp_0rtt: [uint64_t; 10] = [
    ...
    *consumed = 0 as size_t;
    *ticket = ::core::ptr::null_mut::<picoquic_stored_ticket_t>();
    if required_length < bytes_max {
        time_valid_until = (((((*bytes.offset(0 as ::core::ffi::c_int as isize) as uint16_t
            as ::core::ffi::c_int)
            << 8 as ::core::ffi::c_int
        ...
        required_length = required_length.wrapping_add(sni_length as size_t);
        byte_index = byte_index.wrapping_add(sni_length as size_t);
    }
    if required_length < bytes_max {
        alpn_length = ((*bytes
            .offset(byte_index as isize)
        ...
        required_length = required_length.wrapping_add(alpn_length as size_t);
        byte_index = byte_index.wrapping_add(alpn_length as size_t);
    }
    if required_length < bytes_max {
        version = (((*bytes
            .offset(byte_index as isize)
    ...
    if required_length < bytes_max {
        ...
        byte_index = byte_index.wrapping_add(1);
        ip_addr_length = *bytes.offset(c2rust_fresh4 as isize);
        ip_addr_index = byte_index;
        required_length = required_length.wrapping_add(ip_addr_length as size_t);
        byte_index = byte_index.wrapping_add(ip_addr_length as size_t);
    }
    if required_length < bytes_max {
        let c2rust_fresh5 = byte_index;
        byte_index = byte_index.wrapping_add(1);
        ip_addr_client_length = *bytes.offset(c2rust_fresh5 as isize);
        ip_addr_client_index = byte_index;
        required_length = required_length.wrapping_add(ip_addr_client_length as size_t);
        byte_index = byte_index.wrapping_add(ip_addr_client_length as size_t);
    }
    if required_length < bytes_max {
        let mut i: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
        while i < PICOQUIC_NB_TP_0RTT {
            tp_0rtt[i as usize] = (((((*bytes
                .offset(byte_index as isize)
    ...
    if required_length < bytes_max {
        ...
        required_length = required_length.wrapping_add(ticket_length as size_t);
    }
    if required_length > bytes_max {
        *ticket = ::core::ptr::null_mut::<picoquic_stored_ticket_t>();
        ret = PICOQUIC_ERROR_INVALID_TICKET;
    } else {
        *ticket = picoquic_format_ticket(
            time_valid_until,
            bytes.offset(sni_index as isize) as *const ::core::ffi::c_char,
            sni_length,
            bytes.offset(alpn_index as isize) as *const ::core::ffi::c_char,
            alpn_length,
            version,
            bytes.offset(ip_addr_index as isize) as *const uint8_t,
            ip_addr_length,
            bytes.offset(ip_addr_client_index as isize) as *const uint8_t,
            ip_addr_client_length,
            bytes.offset(ticket_index as isize),
            ticket_length,
            ::core::ptr::null::<picoquic_tp_t>(),
        );
        if (*ticket).is_null() {
            ret = PICOQUIC_ERROR_MEMORY;
        } else {
            let mut i_0: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
            while i_0 < PICOQUIC_NB_TP_0RTT {
                (**ticket).tp_0rtt[i_0 as usize] = tp_0rtt[i_0 as usize];
                i_0 += 1;
            }
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_store_ticket(
    ...
    let mut current_time: uint64_t = picoquic_get_tls_time(quic);
    let mut pp_first_ticket: *mut *mut picoquic_stored_ticket_t = &raw mut (*quic).p_first_ticket;
    let mut ret: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    if (ticket_length as ::core::ffi::c_int) < 17 as ::core::ffi::c_int {
        ret = PICOQUIC_ERROR_INVALID_TICKET;
    } else {
        let mut ticket_issued_time: uint64_t = 0;
        let mut ttl_seconds: uint64_t = 0;
        let mut time_valid_until: uint64_t = 0;
        ticket_issued_time = (((((*ticket.offset(0 as ::core::ffi::c_int as isize) as uint16_t
            as ::core::ffi::c_int)
            << 8 as ::core::ffi::c_int
        ...
        ttl_seconds = ((((*ticket
            ...
            | ((*ticket
                ...
                | *ticket
                    ...
                    as ::core::ffi::c_int) as uint32_t) as uint64_t;
        if ttl_seconds
            > (7 as ::core::ffi::c_int * 24 as ::core::ffi::c_int * 3600 as ::core::ffi::c_int)
                as uint64_t
        {
            ttl_seconds = (7 as ::core::ffi::c_int
                * 24 as ::core::ffi::c_int
                * 3600 as ::core::ffi::c_int) as uint64_t;
        }
        time_valid_until = ticket_issued_time
            .wrapping_mul(1000 as uint64_t)
            .wrapping_add(ttl_seconds.wrapping_mul(1000000 as uint64_t));
        if current_time != 0 as uint64_t && time_valid_until < current_time {
            ret = PICOQUIC_ERROR_INVALID_TICKET;
        } else {
            let mut stored: *mut picoquic_stored_ticket_t = picoquic_format_ticket(
                time_valid_until,
                sni,
                sni_length,
                alpn,
            ...
            if stored.is_null() {
                ...
                let mut next: *mut picoquic_stored_ticket_t =
                    ::core::ptr::null_mut::<picoquic_stored_ticket_t>();
                let mut pprevious: *mut *mut picoquic_stored_ticket_t =
                    ::core::ptr::null_mut::<*mut picoquic_stored_ticket_t>();
                next = *pp_first_ticket;
                (*stored).next_ticket = next as *mut st_picoquic_stored_ticket_t;
                *pp_first_ticket = stored;
                pprevious = &raw mut (*stored).next_ticket as *mut *mut picoquic_stored_ticket_t;
                while !next.is_null() {
                    if (*next).time_valid_until <= (*stored).time_valid_until
                        && (*next).sni_length as ::core::ffi::c_int
                            == sni_length as ::core::ffi::c_int
                        && (*next).alpn_length as ::core::ffi::c_int
                            == alpn_length as ::core::ffi::c_int
                        && memcmp(
                            (*next).sni as *const ::core::ffi::c_void,
                            sni as *const ::core::ffi::c_void,
                            sni_length as size_t,
                        ) == 0 as ::core::ffi::c_int
                        && memcmp(
                            (*next).alpn as *const ::core::ffi::c_void,
                            alpn as *const ::core::ffi::c_void,
                            alpn_length as size_t,
                        ) == 0 as ::core::ffi::c_int
                        && (*next).version == version
                    {
                        let mut deleted: *mut picoquic_stored_ticket_t = next;
                        next = (*next).next_ticket as *mut picoquic_stored_ticket_t;
                        *pprevious = next;
                        memset(
                            &raw mut (*deleted).ticket as *mut ::core::ffi::c_void,
                            0 as ::core::ffi::c_int,
                            (*deleted).ticket_length as size_t,
                        );
                        free(deleted as *mut ::core::ffi::c_void);
                    } else {
                        pprevious =
                            &raw mut (*next).next_ticket as *mut *mut picoquic_stored_ticket_t;
                        next = (*next).next_ticket as *mut picoquic_stored_ticket_t;
                    }
                }
            }
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_get_stored_ticket(
    mut quic: *mut picoquic_quic_t,
    mut sni: *const ::core::ffi::c_char,
    mut sni_length: uint16_t,
    mut alpn: *const ::core::ffi::c_char,
    mut alpn_length: uint16_t,
    mut version: uint32_t,
    mut need_unused: ::core::ffi::c_int,
    mut ticket_id: uint64_t,
) -> *mut picoquic_stored_ticket_t {
    let mut next: *mut picoquic_stored_ticket_t = (*quic).p_first_ticket;
    let mut current_time: uint64_t = picoquic_get_tls_time(quic);
    while !next.is_null() {
        if (*next).time_valid_until > current_time
            && (*next).sni_length as ::core::ffi::c_int == sni_length as ::core::ffi::c_int
            && (*next).alpn_length as ::core::ffi::c_int == alpn_length as ::core::ffi::c_int
            && memcmp(
                (*next).sni as *const ::core::ffi::c_void,
                sni as *const ::core::ffi::c_void,
                sni_length as size_t,
            ...
            && (version == 0 as uint32_t || (*next).version == version)
            && (need_unused == 0 || (*next).was_used() == 0)
        {
            let mut stored_id: uint64_t = if ((*next).ticket_length as ::core::ffi::c_int)
                < 8 as ::core::ffi::c_int
            {
                0 as uint64_t
            } else {
                (((((*(*next).ticket.offset(0 as ::core::ffi::c_int as isize) as uint16_t
                    as ::core::ffi::c_int)
                    << 8 as ::core::ffi::c_int
                    | *(*next).ticket.offset(1 as ::core::ffi::c_int as isize) as uint16_t
                        as ::core::ffi::c_int) as uint32_t)
                    << 16 as ::core::ffi::c_int
                    | ((*(*next)
                        .ticket
            ...
            if ticket_id == 0 as uint64_t || stored_id == ticket_id {
                break;
            }
        }
        next = (*next).next_ticket as *mut picoquic_stored_ticket_t;
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_get_ticket_and_version(
    mut quic: *mut picoquic_quic_t,
    mut sni: *const ::core::ffi::c_char,
    mut sni_length: uint16_t,
    mut alpn: *const ::core::ffi::c_char,
    mut alpn_length: uint16_t,
    mut version: uint32_t,
    mut ticket_version: *mut uint32_t,
    mut ticket: *mut *mut uint8_t,
    mut ticket_length: *mut uint16_t,
    mut tp: *mut picoquic_tp_t,
    mut mark_used: ::core::ffi::c_int,
) -> ::core::ffi::c_int {
    let mut ret: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut next: *mut picoquic_stored_ticket_t = picoquic_get_stored_ticket(
        quic,
        sni,
        sni_length,
        alpn,
    ...
    if next.is_null() {
        *ticket = ::core::ptr::null_mut::<uint8_t>();
        *ticket_length = 0 as uint16_t;
        ret = -(1 as ::core::ffi::c_int);
    } else {
        if !tp.is_null() {
            (*tp).initial_max_data =
                (*next).tp_0rtt[picoquic_tp_0rtt_max_data as ::core::ffi::c_int as usize];
            (*tp).initial_max_stream_data_bidi_local = (*next).tp_0rtt
                [picoquic_tp_0rtt_max_stream_data_bidi_local as ::core::ffi::c_int as usize];
            (*tp).initial_max_stream_data_bidi_remote = (*next).tp_0rtt
                [picoquic_tp_0rtt_max_stream_data_bidi_remote as ::core::ffi::c_int as usize];
            (*tp).initial_max_stream_data_uni = (*next).tp_0rtt
                [picoquic_tp_0rtt_max_stream_data_uni as ::core::ffi::c_int as usize];
            (*tp).initial_max_stream_id_bidir = (*next).tp_0rtt
                [picoquic_tp_0rtt_max_streams_id_bidir as ::core::ffi::c_int as usize];
            (*tp).initial_max_stream_id_unidir = (*next).tp_0rtt
                [picoquic_tp_0rtt_max_streams_id_unidir as ::core::ffi::c_int as usize];
            *ticket_version = (*next).version;
        }
        *ticket = (*next).ticket;
        *ticket_length = (*next).ticket_length;
        (*next).set_was_used(mark_used as ::core::ffi::c_uint as ::core::ffi::c_uint);
    }
    return ret;
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_get_ticket(
    mut quic: *mut picoquic_quic_t,
    mut sni: *const ::core::ffi::c_char,
    mut sni_length: uint16_t,
    mut alpn: *const ::core::ffi::c_char,
    ...
    let mut ticket_version: uint32_t = 0 as uint32_t;
    let mut ret: ::core::ffi::c_int = picoquic_get_ticket_and_version(
        quic,
        sni,
        sni_length,
        alpn,
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_save_tickets(
    mut first_ticket: *const picoquic_stored_ticket_t,
    mut current_time: uint64_t,
    mut ticket_file_name: *const ::core::ffi::c_char,
) -> ::core::ffi::c_int {
    let mut ret: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut F: *mut FILE = ::core::ptr::null_mut::<FILE>();
    let mut next: *const picoquic_stored_ticket_t = first_ticket;
    F = picoquic_file_open(
        ticket_file_name,
    ...
    if F.is_null() {
        ...
        while ret == 0 as ::core::ffi::c_int && !next.is_null() {
            if (*next).time_valid_until > current_time
                && (*next).was_used() as ::core::ffi::c_int == 0 as ::core::ffi::c_int
            {
                let mut buffer: [uint8_t; 2048] = [0; 2048];
                let mut record_size: size_t = 0;
                ret = picoquic_serialize_ticket(
                    next,
                    &raw mut buffer as *mut uint8_t,
                    ::core::mem::size_of::<[uint8_t; 2048]>() as size_t,
                    &raw mut record_size,
                );
                if ret == 0 as ::core::ffi::c_int {
                    if fwrite(
                        &raw mut record_size as *const ::core::ffi::c_void,
                        4 as size_t,
                        1 as size_t,
                        F,
                    ) != 1 as ::core::ffi::c_ulong
                        || fwrite(
                            &raw mut buffer as *mut uint8_t as *const ::core::ffi::c_void,
                            1 as size_t,
                            record_size,
                            F,
                        ) as size_t
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_load_tickets(
    mut quic: *mut picoquic_quic_t,
    mut ticket_file_name: *const ::core::ffi::c_char,
) -> ::core::ffi::c_int {
    let mut pp_first_ticket: *mut *mut picoquic_stored_ticket_t = &raw mut (*quic).p_first_ticket;
    let mut current_time: uint64_t = picoquic_get_tls_time(quic);
    let mut ret: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut file_err: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut F: *mut FILE = ::core::ptr::null_mut::<FILE>();
    let mut previous: *mut picoquic_stored_ticket_t =
        ::core::ptr::null_mut::<picoquic_stored_ticket_t>();
    let mut next: *mut picoquic_stored_ticket_t =
        ::core::ptr::null_mut::<picoquic_stored_ticket_t>();
    let mut record_size: uint32_t = 0;
    let mut storage_size: uint32_t = 0;
    F = picoquic_file_open_ex(
        ticket_file_name,
        b"rb\0".as_ptr() as *const ::core::ffi::c_char,
        &raw mut file_err,
    );
    if F.is_null() {
        ret = if file_err == ENOENT {
            PICOQUIC_ERROR_NO_SUCH_FILE
        } else {
            -(1 as ::core::ffi::c_int)
        };
    }
    while ret == 0 as ::core::ffi::c_int {
        if fread(
            &raw mut storage_size as *mut ::core::ffi::c_void,
            4 as size_t,
            1 as size_t,
            F,
        ) != 1 as ::core::ffi::c_ulong
        ...
        if storage_size > 2048 as uint32_t || {
            record_size = (storage_size as ::core::ffi::c_ulong)
                .wrapping_add(120 as ::core::ffi::c_ulong) as uint32_t;
            record_size > 2048 as uint32_t
        } {
            ret = PICOQUIC_ERROR_INVALID_FILE;
            break;
        } else {
            let mut buffer: [uint8_t; 2048] = [0; 2048];
            if fread(
                &raw mut buffer as *mut uint8_t as *mut ::core::ffi::c_void,
                1 as size_t,
                storage_size as size_t,
                F,
            ) != storage_size as ::core::ffi::c_ulong
            {
                ret = PICOQUIC_ERROR_INVALID_FILE;
            } else {
                let mut consumed: size_t = 0 as size_t;
                ret = picoquic_deserialize_ticket(
                    &raw mut next,
                    &raw mut buffer as *mut uint8_t,
                    storage_size as size_t,
                    &raw mut consumed,
                ...
                if ret == 0 as ::core::ffi::c_int
                    && (consumed != storage_size as size_t || next.is_null())
                {
                    ret = PICOQUIC_ERROR_INVALID_FILE;
                }
                if ret == 0 as ::core::ffi::c_int && !next.is_null() {
                    if (*next).time_valid_until < current_time {
                        free(next as *mut ::core::ffi::c_void);
                        next = ::core::ptr::null_mut::<picoquic_stored_ticket_t>();
                    } else {
                        (*next).next_ticket =
                            ::core::ptr::null_mut::<st_picoquic_stored_ticket_t>();
                        if previous.is_null() {
                            *pp_first_ticket = next;
                        } else {
                            (*previous).next_ticket = next as *mut st_picoquic_stored_ticket_t;
                        }
                        previous = next;
                    }
                }
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_free_tickets(
    mut pp_first_ticket: *mut *mut picoquic_stored_ticket_t,
) {
    let mut next: *mut picoquic_stored_ticket_t =
        ::core::ptr::null_mut::<picoquic_stored_ticket_t>();
    loop {
        ...
        *pp_first_ticket = (*next).next_ticket as *mut picoquic_stored_ticket_t;
        free(next as *mut ::core::ffi::c_void);
    }
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_save_session_tickets(
    mut quic: *mut picoquic_quic_t,
    mut ticket_store_filename: *const ::core::ffi::c_char,
) -> ::core::ffi::c_int {
    return picoquic_save_tickets(
        (*quic).p_first_ticket,
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_load_retry_tokens(
    mut quic: *mut picoquic_quic_t,
    mut token_store_filename: *const ::core::ffi::c_char,
) -> ::core::ffi::c_int {
    return picoquic_load_tokens(quic as *mut picoquic_quic_t, token_store_filename);
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_save_retry_tokens(
    mut quic: *mut picoquic_quic_t,
    mut ticket_store_filename: *const ::core::ffi::c_char,
) -> ::core::ffi::c_int {
    return picoquic_save_tokens(quic as *mut picoquic_quic_t, ticket_store_filename);
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_update_stored_ticket(
    mut cnx: *mut picoquic_cnx_t,
    mut path_x: *mut picoquic_path_t,
    mut current_time: uint64_t,
) {
    let mut sni: *const ::core::ffi::c_char = if (*cnx).sni.is_null() {
        b"\0".as_ptr() as *const ::core::ffi::c_char
    } else {
        (*cnx).sni
    };
    let mut sni_length: size_t = strlen(sni);
    let mut alpn: *const ::core::ffi::c_char = if (*cnx).alpn.is_null() {
        b"\0".as_ptr() as *const ::core::ffi::c_char
    } else {
        (*cnx).alpn
    };
    let mut alpn_length: size_t = strlen(alpn);
    ...
    picoquic_get_ip_addr(
        ...
        &raw mut ip_addr,
        &raw mut ip_addr_length,
    );
    if !ip_addr.is_null() && ip_addr_length as ::core::ffi::c_int <= PICOQUIC_STORED_IP_MAX {
        let mut next: *mut picoquic_stored_ticket_t = picoquic_get_stored_ticket(
            (*cnx).quic,
            sni,
            sni_length as uint16_t,
            alpn,
            alpn_length as uint16_t,
            version,
            0 as ::core::ffi::c_int,
            (*cnx).issued_ticket_id,
        );
        while !next.is_null() {
            if (*next).sni_length as size_t == sni_length
                && (*next).alpn_length as size_t == alpn_length
                && memcmp(
                    (*next).sni as *const ::core::ffi::c_void,
                    sni as *const ::core::ffi::c_void,
                    sni_length,
                ...
                && (*next).version == version
            {
                let mut ticket_id: uint64_t = if ((*next).ticket_length as ::core::ffi::c_int)
                    < 8 as ::core::ffi::c_int
                {
                    0 as uint64_t
                } else {
                ...
                if (*cnx).issued_ticket_id == 0 as uint64_t || (*cnx).issued_ticket_id == ticket_id
                {
                    break;
                }
            } else {
        ...
        if !next.is_null() {
            ...
            memcpy(
                (*next).ip_addr as *mut ::core::ffi::c_void,
                ip_addr as *const ::core::ffi::c_void,
                ip_addr_length as size_t,
            );
            (*next).tp_0rtt[picoquic_tp_0rtt_rtt_local as ::core::ffi::c_int as usize] =
                (*path_x).rtt_min;
            (*next).tp_0rtt[picoquic_tp_0rtt_cwin_local as ::core::ffi::c_int as usize] =
                (*path_x).cwin;
            (*next).tp_0rtt[picoquic_tp_0rtt_rtt_remote as ::core::ffi::c_int as usize] =
                (*path_x).rtt_min_remote;
            (*next).tp_0rtt[picoquic_tp_0rtt_cwin_remote as ::core::ffi::c_int as usize] =
                (*path_x).cwin_remote;
            (*next).ip_addr_client_length = (*path_x).ip_client_remote_length;
            memcpy(
                (*next).ip_addr_client as *mut ::core::ffi::c_void,
                &raw mut (*path_x).ip_client_remote as *mut uint8_t as *const ::core::ffi::c_void,
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_seed_ticket(
    mut cnx: *mut picoquic_cnx_t,
    mut path_x: *mut picoquic_path_t,
) {
    let mut current_time: uint64_t = picoquic_get_tls_time((*cnx).quic);
    if (*cnx).client_mode() != 0 {
        picoquic_update_stored_ticket(cnx, path_x, current_time);
    } else {
        let mut ip_addr: *mut uint8_t = ::core::ptr::null_mut::<uint8_t>();
        let mut ip_addr_length: uint8_t = 0;
        let mut target_cwin: uint64_t = (*path_x).cwin;
        if (*path_x).bandwidth_estimate_max > 0 as uint64_t {
            target_cwin =
                ((*path_x)
                    .bandwidth_estimate_max
                    .wrapping_mul((*path_x).rtt_min) as ::core::ffi::c_ulonglong)
                    .wrapping_div(1000000 as ::core::ffi::c_ulonglong) as uint64_t;
        }
        picoquic_get_ip_addr(
            &raw mut (*path_x).peer_addr as *mut sockaddr,
            &raw mut ip_addr,
        ...
        picoquic_remember_issued_ticket(
    ...
    (*path_x).set_is_ticket_seeded(1 as ::core::ffi::c_uint as ::core::ffi::c_uint);
}
