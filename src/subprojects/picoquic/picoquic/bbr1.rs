...
pub type picoquic_bbr1_state_t = st_picoquic_bbr1_state_t;
#[derive(Copy, Clone, BitfieldStruct)]
#[repr(C)]
pub struct st_picoquic_bbr1_state_t {
    pub state: picoquic_bbr1_alg_state_t,
    pub btl_bw: uint64_t,
    pub next_round_delivered: uint64_t,
    pub btl_bw_filter: [uint64_t; 10],
    pub full_bw: uint64_t,
    pub rt_prop: uint64_t,
    pub rt_prop_stamp: uint64_t,
    pub cycle_stamp: uint64_t,
    pub probe_rtt_done_stamp: uint64_t,
    pub prior_cwnd: uint64_t,
    pub prior_in_flight: uint64_t,
    pub bytes_delivered: uint64_t,
    pub send_quantum: uint64_t,
    pub rtt_filter: picoquic_min_max_rtt_t,
    pub target_cwnd: uint64_t,
    pub pacing_gain: ::core::ffi::c_double,
    pub cwnd_gain: ::core::ffi::c_double,
    pub pacing_rate: ::core::ffi::c_double,
    pub cycle_index: ::core::ffi::c_uint,
    pub cycle_start: ::core::ffi::c_uint,
    pub round_count: ::core::ffi::c_int,
    pub full_bw_count: ::core::ffi::c_int,
    pub lt_rtt_cnt: ::core::ffi::c_int,
    pub lt_bw: uint64_t,
    pub lt_last_stamp: uint64_t,
    pub previous_round_lost: uint64_t,
    pub previous_sampling_delivered: uint64_t,
    pub previous_sampling_lost: uint64_t,
    pub loss_interval_start: uint64_t,
    pub congestion_sequence: uint64_t,
    pub cwin_before_suspension: uint64_t,
    pub wifi_shadow_rtt: uint64_t,
    pub quantum_ratio: ::core::ffi::c_double,
    #[bitfield(name = "filled_pipe", ty = "::core::ffi::c_uint", bits = "0..=0")]
    #[bitfield(name = "round_start", ty = "::core::ffi::c_uint", bits = "1..=1")]
    #[bitfield(name = "rt_prop_expired", ty = "::core::ffi::c_uint", bits = "2..=2")]
    #[bitfield(
        name = "probe_rtt_round_done",
        ty = "::core::ffi::c_uint",
        bits = "3..=3"
    )]
    #[bitfield(name = "idle_restart", ty = "::core::ffi::c_uint", bits = "4..=4")]
    #[bitfield(
        name = "packet_conservation",
        ty = "::core::ffi::c_uint",
        bits = "5..=5"
    )]
    #[bitfield(name = "btl_bw_increased", ty = "::core::ffi::c_uint", bits = "6..=6")]
    #[bitfield(name = "lt_use_bw", ty = "::core::ffi::c_uint", bits = "7..=7")]
    #[bitfield(name = "lt_is_sampling", ty = "::core::ffi::c_uint", bits = "8..=8")]
    #[bitfield(
        name = "last_loss_was_timeout",
        ty = "::core::ffi::c_uint",
        bits = "9..=9"
    )]
    #[bitfield(name = "cycle_on_loss", ty = "::core::ffi::c_uint", bits = "10..=10")]
    pub filled_pipe_round_start_rt_prop_expired_probe_rtt_round_done_idle_restart_packet_conservation_btl_bw_increased_lt_use_bw_lt_is_sampling_last_loss_was_timeout_cycle_on_loss:
        [u8; 2],
    #[bitfield(padding)]
    pub c2rust_padding: [u8; 2],
    pub is_suspended: ::core::ffi::c_uint,
    #[bitfield(
        name = "is_suspension_nearly_over",
        ty = "::core::ffi::c_uint",
        bits = "0..=0"
    )]
    pub is_suspension_nearly_over: [u8; 1],
    #[bitfield(padding)]
    pub c2rust_padding_0: [u8; 7],
}
...
pub type picoquic_bbr1_alg_state_t = ::core::ffi::c_uint;
pub const picoquic_bbr1_alg_startup_long_rtt: picoquic_bbr1_alg_state_t = 4;
pub const picoquic_bbr1_alg_probe_rtt: picoquic_bbr1_alg_state_t = 3;
pub const picoquic_bbr1_alg_probe_bw: picoquic_bbr1_alg_state_t = 2;
pub const picoquic_bbr1_alg_drain: picoquic_bbr1_alg_state_t = 1;
pub const picoquic_bbr1_alg_startup: picoquic_bbr1_alg_state_t = 0;
...
pub const PICOQUIC_CWIN_MINIMUM: ::core::ffi::c_int =
    2 as ::core::ffi::c_int * PICOQUIC_MAX_PACKET_SIZE;
pub const PICOQUIC_CC_ALGO_NUMBER_BBR1: ::core::ffi::c_int = 7 as ::core::ffi::c_int;
pub const NULL: *mut ::core::ffi::c_void =
    ::core::ptr::null::<::core::ffi::c_void>() as *mut ::core::ffi::c_void;
pub const BBR1_BTL_BW_FILTER_LENGTH: ::core::ffi::c_int = 10 as ::core::ffi::c_int;
pub const BBR1_HIGH_GAIN: ::core::ffi::c_double = 2.8853900817779f64;
pub const BBR1_PROBE_RTT_INTERVAL: ::core::ffi::c_int = 10000000 as ::core::ffi::c_int;
pub const BBR1_PROBE_RTT_DURATION: ::core::ffi::c_int = 200000 as ::core::ffi::c_int;
pub const BBR1_PACING_RATE_LOW: ::core::ffi::c_double = 150000.0f64;
pub const BBR1_PACING_RATE_MEDIUM: ::core::ffi::c_double = 3000000.0f64;
pub const BBR1_GAIN_CYCLE_LEN: ::core::ffi::c_int = 8 as ::core::ffi::c_int;
pub const BBR1_GAIN_CYCLE_MAX_START: ::core::ffi::c_int = 5 as ::core::ffi::c_int;
pub const BBR1_LT_BW_INTERVAL_MIN_RTT: ::core::ffi::c_int = 4 as ::core::ffi::c_int;
pub const BBR1_LT_BW_RATIO_SCALE: ::core::ffi::c_int = 1024 as ::core::ffi::c_int;
pub const BBR1_LT_BW_RATIO_SCALED_TARGET: ::core::ffi::c_int = 205 as ::core::ffi::c_int;
pub const BBR1_LT_BW_INTERVAL_MAX_RTT: ::core::ffi::c_int =
    4 as ::core::ffi::c_int * BBR1_LT_BW_INTERVAL_MIN_RTT;
pub const BBR1_LT_BW_RATIO_INVERSE: ::core::ffi::c_int = 8 as ::core::ffi::c_int;
pub const BBR1_LT_BW_BYTES_PER_SEC_DIFF: ::core::ffi::c_int = 4000 as ::core::ffi::c_int;
pub const BBR1_LT_BW_MAX_RTTS: ::core::ffi::c_int = 48 as ::core::ffi::c_int;
pub const BBR1_HYSTART_THRESHOLD_RTT: ::core::ffi::c_int = 50000 as ::core::ffi::c_int;
static mut bbr1_pacing_gain_cycle: [::core::ffi::c_double; 8] = [
    1.0f64, 1.0f64, 1.0f64, 1.0f64, 1.0f64, 1.0f64, 1.25f64, 0.75f64,
];
unsafe extern "C" fn BBR1GetBtlBW(mut bbr1_state: *mut picoquic_bbr1_state_t) -> uint64_t {
    return if (*bbr1_state).lt_use_bw() as ::core::ffi::c_int != 0 {
        (*bbr1_state).lt_bw
    } else {
        (*bbr1_state).btl_bw
    };
...
#[no_mangle]
pub unsafe extern "C" fn BBR1EnterStartupLongRTT(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
...
#[no_mangle]
pub unsafe extern "C" fn BBR1EnterStartup(mut bbr1_state: *mut picoquic_bbr1_state_t) {
    (*bbr1_state).state = picoquic_bbr1_alg_startup;
    (*bbr1_state).pacing_gain = BBR1_HIGH_GAIN;
    (*bbr1_state).cwnd_gain = BBR1_HIGH_GAIN;
}
#[no_mangle]
pub unsafe extern "C" fn BBR1SetSendQuantum(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut path_x: *mut picoquic_path_t,
) {
    if (*bbr1_state).pacing_rate < BBR1_PACING_RATE_LOW {
        (*bbr1_state).send_quantum = (1 as ::core::ffi::c_ulonglong)
            .wrapping_mul((*path_x).send_mtu as ::core::ffi::c_ulonglong)
            as uint64_t;
    } else if (*bbr1_state).pacing_rate < BBR1_PACING_RATE_MEDIUM {
        (*bbr1_state).send_quantum = (2 as ::core::ffi::c_ulonglong)
            .wrapping_mul((*path_x).send_mtu as ::core::ffi::c_ulonglong)
            as uint64_t;
    } else {
        (*bbr1_state).send_quantum =
            ((*bbr1_state).pacing_rate * (*bbr1_state).quantum_ratio) as uint64_t;
        if (*bbr1_state).send_quantum > 0x10000 as uint64_t {
            (*bbr1_state).send_quantum = 0x10000 as uint64_t;
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn BBR1Inflight(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut gain: ::core::ffi::c_double,
) -> uint64_t {
    let mut cwnd: uint64_t = PICOQUIC_CWIN_INITIAL as uint64_t;
    if (*bbr1_state).rt_prop != UINT64_MAX as uint64_t {
        let mut rt_target: uint64_t = (*bbr1_state).rt_prop;
        if (*bbr1_state).rt_prop < (*bbr1_state).wifi_shadow_rtt {
            rt_target = (*bbr1_state).wifi_shadow_rtt;
        }
        let mut estimated_bdp: ::core::ffi::c_double =
            BBR1GetBtlBW(bbr1_state) as ::core::ffi::c_double * rt_target as ::core::ffi::c_double
                / 1000000.0f64;
        let mut quanta: uint64_t = (3 as uint64_t).wrapping_mul((*bbr1_state).send_quantum);
        cwnd = ((gain * estimated_bdp) as uint64_t).wrapping_add(quanta);
    }
    return cwnd;
}
#[no_mangle]
pub unsafe extern "C" fn BBR1UpdateTargetCwnd(mut bbr1_state: *mut picoquic_bbr1_state_t) {
    (*bbr1_state).target_cwnd = BBR1Inflight(bbr1_state, (*bbr1_state).cwnd_gain);
}
unsafe extern "C" fn picoquic_bbr1_reset(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut path_x: *mut picoquic_path_t,
    ...
    memset(
        bbr1_state as *mut ::core::ffi::c_void,
        0 as ::core::ffi::c_int,
        ::core::mem::size_of::<picoquic_bbr1_state_t>() as size_t,
    );
    (*path_x).cwin = PICOQUIC_CWIN_INITIAL as uint64_t;
    (*bbr1_state).rt_prop = UINT64_MAX as uint64_t;
    (*bbr1_state).wifi_shadow_rtt = (*(*(*path_x).cnx).quic).wifi_shadow_rtt;
    (*bbr1_state).quantum_ratio = (*(*(*path_x).cnx).quic).bbr_quantum_ratio;
    if (*bbr1_state).quantum_ratio == 0 as ::core::ffi::c_int as ::core::ffi::c_double {
        (*bbr1_state).quantum_ratio = 0.001f64;
    }
    (*bbr1_state).rt_prop_stamp = current_time;
    (*bbr1_state).cycle_stamp = current_time;
    (*bbr1_state).cycle_index = 0 as ::core::ffi::c_uint;
    (*bbr1_state).cycle_start = 0 as ::core::ffi::c_uint;
    BBR1EnterStartup(bbr1_state);
    BBR1SetSendQuantum(bbr1_state, path_x);
    BBR1UpdateTargetCwnd(bbr1_state);
}
unsafe extern "C" fn picoquic_bbr1_init(
    mut cnx: *mut picoquic_cnx_t,
    mut path_x: *mut picoquic_path_t,
    mut current_time: uint64_t,
) {
    let mut bbr1_state: *mut picoquic_bbr1_state_t =
        malloc(::core::mem::size_of::<picoquic_bbr1_state_t>() as size_t)
            as *mut picoquic_bbr1_state_t;
    (*path_x).congestion_alg_state = bbr1_state as *mut ::core::ffi::c_void;
    if !bbr1_state.is_null() {
        picoquic_bbr1_reset(
            bbr1_state,
            path_x,
            current_time,
            (*(*cnx).quic).wifi_shadow_rtt,
        );
    }
}
unsafe extern "C" fn picoquic_bbr1_delete(mut path_x: *mut picoquic_path_t) {
...
#[no_mangle]
pub unsafe extern "C" fn BBR1ltbwResetInterval(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut path_x: *mut picoquic_path_t,
    mut current_time: uint64_t,
) {
    ...
    (*bbr1_state).lt_rtt_cnt = 0 as ::core::ffi::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn BBR1ltbwResetSampling(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut path_x: *mut picoquic_path_t,
    mut current_time: uint64_t,
) {
    (*bbr1_state).lt_bw = 0 as uint64_t;
    (*bbr1_state).set_lt_use_bw(0 as ::core::ffi::c_uint as ::core::ffi::c_uint);
    (*bbr1_state).set_lt_is_sampling(0 as ::core::ffi::c_uint as ::core::ffi::c_uint);
    BBR1ltbwResetInterval(bbr1_state, path_x, current_time);
}
#[no_mangle]
pub unsafe extern "C" fn BBR1ltbwIntervalDone(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut path_x: *mut picoquic_path_t,
    mut bw: uint64_t,
    mut current_time: uint64_t,
) {
    if (*bbr1_state).lt_bw != 0 {
        let mut diff: uint64_t = if bw > (*bbr1_state).lt_bw {
            bw.wrapping_sub((*bbr1_state).lt_bw)
        } else {
            (*bbr1_state).lt_bw.wrapping_sub(bw)
        };
        if diff.wrapping_mul(BBR1_LT_BW_RATIO_INVERSE as uint64_t) < (*bbr1_state).lt_bw
            || diff < BBR1_LT_BW_BYTES_PER_SEC_DIFF as uint64_t
        {
            (*bbr1_state).lt_bw = (*bbr1_state)
                .lt_bw
                .wrapping_add(bw)
                .wrapping_div(2 as uint64_t);
            (*bbr1_state).set_lt_use_bw(1 as ::core::ffi::c_uint as ::core::ffi::c_uint);
            (*bbr1_state).pacing_gain = 1.0f64;
            (*bbr1_state).lt_rtt_cnt = 0 as ::core::ffi::c_int;
            return;
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn BBR1ltbwSampling(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut path_x: *mut picoquic_path_t,
    mut current_time: uint64_t,
) {
    let mut losses: uint64_t = if (*path_x).total_bytes_lost > (*bbr1_state).previous_round_lost {
        (*path_x)
            .total_bytes_lost
            .wrapping_sub((*bbr1_state).previous_round_lost)
    } else {
        0 as uint64_t
    };
    let mut delivered: uint64_t = 0;
    let mut interval_microsec: uint64_t = 0;
    let mut bw: uint64_t = 0;
    if (*bbr1_state).lt_use_bw() != 0 {
        if (*bbr1_state).state as ::core::ffi::c_uint
            == picoquic_bbr1_alg_probe_bw as ::core::ffi::c_int as ::core::ffi::c_uint
            && (*bbr1_state).round_start() as ::core::ffi::c_int != 0
        {
            (*bbr1_state).lt_rtt_cnt += 1;
    ...
    if (*bbr1_state).lt_is_sampling() == 0 {
        if losses == 0 as uint64_t {
            return;
        }
        BBR1ltbwResetSampling(bbr1_state, path_x, current_time);
        (*bbr1_state).set_lt_is_sampling(1 as ::core::ffi::c_uint as ::core::ffi::c_uint);
    }
    if (*path_x).last_bw_estimate_path_limited() != 0 {
        BBR1ltbwResetSampling(bbr1_state, path_x, current_time);
        return;
    }
    if (*bbr1_state).round_start() == 0 {
        return;
    } else {
        (*bbr1_state).lt_rtt_cnt += 1;
        (*bbr1_state).previous_round_lost = (*path_x).total_bytes_lost;
    ...
    losses = if (*path_x).total_bytes_lost > (*bbr1_state).previous_sampling_lost {
        (*path_x)
            .total_bytes_lost
            .wrapping_sub((*bbr1_state).previous_sampling_lost)
    } else {
        0 as uint64_t
    };
    delivered = (*path_x)
        .delivered
        .wrapping_sub((*bbr1_state).previous_sampling_delivered);
    if losses.wrapping_mul(BBR1_LT_BW_RATIO_SCALE as uint64_t)
        < (BBR1_LT_BW_RATIO_SCALED_TARGET as uint64_t).wrapping_mul(delivered)
    {
        return;
    }
    interval_microsec = current_time.wrapping_sub((*bbr1_state).lt_last_stamp);
    if interval_microsec < 1000 as uint64_t {
        return;
    }
    bw = delivered
        .wrapping_mul(1000000 as uint64_t)
        .wrapping_div(interval_microsec);
    BBR1ltbwIntervalDone(bbr1_state, path_x, bw, current_time);
}
#[no_mangle]
pub unsafe extern "C" fn BBR1UpdateBtlBw(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut path_x: *mut picoquic_path_t,
    mut current_time: uint64_t,
) {
    let mut bandwidth_estimate: uint64_t = (*path_x).bandwidth_estimate;
    if (*bbr1_state).state as ::core::ffi::c_uint
        == picoquic_bbr1_alg_startup as ::core::ffi::c_int as ::core::ffi::c_uint
        && bandwidth_estimate
            < (*path_x)
                .peak_bandwidth_estimate
                .wrapping_div(2 as uint64_t)
    {
        bandwidth_estimate = (*path_x)
            .peak_bandwidth_estimate
            .wrapping_div(2 as uint64_t);
    }
    if (*bbr1_state).rt_prop > 0 as uint64_t {
        let mut min_bandwidth: uint64_t = (PICOQUIC_CWIN_MINIMUM as uint64_t)
            .wrapping_mul(1000000 as uint64_t)
            .wrapping_div((*bbr1_state).rt_prop);
    ...
    if (*path_x).delivered_last_packet >= (*bbr1_state).next_round_delivered {
        ...
        (*bbr1_state).round_count += 1;
        (*bbr1_state).set_round_start(1 as ::core::ffi::c_uint as ::core::ffi::c_uint);
    } else {
        (*bbr1_state).set_round_start(0 as ::core::ffi::c_uint as ::core::ffi::c_uint);
    }
    ...
    if (*bbr1_state).round_start() != 0 {
        ...
        {
            (*bbr1_state).btl_bw = 0 as uint64_t;
            let mut i: ::core::ffi::c_int = BBR1_BTL_BW_FILTER_LENGTH - 2 as ::core::ffi::c_int;
            while i >= 0 as ::core::ffi::c_int {
                let mut b: uint64_t = (*bbr1_state).btl_bw_filter[i as usize];
                (*bbr1_state).btl_bw_filter[(i + 1 as ::core::ffi::c_int) as usize] = b;
                if b > (*bbr1_state).btl_bw {
                    (*bbr1_state).btl_bw = b;
                }
                i -= 1;
            }
            (*bbr1_state).set_btl_bw_increased(
                (*bbr1_state).btl_bw_increased()
                    | (bandwidth_estimate
                        > (*bbr1_state).btl_bw_filter[0 as ::core::ffi::c_int as usize])
                        as ::core::ffi::c_int as ::core::ffi::c_uint,
            );
            (*bbr1_state).btl_bw_filter[0 as ::core::ffi::c_int as usize] = bandwidth_estimate;
            if bandwidth_estimate > (*bbr1_state).btl_bw {
                (*bbr1_state).btl_bw = bandwidth_estimate;
            }
        } else {
            (*bbr1_state).set_btl_bw_increased(0 as ::core::ffi::c_uint as ::core::ffi::c_uint);
        }
    } else if bandwidth_estimate > (*bbr1_state).btl_bw_filter[0 as ::core::ffi::c_int as usize] {
        (*bbr1_state).btl_bw_filter[0 as ::core::ffi::c_int as usize] = bandwidth_estimate;
        if bandwidth_estimate > (*bbr1_state).btl_bw {
            (*bbr1_state).btl_bw = bandwidth_estimate;
            (*bbr1_state).set_btl_bw_increased(1 as ::core::ffi::c_uint as ::core::ffi::c_uint);
        }
    }
}
#[no_mangle]
pub unsafe extern "C" fn BBR1UpdateRTprop(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut rtt_sample: uint64_t,
    mut current_time: uint64_t,
) {
    (*bbr1_state).set_rt_prop_expired(
        (current_time
            > (*bbr1_state)
                .rt_prop_stamp
                .wrapping_add(BBR1_PROBE_RTT_INTERVAL as uint64_t)
            && current_time
                > (*bbr1_state)
                    .rt_prop_stamp
                    .wrapping_add((20 as uint64_t).wrapping_mul((*bbr1_state).rt_prop)))
            as ::core::ffi::c_int as ::core::ffi::c_uint as ::core::ffi::c_uint,
    );
    if rtt_sample <= (*bbr1_state).rt_prop
        || (*bbr1_state).rt_prop_expired() as ::core::ffi::c_int != 0
    {
        (*bbr1_state).rt_prop = rtt_sample;
        (*bbr1_state).rt_prop_stamp = current_time;
    } else {
        let mut delta: uint64_t = rtt_sample.wrapping_sub((*bbr1_state).rt_prop);
        if (20 as uint64_t).wrapping_mul(delta) < (*bbr1_state).rt_prop {
            (*bbr1_state).rt_prop_stamp = current_time;
        }
    };
}
#[no_mangle]
pub unsafe extern "C" fn BBR1IsNextCyclePhase(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut prior_in_flight: uint64_t,
    mut packets_lost: uint64_t,
    mut current_time: uint64_t,
) -> ::core::ffi::c_int {
    let mut is_full_length: ::core::ffi::c_int =
        ((*bbr1_state).cycle_on_loss() as ::core::ffi::c_int != 0
            || current_time.wrapping_sub((*bbr1_state).cycle_stamp) > (*bbr1_state).rt_prop)
            as ::core::ffi::c_int;
    if (*bbr1_state).pacing_gain != 1.0f64 {
        if (*bbr1_state).pacing_gain > 1.0f64 {
            is_full_length &= (packets_lost > 0 as uint64_t
                || prior_in_flight >= BBR1Inflight(bbr1_state, (*bbr1_state).pacing_gain))
                as ::core::ffi::c_int;
        } else {
            is_full_length &=
                (prior_in_flight <= BBR1Inflight(bbr1_state, 1.0f64)) as ::core::ffi::c_int;
        }
    }
    return is_full_length;
}
#[no_mangle]
pub unsafe extern "C" fn BBR1SetMinimalGain(mut bbr1_state: *mut picoquic_bbr1_state_t) {
    if (*bbr1_state).pacing_gain > 1.0f64 && (*bbr1_state).rt_prop > 0 as uint64_t {
        let mut target_cwin: uint64_t = (*bbr1_state)
            .btl_bw
            .wrapping_mul((*bbr1_state).rt_prop)
            .wrapping_div(1000000 as uint64_t);
        if target_cwin < (4 as ::core::ffi::c_int * PICOQUIC_MAX_PACKET_SIZE) as uint64_t {
            let mut d_target: ::core::ffi::c_double = target_cwin as ::core::ffi::c_double;
            let mut d_gain: ::core::ffi::c_double =
                (4 as ::core::ffi::c_int * PICOQUIC_MAX_PACKET_SIZE) as ::core::ffi::c_double
                    / d_target;
...
#[no_mangle]
pub unsafe extern "C" fn BBR1AdvanceCyclePhase(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut current_time: uint64_t,
) {
    (*bbr1_state).set_cycle_on_loss(0 as ::core::ffi::c_uint as ::core::ffi::c_uint);
    (*bbr1_state).cycle_stamp = current_time;
    (*bbr1_state).cycle_index = (*bbr1_state).cycle_index.wrapping_add(1);
    if (*bbr1_state).cycle_index >= BBR1_GAIN_CYCLE_LEN as ::core::ffi::c_uint {
        let mut start: ::core::ffi::c_uint = (*bbr1_state).cycle_start;
        if (*bbr1_state).btl_bw_increased() != 0 {
            (*bbr1_state).set_btl_bw_increased(0 as ::core::ffi::c_uint as ::core::ffi::c_uint);
            start = start.wrapping_add(1);
            if start > BBR1_GAIN_CYCLE_MAX_START as ::core::ffi::c_uint {
                start = BBR1_GAIN_CYCLE_MAX_START as ::core::ffi::c_uint;
            }
        } else if start > 0 as ::core::ffi::c_uint {
            start = start.wrapping_sub(1);
        }
        (*bbr1_state).cycle_index = start;
        (*bbr1_state).cycle_start = start;
    }
    (*bbr1_state).pacing_gain = bbr1_pacing_gain_cycle[(*bbr1_state).cycle_index as usize];
    BBR1SetMinimalGain(bbr1_state);
}
#[no_mangle]
pub unsafe extern "C" fn BBR1CheckCyclePhase(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut packets_lost: uint64_t,
    mut current_time: uint64_t,
) {
    if (*bbr1_state).state as ::core::ffi::c_uint
        == picoquic_bbr1_alg_probe_bw as ::core::ffi::c_int as ::core::ffi::c_uint
        && BBR1IsNextCyclePhase(
            bbr1_state,
            (*bbr1_state).prior_in_flight,
            packets_lost,
            current_time,
        ) != 0
    {
...
unsafe extern "C" fn BBR1ResetProbeBwMode(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut current_time: uint64_t,
) {
    (*bbr1_state).state = picoquic_bbr1_alg_probe_bw;
    (*bbr1_state).cycle_index = 2 as ::core::ffi::c_uint;
    BBR1AdvanceCyclePhase(bbr1_state, current_time);
}
#[no_mangle]
pub unsafe extern "C" fn BBR1CheckFullPipe(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut rs_is_app_limited: ::core::ffi::c_int,
) {
    if (*bbr1_state).filled_pipe() == 0
        && (*bbr1_state).round_start() as ::core::ffi::c_int != 0
        && rs_is_app_limited == 0
    {
        if (*bbr1_state).btl_bw as ::core::ffi::c_double
            >= (*bbr1_state).full_bw as ::core::ffi::c_double * 1.25f64
        {
            (*bbr1_state).full_bw = (*bbr1_state).btl_bw;
            (*bbr1_state).full_bw_count = 0 as ::core::ffi::c_int;
        } else {
            (*bbr1_state).full_bw_count += 1;
            if (*bbr1_state).full_bw_count >= 3 as ::core::ffi::c_int {
                (*bbr1_state).set_filled_pipe(1 as ::core::ffi::c_uint as ::core::ffi::c_uint);
            }
        }
    }
}
#[no_mangle]
pub unsafe extern "C" fn BBR1EnterProbeBW(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut path_x: *mut picoquic_path_t,
    mut current_time: uint64_t,
) {
    let mut start: ::core::ffi::c_uint = 0 as ::core::ffi::c_uint;
    (*bbr1_state).state = picoquic_bbr1_alg_probe_bw;
    (*bbr1_state).pacing_gain = 1.0f64;
    (*bbr1_state).cwnd_gain = 2.0f64;
    if (*bbr1_state).rt_prop as ::core::ffi::c_ulonglong > PICOQUIC_TARGET_RENO_RTT {
        let mut ref_rt: uint64_t =
            (if (*bbr1_state).rt_prop as ::core::ffi::c_ulonglong > PICOQUIC_TARGET_SATELLITE_RTT {
                PICOQUIC_TARGET_SATELLITE_RTT
            } else {
                (*bbr1_state).rt_prop as ::core::ffi::c_ulonglong
            }) as uint64_t;
        start = (ref_rt as ::core::ffi::c_ulonglong).wrapping_div(PICOQUIC_TARGET_RENO_RTT)
            as ::core::ffi::c_uint;
        if start > BBR1_GAIN_CYCLE_MAX_START as ::core::ffi::c_uint {
            start = BBR1_GAIN_CYCLE_MAX_START as ::core::ffi::c_uint;
        }
    } else {
        start = 2 as ::core::ffi::c_uint;
    }
    (*bbr1_state).cycle_index = start;
    (*bbr1_state).cycle_start = start;
    (*bbr1_state).set_btl_bw_increased(1 as ::core::ffi::c_uint as ::core::ffi::c_uint);
...
#[no_mangle]
pub unsafe extern "C" fn BBR1EnterDrain(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut path_x: *mut picoquic_path_t,
    mut current_time: uint64_t,
) {
    ...
    (*bbr1_state).pacing_gain = 1.0f64 / BBR1_HIGH_GAIN;
    (*bbr1_state).cwnd_gain = BBR1_HIGH_GAIN;
    BBR1ltbwSampling(bbr1_state, path_x, current_time);
}
#[no_mangle]
pub unsafe extern "C" fn BBR1CheckDrain(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut path_x: *mut picoquic_path_t,
    mut bytes_in_transit: uint64_t,
    mut current_time: uint64_t,
) {
    if (*bbr1_state).state as ::core::ffi::c_uint
        == picoquic_bbr1_alg_startup as ::core::ffi::c_int as ::core::ffi::c_uint
        && (*bbr1_state).filled_pipe() as ::core::ffi::c_int != 0
    {
        BBR1EnterDrain(bbr1_state, path_x, current_time);
    }
    if (*bbr1_state).state as ::core::ffi::c_uint
        == picoquic_bbr1_alg_drain as ::core::ffi::c_int as ::core::ffi::c_uint
        && bytes_in_transit <= BBR1Inflight(bbr1_state, 1.0f64)
    {
        BBR1EnterProbeBW(bbr1_state, path_x, current_time);
    }
}
#[no_mangle]
pub unsafe extern "C" fn BBR1ExitStartupLongRtt(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut path_x: *mut picoquic_path_t,
    mut current_time: uint64_t,
) {
    ...
    (*bbr1_state).set_round_start(1 as ::core::ffi::c_uint as ::core::ffi::c_uint);
    (*bbr1_state).full_bw = (*bbr1_state).btl_bw;
    (*bbr1_state).full_bw_count = 3 as ::core::ffi::c_int;
    (*bbr1_state).set_filled_pipe(1 as ::core::ffi::c_uint as ::core::ffi::c_uint);
    if ((*bbr1_state).rtt_filter.is_init != 0
        || (*bbr1_state).rtt_filter.sample_current > 0 as ::core::ffi::c_int)
        && (*bbr1_state).rt_prop > 30000000 as uint64_t
    ...
    BBR1EnterDrain(bbr1_state, path_x, current_time);
    if (*path_x).bytes_in_transit <= BBR1Inflight(bbr1_state, 1.0f64) {
        BBR1EnterProbeBW(bbr1_state, path_x, current_time);
    }
}
#[no_mangle]
pub unsafe extern "C" fn BBR1ExitStartupSeedBDP(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut path_x: *mut picoquic_path_t,
    mut bdp: uint64_t,
    mut current_time: uint64_t,
) {
    let mut bandwidth_estimate: uint64_t = bdp
        .wrapping_mul(1000000 as uint64_t)
        .wrapping_div((*path_x).rtt_min);
    (*path_x).cwin = bdp;
    if bandwidth_estimate > (*bbr1_state).btl_bw_filter[0 as ::core::ffi::c_int as usize] {
        (*bbr1_state).btl_bw_filter[0 as ::core::ffi::c_int as usize] = bandwidth_estimate;
        if bandwidth_estimate > (*bbr1_state).btl_bw {
            (*bbr1_state).btl_bw = bandwidth_estimate;
            (*bbr1_state).set_btl_bw_increased(1 as ::core::ffi::c_uint as ::core::ffi::c_uint);
...
#[no_mangle]
pub unsafe extern "C" fn BBR1EnterProbeRTT(mut bbr1_state: *mut picoquic_bbr1_state_t) {
    (*bbr1_state).state = picoquic_bbr1_alg_probe_rtt;
    (*bbr1_state).pacing_gain = 1.0f64;
    (*bbr1_state).cwnd_gain = 1.0f64;
}
#[no_mangle]
pub unsafe extern "C" fn BBR1ExitProbeRTT(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut path_x: *mut picoquic_path_t,
    mut current_time: uint64_t,
) {
...
unsafe extern "C" fn InLossRecovery1(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
) -> ::core::ffi::c_int {
    return (*bbr1_state).packet_conservation() as ::core::ffi::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn BBR1SaveCwnd(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut path_x: *mut picoquic_path_t,
) -> uint64_t {
    let mut w: uint64_t = (*path_x).cwin;
    if (InLossRecovery1(bbr1_state) != 0
        || (*bbr1_state).state as ::core::ffi::c_uint
            == picoquic_bbr1_alg_probe_bw as ::core::ffi::c_int as ::core::ffi::c_uint)
...
#[no_mangle]
pub unsafe extern "C" fn BBR1RestoreCwnd(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut path_x: *mut picoquic_path_t,
) {
...
#[no_mangle]
pub unsafe extern "C" fn BBR1HandleProbeRTT(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut path_x: *mut picoquic_path_t,
    mut bytes_in_transit: uint64_t,
    mut current_time: uint64_t,
) {
    if (*bbr1_state).probe_rtt_done_stamp == 0 as uint64_t
        && bytes_in_transit <= ((*path_x).send_mtu as uint64_t).wrapping_mul(4 as uint64_t)
    {
        (*bbr1_state).probe_rtt_done_stamp =
            current_time.wrapping_add(BBR1_PROBE_RTT_DURATION as uint64_t);
        (*bbr1_state).set_probe_rtt_round_done(0 as ::core::ffi::c_uint as ::core::ffi::c_uint);
        (*bbr1_state).next_round_delivered = (*path_x).delivered;
    } else if (*bbr1_state).probe_rtt_done_stamp != 0 as uint64_t {
        if (*bbr1_state).round_start() != 0 {
            (*bbr1_state).set_probe_rtt_round_done(1 as ::core::ffi::c_uint as ::core::ffi::c_uint);
        }
        if (*bbr1_state).probe_rtt_round_done() as ::core::ffi::c_int != 0
...
#[no_mangle]
pub unsafe extern "C" fn BBR1CheckProbeRTT(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut path_x: *mut picoquic_path_t,
    mut bytes_in_transit: uint64_t,
    mut current_time: uint64_t,
    ...
    if (*bbr1_state).state as ::core::ffi::c_uint
        != picoquic_bbr1_alg_probe_rtt as ::core::ffi::c_int as ::core::ffi::c_uint
        && (*bbr1_state).rt_prop_expired() as ::core::ffi::c_int != 0
        && (*bbr1_state).idle_restart() == 0
    {
        BBR1EnterProbeRTT(bbr1_state);
        (*bbr1_state).prior_cwnd = BBR1SaveCwnd(bbr1_state, path_x);
        (*bbr1_state).probe_rtt_done_stamp = 0 as uint64_t;
    }
    if (*bbr1_state).state as ::core::ffi::c_uint
        == picoquic_bbr1_alg_probe_rtt as ::core::ffi::c_int as ::core::ffi::c_uint
    {
        BBR1HandleProbeRTT(bbr1_state, path_x, bytes_in_transit, current_time);
        (*bbr1_state).set_idle_restart(0 as ::core::ffi::c_uint as ::core::ffi::c_uint);
    }
}
#[no_mangle]
pub unsafe extern "C" fn BBR1UpdateModelAndState(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut path_x: *mut picoquic_path_t,
    mut rtt_sample: uint64_t,
    mut bytes_in_transit: uint64_t,
    ...
    BBR1CheckFullPipe(
        bbr1_state,
        (*path_x).last_bw_estimate_path_limited() as ::core::ffi::c_int,
    );
...
#[no_mangle]
pub unsafe extern "C" fn BBR1SetPacingRateWithGain(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut pacing_gain: ::core::ffi::c_double,
) {
    let mut rate: ::core::ffi::c_double =
        pacing_gain * BBR1GetBtlBW(bbr1_state) as ::core::ffi::c_double;
    if (*bbr1_state).filled_pipe() as ::core::ffi::c_int != 0 || rate > (*bbr1_state).pacing_rate {
        (*bbr1_state).pacing_rate = rate;
    }
}
#[no_mangle]
pub unsafe extern "C" fn BBR1SetPacingRate(mut bbr1_state: *mut picoquic_bbr1_state_t) {
    BBR1SetPacingRateWithGain(bbr1_state, (*bbr1_state).pacing_gain);
}
#[no_mangle]
pub unsafe extern "C" fn BBR1ModulateCwndForRecovery(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut path_x: *mut picoquic_path_t,
    mut bytes_in_transit: uint64_t,
    mut bytes_lost: uint64_t,
    mut bytes_delivered: uint64_t,
) {
    if bytes_lost > 0 as uint64_t {
        if (*path_x).cwin > bytes_lost {
            (*path_x).cwin = (*path_x).cwin.wrapping_sub(bytes_lost);
        } else {
            (*path_x).cwin = (*path_x).send_mtu as uint64_t;
        }
    }
    if (*bbr1_state).packet_conservation() != 0 {
        if (*path_x).cwin < bytes_in_transit.wrapping_add(bytes_delivered) {
            (*path_x).cwin = bytes_in_transit.wrapping_add(bytes_delivered);
        }
    }
}
#[no_mangle]
pub unsafe extern "C" fn BBR1ModulateCwndForProbeRTT(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut path_x: *mut picoquic_path_t,
) {
    if (*bbr1_state).state as ::core::ffi::c_uint
        == picoquic_bbr1_alg_probe_rtt as ::core::ffi::c_int as ::core::ffi::c_uint
    {
        if (*path_x).cwin > ((*path_x).send_mtu as uint64_t).wrapping_mul(4 as uint64_t) {
            (*path_x).cwin = ((*path_x).send_mtu as uint64_t).wrapping_mul(4 as uint64_t);
        }
    }
}
#[no_mangle]
pub unsafe extern "C" fn BBR1SetCwnd(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut path_x: *mut picoquic_path_t,
    mut bytes_in_transit: uint64_t,
    mut packets_lost: uint64_t,
    ...
    if (*bbr1_state).packet_conservation() == 0 {
        if (*bbr1_state).filled_pipe() != 0 {
            (*path_x).cwin = (*path_x).cwin.wrapping_add(bytes_delivered);
            if (*path_x).cwin > (*bbr1_state).target_cwnd {
                (*path_x).cwin = (*bbr1_state).target_cwnd;
            }
        } else if (*path_x).cwin < (*bbr1_state).target_cwnd
...
#[no_mangle]
pub unsafe extern "C" fn BBR1UpdateControlParameters(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut path_x: *mut picoquic_path_t,
    mut bytes_in_transit: uint64_t,
    mut packets_lost: uint64_t,
...
#[no_mangle]
pub unsafe extern "C" fn BBR1HandleRestartFromIdle(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut bytes_in_transit: uint64_t,
    mut is_app_limited: ::core::ffi::c_int,
) {
    if bytes_in_transit == 0 as uint64_t && is_app_limited != 0 {
        (*bbr1_state).set_idle_restart(1 as ::core::ffi::c_uint as ::core::ffi::c_uint);
        if (*bbr1_state).state as ::core::ffi::c_uint
            == picoquic_bbr1_alg_probe_bw as ::core::ffi::c_int as ::core::ffi::c_uint
        {
            BBR1SetPacingRateWithGain(bbr1_state, 1.0f64);
        }
    }
}
#[no_mangle]
pub unsafe extern "C" fn BBR1UpdateOnACK(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut path_x: *mut picoquic_path_t,
    mut rtt_sample: uint64_t,
    mut bytes_in_transit: uint64_t,
...
#[no_mangle]
pub unsafe extern "C" fn BBR1OnTransmit(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut bytes_in_transit: uint64_t,
    mut is_app_limited: ::core::ffi::c_int,
) {
...
#[no_mangle]
pub unsafe extern "C" fn BBR1OnAllPacketsLost(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut path_x: *mut picoquic_path_t,
) {
    (*bbr1_state).prior_cwnd = BBR1SaveCwnd(bbr1_state, path_x);
...
#[no_mangle]
pub unsafe extern "C" fn BBR1OnEnterFastRecovery(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut path_x: *mut picoquic_path_t,
    mut bytes_in_transit: uint64_t,
    mut bytes_delivered: uint64_t,
) {
    if bytes_delivered < (*path_x).send_mtu as uint64_t {
        bytes_delivered = (*path_x).send_mtu as uint64_t;
    }
    (*bbr1_state).prior_cwnd = BBR1SaveCwnd(bbr1_state, path_x);
    (*path_x).cwin = bytes_in_transit.wrapping_add(bytes_delivered);
    (*bbr1_state).set_packet_conservation(1 as ::core::ffi::c_uint as ::core::ffi::c_uint);
}
#[no_mangle]
pub unsafe extern "C" fn BBR1AfterOneRoundtripInFastRecovery(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
) {
    (*bbr1_state).set_packet_conservation(0 as ::core::ffi::c_uint as ::core::ffi::c_uint);
}
#[no_mangle]
pub unsafe extern "C" fn BBR1ExitFastRecovery(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut path_x: *mut picoquic_path_t,
) {
    (*bbr1_state).set_packet_conservation(0 as ::core::ffi::c_uint as ::core::ffi::c_uint);
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_bbr1_notify_congestion(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut cnx: *mut picoquic_cnx_t,
    mut path_x: *mut picoquic_path_t,
    mut current_time: uint64_t,
    mut is_timeout: ::core::ffi::c_int,
) {
    if ((*bbr1_state).cycle_on_loss() as ::core::ffi::c_int != 0
        || current_time
            < (*bbr1_state)
                .loss_interval_start
                .wrapping_add((*path_x).smoothed_rtt))
        && (is_timeout == 0 || (*bbr1_state).last_loss_was_timeout() as ::core::ffi::c_int != 0)
    {
        return;
    }
    if is_timeout != 0 || (*path_x).cwin < PICOQUIC_CWIN_MINIMUM as uint64_t {
        if (*bbr1_state).is_suspended == 0 {
            (*bbr1_state).is_suspended = 1 as ::core::ffi::c_uint;
            (*bbr1_state).cwin_before_suspension = (*path_x).cwin;
        }
        (*path_x).cwin = PICOQUIC_CWIN_MINIMUM as uint64_t;
    } else {
        (*path_x).cwin = (*path_x).cwin.wrapping_div(2 as uint64_t);
    }
    (*bbr1_state).loss_interval_start = current_time;
    (*bbr1_state)
        .set_last_loss_was_timeout(is_timeout as ::core::ffi::c_uint as ::core::ffi::c_uint);
    (*bbr1_state).congestion_sequence = picoquic_cc_get_sequence_number(cnx, path_x);
    if (*bbr1_state).state as ::core::ffi::c_uint
        == picoquic_bbr1_alg_startup_long_rtt as ::core::ffi::c_int as ::core::ffi::c_uint
    {
        BBR1ExitStartupLongRtt(bbr1_state, path_x, current_time);
    } else if (*bbr1_state).state as ::core::ffi::c_uint
        == picoquic_bbr1_alg_startup as ::core::ffi::c_int as ::core::ffi::c_uint
    {
        (*bbr1_state).set_filled_pipe(1 as ::core::ffi::c_uint as ::core::ffi::c_uint);
        BBR1EnterDrain(bbr1_state, path_x, current_time);
    } else {
        (*bbr1_state).set_cycle_on_loss(1 as ::core::ffi::c_uint as ::core::ffi::c_uint);
    };
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_bbr1_suspension_almost_over(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut path_x: *mut picoquic_path_t,
    mut lost_packet_number: uint64_t,
) {
    if (*bbr1_state).is_suspended != 0
        && (*bbr1_state).cwin_before_suspension > 0 as uint64_t
        && (*bbr1_state).is_suspension_nearly_over() == 0
        && (*bbr1_state).congestion_sequence >= lost_packet_number
    {
        (*bbr1_state)
            .set_is_suspension_nearly_over(1 as ::core::ffi::c_uint as ::core::ffi::c_uint);
    }
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_bbr1_suspension_exit(
    mut bbr1_state: *mut picoquic_bbr1_state_t,
    mut cnx: *mut picoquic_cnx_t,
    mut path_x: *mut picoquic_path_t,
) {
    if (*bbr1_state).is_suspended != 0
        && (*bbr1_state).is_suspension_nearly_over() as ::core::ffi::c_int != 0
    {
        (*path_x).cwin = (*bbr1_state).cwin_before_suspension;
        picoquic_update_pacing_rate(
            cnx,
            path_x,
            (*bbr1_state).pacing_rate,
            (*bbr1_state).send_quantum,
        );
    }
    (*bbr1_state).is_suspended = 0 as ::core::ffi::c_uint;
    (*bbr1_state).set_is_suspension_nearly_over(0 as ::core::ffi::c_uint as ::core::ffi::c_uint);
}
unsafe extern "C" fn picoquic_bbr1_notify(
    mut cnx: *mut picoquic_cnx_t,
    mut path_x: *mut picoquic_path_t,
    ...
    let mut bbr1_state: *mut picoquic_bbr1_state_t =
        (*path_x).congestion_alg_state as *mut picoquic_bbr1_state_t;
        ...
        match notification as ::core::ffi::c_uint {
            5 => {
                if (*ack_state).lost_packet_number >= (*bbr1_state).congestion_sequence {
                    picoquic_bbr1_notify_congestion(
                        bbr1_state,
                        cnx,
                        path_x,
                        current_time,
            ...
            1 | 2 => {
                if (*ack_state).lost_packet_number >= (*bbr1_state).congestion_sequence
                    && picoquic_hystart_loss_test(
                        &raw mut (*bbr1_state).rtt_filter,
                        notification,
                    ...
                    ) != 0
                {
                    picoquic_bbr1_notify_congestion(
                        ...
                        path_x,
                        current_time,
                        if notification as ::core::ffi::c_uint
                            == picoquic_congestion_notification_timeout as ::core::ffi::c_int
                                as ::core::ffi::c_uint
                        {
                            1 as ::core::ffi::c_int
                        } else {
            ...
            0 => {
                ...
                (*bbr1_state).bytes_delivered = (*bbr1_state)
                    .bytes_delivered
                    .wrapping_add((*ack_state).nb_bytes_acknowledged);
                if (*bbr1_state).state as ::core::ffi::c_uint
                    == picoquic_bbr1_alg_startup as ::core::ffi::c_int as ::core::ffi::c_uint
                    && (*path_x).rtt_min > BBR1_HYSTART_THRESHOLD_RTT as uint64_t
                {
                    BBR1EnterStartupLongRTT(bbr1_state, path_x);
                }
                if (*bbr1_state).state as ::core::ffi::c_uint
                    == picoquic_bbr1_alg_startup_long_rtt as ::core::ffi::c_int
                        as ::core::ffi::c_uint
                {
                    if picoquic_hystart_test(
                        &raw mut (*bbr1_state).rtt_filter,
                        if (*cnx).is_time_stamp_enabled() as ::core::ffi::c_int != 0 {
                        ...
                        current_time,
                        (*cnx).is_time_stamp_enabled() as ::core::ffi::c_int,
                    ) != 0
                    {
                        BBR1ExitStartupLongRtt(bbr1_state, path_x, current_time);
                    }
                ...
                if (*bbr1_state).state as ::core::ffi::c_uint
                    == picoquic_bbr1_alg_startup_long_rtt as ::core::ffi::c_int
                        as ::core::ffi::c_uint
                {
                    let mut max_win: uint64_t = 0;
                    let mut min_win: uint64_t = 0;
                    BBR1UpdateBtlBw(bbr1_state, path_x, current_time);
                    ...
                    {
                        picoquic_hystart_increase(
                            path_x,
                            &raw mut (*bbr1_state).rtt_filter,
                            (*bbr1_state).bytes_delivered,
                        );
                    }
                    (*bbr1_state).bytes_delivered = 0 as uint64_t;
                    max_win = (*path_x)
                        .peak_bandwidth_estimate
                        .wrapping_mul((*bbr1_state).rt_prop)
                        .wrapping_div(1000000 as uint64_t);
                    ...
                    if (*path_x).cwin < min_win {
                        (*path_x).cwin = min_win;
                    } else if (*path_x).smoothed_rtt as ::core::ffi::c_ulonglong
                        > PICOQUIC_TARGET_RENO_RTT
                    {
                        (*path_x).pacing.bandwidth_pause = 1 as ::core::ffi::c_int;
                    }
                    ...
                    (*bbr1_state).bytes_delivered = 0 as uint64_t;
                    if (*bbr1_state).pacing_rate > 0 as ::core::ffi::c_int as ::core::ffi::c_double
                    {
                        picoquic_update_pacing_rate(
                            cnx,
                            path_x,
            ...
            7 => {
                        ...
                        as ::core::ffi::c_uint
                {
                    ...
                    == picoquic_bbr1_alg_startup as ::core::ffi::c_int as ::core::ffi::c_uint
                {
                    let mut seed_bw_estimate: ::core::ffi::c_double =
                        (*ack_state).nb_bytes_acknowledged as ::core::ffi::c_double;
                    let mut bwe: uint64_t = 0;
                    seed_bw_estimate /= (*path_x).smoothed_rtt as ::core::ffi::c_double;
                    seed_bw_estimate *= 1000000 as ::core::ffi::c_int as ::core::ffi::c_double;
                    bwe = (seed_bw_estimate as uint64_t).wrapping_mul(2 as uint64_t);
                    if (*path_x).bandwidth_estimate_max < bwe {
                        (*path_x).bandwidth_estimate_max = bwe;
                        BBR1UpdateBtlBw(bbr1_state, path_x, current_time);
                        BBR1SetPacingRate(bbr1_state);
                        if (*bbr1_state).pacing_rate
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_bbr1_observe(
    mut path_x: *mut picoquic_path_t,
    ...
    let mut bbr1_state: *mut picoquic_bbr1_state_t =
        (*path_x).congestion_alg_state as *mut picoquic_bbr1_state_t;
    *cc_state = (*bbr1_state).state as uint64_t;
    *cc_param = (*bbr1_state).btl_bw;
}
pub const picoquic_bbr1_ID: [::core::ffi::c_char; 5] =
    unsafe { ::core::mem::transmute::<[u8; 5], [::core::ffi::c_char; 5]>(*b"bbr1\0") };
#[no_mangle]
pub static mut picoquic_bbr1_algorithm_struct: picoquic_congestion_algorithm_t = unsafe {
    st_picoquic_congestion_algorithm_t {
        congestion_algorithm_id: picoquic_bbr1_ID.as_ptr(),
        congestion_algorithm_number: PICOQUIC_CC_ALGO_NUMBER_BBR1 as uint8_t,
        alg_init: Some(
            picoquic_bbr1_init
        ...
        alg_delete: Some(picoquic_bbr1_delete as unsafe extern "C" fn(*mut picoquic_path_t) -> ()),
        alg_observe: Some(
...
#[no_mangle]
pub static mut picoquic_bbr1_algorithm: *mut picoquic_congestion_algorithm_t =
    unsafe { &raw const picoquic_bbr1_algorithm_struct as *mut picoquic_congestion_algorithm_t };
