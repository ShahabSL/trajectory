...
extern "C" {
    ...
    fn picosplay_previous(node: *mut picosplay_node_t) -> *mut picosplay_node_t;
...
pub const PICOQUIC_MAX_ACK_RANGE_REPEAT: ::core::ffi::c_int = 4 as ::core::ffi::c_int;
pub const NULL: *mut ::core::ffi::c_void =
    ::core::ptr::null::<::core::ffi::c_void>() as *mut ::core::ffi::c_void;
unsafe extern "C" fn picoquic_sack_node_value(
    mut node: *mut picosplay_node_t,
) -> *mut ::core::ffi::c_void {
    return (node as *mut ::core::ffi::c_char).offset(-(0 as ::core::ffi::c_ulong as isize))
        as *mut ::core::ffi::c_void;
}
unsafe extern "C" fn picoquic_sack_item_value(
    mut node: *mut picosplay_node_t,
) -> *mut picoquic_sack_item_t {
    return if node.is_null() {
        ::core::ptr::null_mut::<picoquic_sack_item_t>()
    } else {
        picoquic_sack_node_value(node) as *mut picoquic_sack_item_t
    };
}
unsafe extern "C" fn picoquic_sack_item_compare(
    mut l: *mut ::core::ffi::c_void,
    mut r: *mut ::core::ffi::c_void,
) -> int64_t {
    let mut delta: int64_t = (*(l as *mut picoquic_sack_item_t))
        .start_of_sack_range
        .wrapping_sub((*(r as *mut picoquic_sack_item_t)).start_of_sack_range)
        as int64_t;
    return delta;
}
unsafe extern "C" fn picoquic_sack_node_create(
    mut value: *mut ::core::ffi::c_void,
) -> *mut picosplay_node_t {
    return &raw mut (*(value as *mut picoquic_sack_item_t)).node;
}
unsafe extern "C" fn picoquic_sack_node_delete(
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_sack_first_item(
    mut sack_list: *mut picoquic_sack_list_t,
) -> *mut picoquic_sack_item_t {
    return picoquic_sack_item_value(picosplay_first(&raw mut (*sack_list).ack_tree));
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_sack_last_item(
    mut sack_list: *mut picoquic_sack_list_t,
) -> *mut picoquic_sack_item_t {
    return picoquic_sack_item_value(picosplay_last(&raw mut (*sack_list).ack_tree));
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_sack_next_item(
    mut sack: *mut picoquic_sack_item_t,
) -> *mut picoquic_sack_item_t {
    return picoquic_sack_item_value(picosplay_next(&raw mut (*sack).node));
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_sack_previous_item(
    mut sack: *mut picoquic_sack_item_t,
) -> *mut picoquic_sack_item_t {
    return picoquic_sack_item_value(picosplay_previous(&raw mut (*sack).node));
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_sack_insert_item(
    mut sack_list: *mut picoquic_sack_list_t,
    mut range_min: uint64_t,
    mut range_max: uint64_t,
    mut current_time: uint64_t,
) -> ::core::ffi::c_int {
    let mut ret: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut sack_new: *mut picoquic_sack_item_t =
        malloc(::core::mem::size_of::<picoquic_sack_item_t>() as size_t)
            as *mut picoquic_sack_item_t;
    if sack_new.is_null() {
        ret = -(1 as ::core::ffi::c_int);
    } else {
        memset(
            sack_new as *mut ::core::ffi::c_void,
            0 as ::core::ffi::c_int,
            ::core::mem::size_of::<picoquic_sack_item_t>() as size_t,
        );
        (*sack_new).start_of_sack_range = range_min;
        (*sack_new).end_of_sack_range = range_max;
        (*sack_new).time_created = current_time;
        (*sack_list).rc[0 as ::core::ffi::c_int as usize].range_counts
            [0 as ::core::ffi::c_int as usize] += 1 as ::core::ffi::c_int;
        (*sack_list).rc[1 as ::core::ffi::c_int as usize].range_counts
            [0 as ::core::ffi::c_int as usize] += 1 as ::core::ffi::c_int;
        picosplay_insert(
            &raw mut (*sack_list).ack_tree,
            sack_new as *mut ::core::ffi::c_void,
        );
    }
    return ret;
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_sack_delete_item(
    mut sack_list: *mut picoquic_sack_list_t,
    mut sack: *mut picoquic_sack_item_t,
) {
    let mut r: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    while r < 2 as ::core::ffi::c_int {
        if (*sack).nb_times_sent[r as usize] < PICOQUIC_MAX_ACK_RANGE_REPEAT {
            (*sack_list).rc[r as usize].range_counts[(*sack).nb_times_sent[r as usize] as usize] -=
                1 as ::core::ffi::c_int;
        }
        r += 1;
    }
    picosplay_delete_hint(&raw mut (*sack_list).ack_tree, &raw mut (*sack).node);
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_sack_list_is_empty(
    mut sack_list: *mut picoquic_sack_list_t,
) -> ::core::ffi::c_int {
    return ((*sack_list).ack_tree.size == 0 as ::core::ffi::c_int) as ::core::ffi::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_ack_ctx_from_cnx_context(
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_sack_list_from_cnx_context(
    mut cnx: *mut picoquic_cnx_t,
    mut pc: picoquic_packet_context_enum,
    mut l_cid: *mut picoquic_local_cnxid_t,
) -> *mut picoquic_sack_list_t {
    return &raw mut (*(picoquic_ack_ctx_from_cnx_context
        as unsafe extern "C" fn(
            *mut picoquic_cnx_t,
            picoquic_packet_context_enum,
            *mut picoquic_local_cnxid_t,
        ) -> *mut picoquic_ack_context_t)(cnx, pc, l_cid))
    .sack_list;
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_sack_find_range_below_number(
    mut sack_list: *mut picoquic_sack_list_t,
    mut previous: *mut picoquic_sack_item_t,
    mut pn64: uint64_t,
) -> *mut picoquic_sack_item_t {
    let mut v: picoquic_sack_item_t = st_picoquic_sack_item_t {
        node: st_picosplay_node_t {
    ...
    return picoquic_sack_item_value(picosplay_find_previous(
        &raw mut (*sack_list).ack_tree,
        &raw mut v as *mut ::core::ffi::c_void,
    ));
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_is_pn_already_received(
    mut cnx: *mut picoquic_cnx_t,
    mut pc: picoquic_packet_context_enum,
    mut l_cid: *mut picoquic_local_cnxid_t,
    mut pn64: uint64_t,
) -> ::core::ffi::c_int {
    let mut is_received: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut sack_list: *mut picoquic_sack_list_t =
        picoquic_sack_list_from_cnx_context(cnx, pc, l_cid);
    if (*sack_list).horizon_delay > 0 as int64_t && pn64 < (*sack_list).ack_horizon {
        is_received = 1 as ::core::ffi::c_int;
    } else {
        let mut sack_found: *mut picoquic_sack_item_t = picoquic_sack_find_range_below_number(
            sack_list,
            ::core::ptr::null_mut::<picoquic_sack_item_t>(),
            pn64,
        );
        is_received = (!sack_found.is_null() && pn64 <= (*sack_found).end_of_sack_range)
            as ::core::ffi::c_int;
    }
    return is_received;
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_update_sack_list(
    mut sack_list: *mut picoquic_sack_list_t,
    mut pn64_min: uint64_t,
    mut pn64_max: uint64_t,
    mut current_time: uint64_t,
) -> ::core::ffi::c_int {
    let mut ret: ::core::ffi::c_int = 1 as ::core::ffi::c_int;
    let mut previous: *mut picoquic_sack_item_t = picoquic_sack_find_range_below_number(
        sack_list,
        ::core::ptr::null_mut::<picoquic_sack_item_t>(),
        pn64_min,
    );
    if previous.is_null() || (*previous).end_of_sack_range.wrapping_add(1 as uint64_t) < pn64_min {
        let mut next: *mut picoquic_sack_item_t = if previous.is_null() {
            picoquic_sack_first_item(sack_list)
        } else {
            picoquic_sack_next_item(previous)
        };
        if next.is_null() || (*next).start_of_sack_range.wrapping_sub(1 as uint64_t) > pn64_max {
            ret = picoquic_sack_insert_item(sack_list, pn64_min, pn64_max, current_time);
            previous = ::core::ptr::null_mut::<picoquic_sack_item_t>();
        } else {
    ...
    while !previous.is_null() && (*previous).end_of_sack_range < pn64_max {
        let mut next_0: *mut picoquic_sack_item_t = picoquic_sack_next_item(previous);
        if next_0.is_null() || (*next_0).start_of_sack_range.wrapping_sub(1 as uint64_t) > pn64_max
        {
            ...
            (*previous).end_of_sack_range = (*next_0).end_of_sack_range;
            picoquic_sack_item_record_reset(sack_list, previous);
            if (*next_0).time_created > (*previous).time_created {
                (*previous).time_created = (*next_0).time_created;
            }
            ret = 0 as ::core::ffi::c_int;
            picoquic_sack_delete_item(sack_list, next_0);
        }
    }
    if (*sack_list).horizon_delay > 0 as int64_t {
        picoquic_update_ack_horizon(sack_list, current_time);
    }
    return ret;
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_record_pn_received(
    mut cnx: *mut picoquic_cnx_t,
    mut pc: picoquic_packet_context_enum,
    mut l_cid: *mut picoquic_local_cnxid_t,
    mut pn64: uint64_t,
    mut current_microsec: uint64_t,
) -> ::core::ffi::c_int {
    let mut ret: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut sack_list: *mut picoquic_sack_list_t =
        picoquic_sack_list_from_cnx_context(cnx, pc, l_cid);
    if !sack_list.is_null() {
        if picoquic_sack_list_is_empty(sack_list) != 0 {
            (*cnx).ack_ctx[pc as usize].time_stamp_largest_received = current_microsec;
        } else {
            let mut pn_last: uint64_t = picoquic_sack_list_last(sack_list);
            if pn64 > pn_last {
                if pn64 > pn_last.wrapping_add(1 as uint64_t) {
                    (*cnx).ack_ctx[pc as usize].act[0 as ::core::ffi::c_int as usize]
                        .set_out_of_order_received(1 as ::core::ffi::c_uint as ::core::ffi::c_uint);
                    (*cnx).ack_ctx[pc as usize].act[1 as ::core::ffi::c_int as usize]
                        .set_out_of_order_received(1 as ::core::ffi::c_uint as ::core::ffi::c_uint);
                }
                (*cnx).ack_ctx[pc as usize].time_stamp_largest_received = current_microsec;
            } else {
                if (*cnx).ack_ctx[pc as usize].act[0 as ::core::ffi::c_int as usize].ack_needed()
                    as ::core::ffi::c_int
                    != 0
                    && pn64
                        < (*cnx).ack_ctx[pc as usize].act[0 as ::core::ffi::c_int as usize]
                ...
                if (*cnx).ack_ctx[pc as usize].act[1 as ::core::ffi::c_int as usize].ack_needed()
                    as ::core::ffi::c_int
                    != 0
                    && pn64
                        < (*cnx).ack_ctx[pc as usize].act[1 as ::core::ffi::c_int as usize]
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_sack_select_ack_ranges(
    mut sack_list: *mut picoquic_sack_list_t,
    mut first_sack: *mut picoquic_sack_item_t,
    mut max_ranges: ::core::ffi::c_int,
    mut is_opportunistic: ::core::ffi::c_int,
    mut nb_sent_max: *mut ::core::ffi::c_int,
    mut nb_sent_max_skip: *mut ::core::ffi::c_int,
) {
    let mut cumul_sent: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut first_sack_count: ::core::ffi::c_int = if first_sack.is_null() {
        PICOQUIC_MAX_ACK_RANGE_REPEAT
    } else {
        (*first_sack).nb_times_sent[is_opportunistic as usize]
    };
    *nb_sent_max = PICOQUIC_MAX_ACK_RANGE_REPEAT;
    *nb_sent_max_skip = 0 as ::core::ffi::c_int;
    let mut i: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    while i < PICOQUIC_MAX_ACK_RANGE_REPEAT {
        cumul_sent += (*sack_list).rc[is_opportunistic as usize].range_counts[i as usize];
        if i == first_sack_count {
            cumul_sent -= 1 as ::core::ffi::c_int;
        }
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_check_sack_list(
    mut sack_list: *mut picoquic_sack_list_t,
    mut pn64_min: uint64_t,
    mut pn64_max: uint64_t,
) -> ::core::ffi::c_int {
    let mut ret: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut sack: *mut picoquic_sack_item_t = picoquic_sack_find_range_below_number(
        sack_list,
        ::core::ptr::null_mut::<picoquic_sack_item_t>(),
        pn64_min,
    );
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_process_ack_of_ack_range(
    mut sack_list: *mut picoquic_sack_list_t,
    mut previous: *mut picoquic_sack_item_t,
    mut start_of_range: uint64_t,
    mut end_of_range: uint64_t,
) -> *mut picoquic_sack_item_t {
    previous = picoquic_sack_find_range_below_number(
        sack_list,
        ::core::ptr::null_mut::<picoquic_sack_item_t>(),
        start_of_range,
    );
    if !previous.is_null() && (*previous).start_of_sack_range == start_of_range {
        let mut next: *mut picoquic_sack_item_t =
            picoquic_sack_item_value(picosplay_next(&raw mut (*previous).node));
        if next.is_null() {
            if end_of_range < (*previous).end_of_sack_range {
                (*previous).start_of_sack_range = end_of_range.wrapping_add(1 as uint64_t);
            } else {
            ...
            if (*sack_list).horizon_delay > 0 as int64_t {
                let mut r: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
                while r < 2 as ::core::ffi::c_int {
                    if (*previous).nb_times_sent[r as usize] < PICOQUIC_MAX_ACK_RANGE_REPEAT {
                        (*sack_list).rc[r as usize].range_counts
                            [(*previous).nb_times_sent[r as usize] as usize] -=
                            1 as ::core::ffi::c_int;
                        (*previous).nb_times_sent[r as usize] = PICOQUIC_MAX_ACK_RANGE_REPEAT;
                    }
                    r += 1;
                }
            } else {
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_update_ack_horizon(
    mut sack_list: *mut picoquic_sack_list_t,
    mut current_time: uint64_t,
) {
    let mut first_sack: *mut picoquic_sack_item_t = picoquic_sack_first_item(sack_list);
    while !first_sack.is_null()
        && (*first_sack).nb_times_sent[0 as ::core::ffi::c_int as usize]
            >= PICOQUIC_MAX_ACK_RANGE_REPEAT
    {
        let mut delay: int64_t = current_time.wrapping_sub((*first_sack).time_created) as int64_t;
        if !(delay > (*sack_list).horizon_delay) {
            break;
        }
        let mut next_sack: *mut picoquic_sack_item_t = picoquic_sack_next_item(first_sack);
        if !next_sack.is_null() {
            (*sack_list).ack_horizon = (*first_sack).end_of_sack_range.wrapping_add(1 as uint64_t);
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_sack_list_first(
    mut sack_list: *mut picoquic_sack_list_t,
) -> uint64_t {
    let mut first: *mut picoquic_sack_item_t = picoquic_sack_first_item(sack_list);
    return if first.is_null() {
        UINT64_MAX as uint64_t
    } else {
        (*first).start_of_sack_range
    };
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_sack_list_last(
    mut sack_list: *mut picoquic_sack_list_t,
) -> uint64_t {
    let mut last: *mut picoquic_sack_item_t = picoquic_sack_last_item(sack_list);
    return if last.is_null() {
        0 as uint64_t
    } else {
        (*last).end_of_sack_range
    };
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_sack_list_first_range(
    mut sack_list: *mut picoquic_sack_list_t,
) -> *mut picoquic_sack_item_t {
    let mut first: *mut picoquic_sack_item_t = picoquic_sack_first_item(sack_list);
    return if first.is_null() {
        ...
        picoquic_sack_item_value(picosplay_next(&raw mut (*first).node))
    };
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_sack_list_init(mut sack_list: *mut picoquic_sack_list_t) {
    memset(
        sack_list as *mut ::core::ffi::c_void,
        0 as ::core::ffi::c_int,
        ::core::mem::size_of::<picoquic_sack_list_t>() as size_t,
    );
    picosplay_init_tree(
        &raw mut (*sack_list).ack_tree,
        Some(
            picoquic_sack_item_compare
                as unsafe extern "C" fn(
                    *mut ::core::ffi::c_void,
                    *mut ::core::ffi::c_void,
                ) -> int64_t,
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_sack_list_free(mut sack_list: *mut picoquic_sack_list_t) {
    picosplay_empty_tree(&raw mut (*sack_list).ack_tree);
    let mut r: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    while r < 2 as ::core::ffi::c_int {
        memset(
            &raw mut (*(&raw mut (*sack_list).rc as *mut picoquic_sack_range_count_t)
                .offset(r as isize))
            .range_counts as *mut ::core::ffi::c_int as *mut ::core::ffi::c_void,
            0 as ::core::ffi::c_int,
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_sack_item_range_start(
    mut sack_item: *mut picoquic_sack_item_t,
) -> uint64_t {
    return (*sack_item).start_of_sack_range;
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_sack_item_range_end(
    mut sack_item: *mut picoquic_sack_item_t,
) -> uint64_t {
    return (*sack_item).end_of_sack_range;
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_sack_item_nb_times_sent(
    mut sack_item: *mut picoquic_sack_item_t,
    mut is_opportunistic: ::core::ffi::c_int,
) -> ::core::ffi::c_int {
    return (*sack_item).nb_times_sent[is_opportunistic as usize];
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_sack_item_record_sent(
    mut sack_list: *mut picoquic_sack_list_t,
    mut sack_item: *mut picoquic_sack_item_t,
    mut is_opportunistic: ::core::ffi::c_int,
) {
    if (*sack_item).nb_times_sent[is_opportunistic as usize] < PICOQUIC_MAX_ACK_RANGE_REPEAT {
        (*sack_list).rc[is_opportunistic as usize].range_counts
            [(*sack_item).nb_times_sent[is_opportunistic as usize] as usize] -=
            1 as ::core::ffi::c_int;
    }
    (*sack_item).nb_times_sent[is_opportunistic as usize] += 1;
    if (*sack_item).nb_times_sent[is_opportunistic as usize] < PICOQUIC_MAX_ACK_RANGE_REPEAT {
        (*sack_list).rc[is_opportunistic as usize].range_counts
            [(*sack_item).nb_times_sent[is_opportunistic as usize] as usize] +=
            1 as ::core::ffi::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_sack_item_record_reset(
    mut sack_list: *mut picoquic_sack_list_t,
    mut sack_item: *mut picoquic_sack_item_t,
) {
    let mut r: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    while r < 2 as ::core::ffi::c_int {
        if (*sack_item).nb_times_sent[r as usize] < PICOQUIC_MAX_ACK_RANGE_REPEAT {
            (*sack_list).rc[r as usize].range_counts
                [(*sack_item).nb_times_sent[r as usize] as usize] -= 1 as ::core::ffi::c_int;
        }
        (*sack_item).nb_times_sent[r as usize] = 0 as ::core::ffi::c_int;
        (*sack_list).rc[r as usize].range_counts
            [(*sack_item).nb_times_sent[r as usize] as usize] += 1 as ::core::ffi::c_int;
        r += 1;
    }
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_sack_list_size(
    mut sack_list: *mut picoquic_sack_list_t,
) -> size_t {
    return (*sack_list).ack_tree.size as size_t;
}
