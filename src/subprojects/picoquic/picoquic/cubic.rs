...
pub type picoquic_cubic_state_t = st_picoquic_cubic_state_t;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct st_picoquic_cubic_state_t {
    pub alg_state: picoquic_cubic_alg_state_t,
    pub recovery_sequence: uint64_t,
    pub start_of_epoch: uint64_t,
    pub previous_start_of_epoch: uint64_t,
    pub K: ::core::ffi::c_double,
    pub W_max: ::core::ffi::c_double,
    pub W_last_max: ::core::ffi::c_double,
    pub C: ::core::ffi::c_double,
    pub beta: ::core::ffi::c_double,
    pub W_reno: ::core::ffi::c_double,
    pub ssthresh: uint64_t,
...
pub type picoquic_cubic_alg_state_t = ::core::ffi::c_uint;
pub const picoquic_cubic_alg_congestion_avoidance: picoquic_cubic_alg_state_t = 2;
pub const picoquic_cubic_alg_recovery: picoquic_cubic_alg_state_t = 1;
pub const picoquic_cubic_alg_slow_start: picoquic_cubic_alg_state_t = 0;
...
pub const PICOQUIC_CC_ALGO_NUMBER_CUBIC: ::core::ffi::c_int = 2 as ::core::ffi::c_int;
pub const PICOQUIC_CC_ALGO_NUMBER_DCUBIC: ::core::ffi::c_int = 3 as ::core::ffi::c_int;
pub const NULL: *mut ::core::ffi::c_void =
    ::core::ptr::null::<::core::ffi::c_void>() as *mut ::core::ffi::c_void;
pub const PICOQUIC_SMOOTHED_LOSS_THRESHOLD: ::core::ffi::c_double = 0.15f64;
unsafe extern "C" fn picoquic_cubic_reset(
    mut cubic_state: *mut picoquic_cubic_state_t,
    mut path_x: *mut picoquic_path_t,
    mut current_time: uint64_t,
) {
    memset(
        &raw mut (*cubic_state).rtt_filter as *mut ::core::ffi::c_void,
        0 as ::core::ffi::c_int,
        ::core::mem::size_of::<picoquic_min_max_rtt_t>() as size_t,
    );
    memset(
        cubic_state as *mut ::core::ffi::c_void,
        0 as ::core::ffi::c_int,
        ::core::mem::size_of::<picoquic_cubic_state_t>() as size_t,
    );
    (*cubic_state).alg_state = picoquic_cubic_alg_slow_start;
    (*cubic_state).ssthresh = UINT64_MAX as uint64_t;
    (*cubic_state).W_last_max = (*cubic_state).ssthresh as ::core::ffi::c_double
        / (*path_x).send_mtu as ::core::ffi::c_double;
    (*cubic_state).W_max = (*cubic_state).W_last_max;
    (*cubic_state).C = 0.6f64;
    (*cubic_state).beta = 19.0f64 / 20.0f64;
    (*cubic_state).start_of_epoch = current_time;
    (*cubic_state).previous_start_of_epoch = 0 as uint64_t;
    (*cubic_state).W_reno =
        (10 as size_t).wrapping_mul((*path_x).send_mtu) as ::core::ffi::c_double;
    (*cubic_state).recovery_sequence = 0 as uint64_t;
    (*path_x).cwin = (10 as size_t).wrapping_mul((*path_x).send_mtu) as uint64_t;
}
unsafe extern "C" fn picoquic_cubic_init(
    mut cnx: *mut picoquic_cnx_t,
    mut path_x: *mut picoquic_path_t,
    mut current_time: uint64_t,
) {
    let mut cubic_state: *mut picoquic_cubic_state_t =
        malloc(::core::mem::size_of::<picoquic_cubic_state_t>() as size_t)
            as *mut picoquic_cubic_state_t;
    (*path_x).congestion_alg_state = cubic_state as *mut ::core::ffi::c_void;
    if !cubic_state.is_null() {
        picoquic_cubic_reset(cubic_state, path_x, current_time);
    }
}
unsafe extern "C" fn picoquic_cubic_root(mut x: ::core::ffi::c_double) -> ::core::ffi::c_double {
    let mut v: ::core::ffi::c_double = 1 as ::core::ffi::c_int as ::core::ffi::c_double;
    let mut y: ::core::ffi::c_double = 1.0f64;
    let mut y2: ::core::ffi::c_double = 0.;
    let mut y3: ::core::ffi::c_double = 0.;
    while v > x * 8 as ::core::ffi::c_int as ::core::ffi::c_double {
        v /= 8 as ::core::ffi::c_int as ::core::ffi::c_double;
        y /= 2 as ::core::ffi::c_int as ::core::ffi::c_double;
    }
    while v < x {
        v *= 8 as ::core::ffi::c_int as ::core::ffi::c_double;
        y *= 2 as ::core::ffi::c_int as ::core::ffi::c_double;
...
unsafe extern "C" fn picoquic_cubic_W_cubic(
    mut cubic_state: *mut picoquic_cubic_state_t,
    mut current_time: uint64_t,
) -> ::core::ffi::c_double {
    let mut delta_t_sec: ::core::ffi::c_double =
        current_time.wrapping_sub((*cubic_state).start_of_epoch) as ::core::ffi::c_double
            / 1000000.0f64
            - (*cubic_state).K;
    let mut W_cubic: ::core::ffi::c_double =
        (*cubic_state).C * (delta_t_sec * delta_t_sec * delta_t_sec) + (*cubic_state).W_max;
    return W_cubic;
}
unsafe extern "C" fn picoquic_cubic_enter_avoidance(
    mut cubic_state: *mut picoquic_cubic_state_t,
    mut current_time: uint64_t,
) {
    (*cubic_state).K = picoquic_cubic_root(
        (*cubic_state).W_max * (1.0f64 - (*cubic_state).beta) / (*cubic_state).C,
    );
...
unsafe extern "C" fn picoquic_cubic_enter_recovery(
    mut cnx: *mut picoquic_cnx_t,
    mut path_x: *mut picoquic_path_t,
    ...
    (*cubic_state).W_max =
        (*path_x).cwin as ::core::ffi::c_double / (*path_x).send_mtu as ::core::ffi::c_double;
    ...
    (*cubic_state).ssthresh = ((*cubic_state).W_max
        * (*cubic_state).beta
        * (*path_x).send_mtu as ::core::ffi::c_double) as uint64_t;
    if (*cubic_state).ssthresh < (2 as uint64_t).wrapping_mul((*path_x).send_mtu as uint64_t) {
        (*cubic_state).alg_state = picoquic_cubic_alg_slow_start;
        (*cubic_state).ssthresh = UINT64_MAX as uint64_t;
        (*path_x).set_is_ssthresh_initialized(0 as ::core::ffi::c_uint as ::core::ffi::c_uint);
        (*cubic_state).previous_start_of_epoch = (*cubic_state).start_of_epoch;
        (*cubic_state).start_of_epoch = current_time;
        (*cubic_state).W_reno =
            (2 as size_t).wrapping_mul((*path_x).send_mtu) as ::core::ffi::c_double;
        (*path_x).cwin = (2 as size_t).wrapping_mul((*path_x).send_mtu) as uint64_t;
    } else if notification as ::core::ffi::c_uint
        == picoquic_congestion_notification_timeout as ::core::ffi::c_int as ::core::ffi::c_uint
    {
        (*path_x).cwin = (2 as size_t).wrapping_mul((*path_x).send_mtu) as uint64_t;
        (*cubic_state).previous_start_of_epoch = (*cubic_state).start_of_epoch;
        (*cubic_state).start_of_epoch = current_time;
        ...
        let mut W_cubic: ::core::ffi::c_double = picoquic_cubic_W_cubic(cubic_state, current_time);
        let mut win_cubic: uint64_t =
            (W_cubic * (*path_x).send_mtu as ::core::ffi::c_double) as uint64_t;
        (*cubic_state).W_reno = (*path_x).cwin as ::core::ffi::c_double / 2.0f64;
        if win_cubic as ::core::ffi::c_double > (*cubic_state).W_reno {
            (*path_x).cwin = win_cubic;
        } else {
            (*path_x).cwin = (*cubic_state).W_reno as uint64_t;
        }
    };
}
unsafe extern "C" fn picoquic_cubic_correct_spurious(
    mut path_x: *mut picoquic_path_t,
    mut cubic_state: *mut picoquic_cubic_state_t,
    mut current_time: uint64_t,
) {
    if (*cubic_state).ssthresh != UINT64_MAX as uint64_t {
        (*cubic_state).W_max = (*cubic_state).W_last_max;
        picoquic_cubic_enter_avoidance(cubic_state, (*cubic_state).previous_start_of_epoch);
        let mut W_cubic: ::core::ffi::c_double = picoquic_cubic_W_cubic(cubic_state, current_time);
        (*cubic_state).W_reno = W_cubic * (*path_x).send_mtu as ::core::ffi::c_double;
        (*cubic_state).ssthresh = ((*cubic_state).W_max
            * (*cubic_state).beta
            * (*path_x).send_mtu as ::core::ffi::c_double)
            as uint64_t;
...
unsafe extern "C" fn cubic_update_bandwidth(mut path_x: *mut picoquic_path_t) {
    let mut max_win: uint64_t = (*path_x)
        .peak_bandwidth_estimate
        .wrapping_mul((*path_x).smoothed_rtt)
...
unsafe extern "C" fn picoquic_cubic_notify(
    mut cnx: *mut picoquic_cnx_t,
    mut path_x: *mut picoquic_path_t,
    mut notification: picoquic_congestion_notification_t,
    ...
    let mut cubic_state: *mut picoquic_cubic_state_t =
        (*path_x).congestion_alg_state as *mut picoquic_cubic_state_t;
    (*path_x).set_is_cc_data_updated(1 as ::core::ffi::c_uint as ::core::ffi::c_uint);
    if !cubic_state.is_null() {
        match (*cubic_state).alg_state as ::core::ffi::c_uint {
            0 => match notification as ::core::ffi::c_uint {
                0 => {
                        ...
                        > (*path_x).last_sender_limited_time
                    {
                        picoquic_hystart_increase(
                            path_x,
                            &raw mut (*cubic_state).rtt_filter,
                            (*ack_state).nb_bytes_acknowledged,
                        );
                        if (*path_x).cwin >= (*cubic_state).ssthresh {
                            (*cubic_state).W_reno =
                                (*path_x).cwin as ::core::ffi::c_double / 2.0f64;
                            (*path_x).set_is_ssthresh_initialized(
                ...
                1 | 5 | 2 => {
                    if (notification as ::core::ffi::c_uint
                        == picoquic_congestion_notification_ecn_ec as ::core::ffi::c_int
                            as ::core::ffi::c_uint
                        ...
                        && (current_time.wrapping_sub((*cubic_state).start_of_epoch)
                            > (*path_x).smoothed_rtt
                            || (*cubic_state).recovery_sequence
                                <= picoquic_cc_get_ack_number(cnx, path_x))
                    {
                        (*path_x).set_is_ssthresh_initialized(
                            1 as ::core::ffi::c_uint as ::core::ffi::c_uint,
                        );
                        picoquic_cubic_enter_recovery(
                            cnx,
                            path_x,
                            notification,
                            cubic_state,
                ...
                4 => {
                    ...
                    {
                        if (*cubic_state).rtt_filter.rtt_filtered_min as ::core::ffi::c_ulonglong
                            > PICOQUIC_TARGET_RENO_RTT
                        {
                            let mut correction: ::core::ffi::c_double = 0.;
                            if (*cubic_state).rtt_filter.rtt_filtered_min
                                as ::core::ffi::c_ulonglong
                                > PICOQUIC_TARGET_SATELLITE_RTT
                            {
                                correction = PICOQUIC_TARGET_SATELLITE_RTT as ::core::ffi::c_double
                                    / (*cubic_state).rtt_filter.rtt_filtered_min
                                        as ::core::ffi::c_double;
                            } else {
                                correction = PICOQUIC_TARGET_RENO_RTT as ::core::ffi::c_double
                                    / (*cubic_state).rtt_filter.rtt_filtered_min
                                        as ::core::ffi::c_double;
                            }
                            let mut base_window: uint64_t =
                                (correction * (*path_x).cwin as ::core::ffi::c_double) as uint64_t;
                            let mut delta_window: uint64_t =
                                (*path_x).cwin.wrapping_sub(base_window);
                            (*path_x).cwin = (*path_x)
                                .cwin
                                .wrapping_sub(delta_window.wrapping_div(2 as uint64_t));
                        }
                        (*cubic_state).ssthresh = (*path_x).cwin;
                        (*cubic_state).W_max = (*path_x).cwin as ::core::ffi::c_double
                            / (*path_x).send_mtu as ::core::ffi::c_double;
                        (*cubic_state).W_last_max = (*cubic_state).W_max;
                        (*cubic_state).W_reno = (*path_x).cwin as ::core::ffi::c_double;
                        (*path_x).set_is_ssthresh_initialized(
                            1 as ::core::ffi::c_uint as ::core::ffi::c_uint,
                        );
                        picoquic_cubic_enter_avoidance(cubic_state, current_time);
                        let mut K_micro: uint64_t = ((*cubic_state).K * 1000000.0f64) as uint64_t;
                        if K_micro > current_time {
                            (*cubic_state).K = current_time as ::core::ffi::c_double / 1000000.0f64;
                            (*cubic_state).start_of_epoch = 0 as uint64_t;
                        } else {
                            (*cubic_state).start_of_epoch = current_time.wrapping_sub(K_micro);
                        }
                    }
                }
                8 => {
            ...
            1 => match notification as ::core::ffi::c_uint {
                0 => {
                    (*cubic_state).alg_state = picoquic_cubic_alg_slow_start;
                    (*path_x).cwin = (*path_x)
                        .cwin
                ...
                1 | 5 | 2 => {
                    if (*ack_state).lost_packet_number >= (*cubic_state).recovery_sequence
                        && (notification as ::core::ffi::c_uint
                            == picoquic_congestion_notification_ecn_ec as ::core::ffi::c_int
                                as ::core::ffi::c_uint
                            || picoquic_hystart_loss_test(
                                &raw mut (*cubic_state).rtt_filter,
            ...
            2 => match notification as ::core::ffi::c_uint {
                0 => {
                    if (*path_x).last_time_acked_data_frame_sent
                        > (*path_x).last_sender_limited_time
                    {
                        let mut W_cubic: ::core::ffi::c_double = 0.;
                        let mut win_cubic: uint64_t = 0;
                        ...
                        win_cubic =
                            (W_cubic * (*path_x).send_mtu as ::core::ffi::c_double) as uint64_t;
                        (*cubic_state).W_reno += (*ack_state).nb_bytes_acknowledged
                            as ::core::ffi::c_double
                            * (*path_x).send_mtu as ::core::ffi::c_double
                            / (*cubic_state).W_reno;
                        if win_cubic as ::core::ffi::c_double > (*cubic_state).W_reno {
        ...
        picoquic_update_pacing_data(
            cnx,
            path_x,
            ((*cubic_state).alg_state as ::core::ffi::c_uint
                == picoquic_cubic_alg_slow_start as ::core::ffi::c_int as ::core::ffi::c_uint
                && (*cubic_state).ssthresh == UINT64_MAX as uint64_t)
                as ::core::ffi::c_int,
        );
    }
}
unsafe extern "C" fn dcubic_exit_slow_start(
    mut cnx: *mut picoquic_cnx_t,
    mut path_x: *mut picoquic_path_t,
    mut notification: picoquic_congestion_notification_t,
    mut cubic_state: *mut picoquic_cubic_state_t,
    ...
    } else if current_time.wrapping_sub((*cubic_state).start_of_epoch) > (*path_x).smoothed_rtt
...
unsafe extern "C" fn picoquic_dcubic_notify(
    mut cnx: *mut picoquic_cnx_t,
    mut path_x: *mut picoquic_path_t,
    mut notification: picoquic_congestion_notification_t,
    mut ack_state: *mut picoquic_per_ack_state_t,
            ...
            0 => match notification as ::core::ffi::c_uint {
                ...
                4 => {
                    if (*path_x).rtt_min as ::core::ffi::c_ulonglong > PICOQUIC_TARGET_RENO_RTT
                        && (*cubic_state).ssthresh == UINT64_MAX as uint64_t
                    {
                        let mut min_cwnd: uint64_t = 0;
                        if (*path_x).rtt_min as ::core::ffi::c_ulonglong
                            > PICOQUIC_TARGET_SATELLITE_RTT
                        {
                            min_cwnd = ((10 as size_t).wrapping_mul((*path_x).send_mtu)
                                as ::core::ffi::c_double
                                * PICOQUIC_TARGET_SATELLITE_RTT as ::core::ffi::c_double
                                / PICOQUIC_TARGET_RENO_RTT as ::core::ffi::c_double)
                                as uint64_t;
                        } else {
                            min_cwnd = ((10 as size_t).wrapping_mul((*path_x).send_mtu)
                                as ::core::ffi::c_double
                                * (*path_x).rtt_min as ::core::ffi::c_double
                                / PICOQUIC_TARGET_RENO_RTT as ::core::ffi::c_double)
                                as uint64_t;
                        }
            ...
            1 => match notification as ::core::ffi::c_uint {
                ...
                4 => {
                    if (*path_x).rtt_min as ::core::ffi::c_ulonglong > PICOQUIC_TARGET_RENO_RTT
                        && (*cubic_state).ssthresh == UINT64_MAX as uint64_t
                    {
                        let mut min_cwnd_0: uint64_t = 0;
                        if (*path_x).rtt_min as ::core::ffi::c_ulonglong
                            > PICOQUIC_TARGET_SATELLITE_RTT
                        {
                            min_cwnd_0 = ((10 as size_t).wrapping_mul((*path_x).send_mtu)
                                as ::core::ffi::c_double
                                * PICOQUIC_TARGET_SATELLITE_RTT as ::core::ffi::c_double
                                / PICOQUIC_TARGET_RENO_RTT as ::core::ffi::c_double)
                                as uint64_t;
                        ...
                        if min_cwnd_0 > (*path_x).cwin {
                            (*path_x).cwin = min_cwnd_0;
                        }
                    }
                    if picoquic_hystart_test(
                        &raw mut (*cubic_state).rtt_filter,
                    ...
                    {
                        if current_time.wrapping_sub((*cubic_state).start_of_epoch)
                            > (*path_x).smoothed_rtt
                            || (*cubic_state).recovery_sequence
                                <= picoquic_cc_get_ack_number(cnx, path_x)
                        {
...
unsafe extern "C" fn picoquic_cubic_delete(mut path_x: *mut picoquic_path_t) {
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_cubic_observe(
    mut path_x: *mut picoquic_path_t,
    ...
    let mut cubic_state: *mut picoquic_cubic_state_t =
        (*path_x).congestion_alg_state as *mut picoquic_cubic_state_t;
    *cc_state = (*cubic_state).alg_state as uint64_t;
    *cc_param = (*cubic_state).W_max as uint64_t;
}
pub const picoquic_cubic_ID: [::core::ffi::c_char; 6] =
    unsafe { ::core::mem::transmute::<[u8; 6], [::core::ffi::c_char; 6]>(*b"cubic\0") };
pub const picoquic_dcubic_ID: [::core::ffi::c_char; 7] =
    unsafe { ::core::mem::transmute::<[u8; 7], [::core::ffi::c_char; 7]>(*b"dcubic\0") };
#[no_mangle]
pub static mut picoquic_cubic_algorithm_struct: picoquic_congestion_algorithm_t = unsafe {
    st_picoquic_congestion_algorithm_t {
        congestion_algorithm_id: picoquic_cubic_ID.as_ptr(),
        congestion_algorithm_number: PICOQUIC_CC_ALGO_NUMBER_CUBIC as uint8_t,
        alg_init: Some(
            picoquic_cubic_init
        ...
        alg_delete: Some(picoquic_cubic_delete as unsafe extern "C" fn(*mut picoquic_path_t) -> ()),
        alg_observe: Some(
...
#[no_mangle]
pub static mut picoquic_dcubic_algorithm_struct: picoquic_congestion_algorithm_t = unsafe {
    st_picoquic_congestion_algorithm_t {
        congestion_algorithm_id: picoquic_dcubic_ID.as_ptr(),
        congestion_algorithm_number: PICOQUIC_CC_ALGO_NUMBER_DCUBIC as uint8_t,
        alg_init: Some(
            picoquic_cubic_init
                as unsafe extern "C" fn(*mut picoquic_cnx_t, *mut picoquic_path_t, uint64_t) -> (),
        ),
...
#[no_mangle]
pub static mut picoquic_cubic_algorithm: *mut picoquic_congestion_algorithm_t =
    unsafe { &raw const picoquic_cubic_algorithm_struct as *mut picoquic_congestion_algorithm_t };
#[no_mangle]
pub static mut picoquic_dcubic_algorithm: *mut picoquic_congestion_algorithm_t =
    unsafe { &raw const picoquic_dcubic_algorithm_struct as *mut picoquic_congestion_algorithm_t };
