...
extern "C" {
    ...
    fn picoquic_reset_path_mtu(path_x: *mut picoquic_path_t);
    ...
    fn picoquic_predict_packet_header_length(
        cnx: *mut picoquic_cnx_t,
    ...
    fn picoquic_decode_datagram_frame_header(
        bytes: *mut uint8_t,
        bytes_max: *const uint8_t,
        frame_id: *mut uint8_t,
        length: *mut uint64_t,
    ) -> *mut uint8_t;
...
pub const PICOQUIC_RACK_DELAY: ::core::ffi::c_ulonglong = 300000 as ::core::ffi::c_ulonglong;
pub const PICOQUIC_MTU_LOSS_THRESHOLD: ::core::ffi::c_int = 10 as ::core::ffi::c_int;
pub const NULL: *mut ::core::ffi::c_void =
    ::core::ptr::null::<::core::ffi::c_void>() as *mut ::core::ffi::c_void;
#[no_mangle]
pub unsafe extern "C" fn picoquic_retransmit_needed(
        ...
        && (*cnx).is_multipath_enabled() as ::core::ffi::c_int != 0
    {
        ...
        while i < (*cnx).nb_paths {
            if length == 0 as size_t {
                length = picoquic_retransmit_needed_loop(
                    cnx,
            ...
            } else if !(**(*cnx).path.offset(i as isize))
                .pkt_ctx
                .pending_first
                .is_null()
            {
                picoquic_set_wake_up_from_packet_retransmit(
                    cnx,
                    (**(*cnx).path.offset(i as isize)).pkt_ctx.pending_first,
                    current_time,
                    next_wake_time,
                );
            }
...
unsafe extern "C" fn picoquic_retransmit_needed_loop(
    mut cnx: *mut picoquic_cnx_t,
    ...
    let mut continue_next: ::core::ffi::c_int = 1 as ::core::ffi::c_int;
    let mut length: size_t = 0 as size_t;
    let mut old_p: *mut picoquic_packet_t = (*pkt_ctx).pending_first;
    while !old_p.is_null() && continue_next != 0 {
        let mut p_next: *mut picoquic_packet_t = (*old_p).packet_next as *mut picoquic_packet_t;
        length = picoquic_retransmit_needed_packet(
            cnx,
            pkt_ctx,
            old_p,
            pc,
            ...
            send_buffer_max,
            header_length,
            &raw mut continue_next,
        );
        old_p = p_next;
    }
    return length;
}
unsafe extern "C" fn picoquic_retransmit_needed_packet(
    mut cnx: *mut picoquic_cnx_t,
    mut pkt_ctx: *mut picoquic_packet_context_t,
    ...
    mut send_buffer_max: size_t,
    mut header_length: *mut size_t,
    mut continue_next: *mut ::core::ffi::c_int,
) -> size_t {
    let mut length: size_t = 0 as size_t;
    *continue_next = 0 as ::core::ffi::c_int;
    let mut old_path: *mut picoquic_path_t = (*old_p).send_path as *mut picoquic_path_t;
    let mut is_probably_lost: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut is_timer_expired: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut next_retransmit_time: uint64_t = *next_wake_time;
    length = 0 as size_t;
    if (*old_p).ptype as ::core::ffi::c_uint
    ...
    {
        *continue_next = 1 as ::core::ffi::c_int;
        return 0 as size_t;
    }
    is_probably_lost = ((*cnx).initial_repeat_needed() as ::core::ffi::c_int != 0
        || (*old_p).send_path.is_null()
        || picoquic_is_packet_probably_lost(
            cnx,
            old_p,
            current_time,
            &raw mut next_retransmit_time,
            &raw mut is_timer_expired,
        ) != 0) as ::core::ffi::c_int;
    if is_probably_lost != 0
        && ((*old_p).ptype as ::core::ffi::c_uint
                ...
                == picoquic_packet_handshake as ::core::ffi::c_int as ::core::ffi::c_uint)
    {
        if (*old_p).length > send_buffer_max {
            picoquic_log_app_message(
                ...
                b"Delay retransmission in type %d, seq %lu, buffer too small\0".as_ptr()
    ...
    if is_probably_lost != 0 {
        if (*old_p).is_ack_trap() != 0 {
            ...
            *continue_next = 1 as ::core::ffi::c_int;
            ...
            let mut packet_is_pure_ack: ::core::ffi::c_int = 1 as ::core::ffi::c_int;
            old_p = picoquic_process_lost_packet(
                cnx,
                pkt_ctx,
                old_p,
                0 as ::core::ffi::c_int,
                ...
                send_buffer_max,
                &raw mut length,
                &raw mut packet_is_pure_ack,
                header_length,
            );
            if old_p.is_null() || packet_is_pure_ack != 0 {
                length = 0 as size_t;
                *continue_next = 1 as ::core::ffi::c_int;
            }
            if length == 0 as size_t {
            ...
            *continue_next = 1 as ::core::ffi::c_int;
            ...
            if next_retransmit_time < *next_wake_time {
                *next_wake_time = next_retransmit_time;
                (*(*cnx).quic).wake_file = 5 as ::core::ffi::c_int;
                (*(*cnx).quic).wake_line = 375 as ::core::ffi::c_int;
            }
            *continue_next = 0 as ::core::ffi::c_int;
        }
        ...
        <= picoquic_state_client_ready_start as ::core::ffi::c_int as ::core::ffi::c_uint
    {
        let mut packet_is_pure_ack_0: ::core::ffi::c_int = 0;
        if !old_path.is_null()
            && (((*old_p).sequence_number > (*pkt_ctx).highest_acknowledged
                ...
                || (*old_path).last_loss_event_detected == 0 as uint64_t)
        {
            (*old_path).nb_retransmit = (*old_path).nb_retransmit.wrapping_add(1);
        ...
        old_p = picoquic_process_lost_packet(
            ...
            send_buffer_max,
            &raw mut length,
            &raw mut packet_is_pure_ack_0,
            header_length,
        );
        if old_p.is_null() || packet_is_pure_ack_0 != 0 {
            length = 0 as size_t;
            *continue_next = 1 as ::core::ffi::c_int;
        }
    } else if picoquic_is_packet_ack_eliciting(old_p) == 0 {
        if !(*old_p).send_path.is_null() && (*cnx).is_multipath_enabled() as ::core::ffi::c_int != 0
        {
            (*(*old_p).send_path).set_is_ack_lost(1 as ::core::ffi::c_uint as ::core::ffi::c_uint);
        }
        picoquic_dequeue_retransmit_packet(
            cnx,
            pkt_ctx,
        ...
        length = 0 as size_t;
        *continue_next = 1 as ::core::ffi::c_int;
    } else if (*old_path).is_pto_required() as ::core::ffi::c_int != 0 && path_x == old_path {
        length = 0 as size_t;
        *continue_next = 0 as ::core::ffi::c_int;
    } else {
        let mut packet_is_pure_ack_1: ::core::ffi::c_int = 1 as ::core::ffi::c_int;
        old_p = picoquic_process_lost_packet(
            cnx,
            pkt_ctx,
            old_p,
            ...
            send_buffer_max,
            &raw mut length,
            &raw mut packet_is_pure_ack_1,
            header_length,
        );
        if packet_is_pure_ack_1 != 0 {
            length = 0 as size_t;
            *continue_next = 1 as ::core::ffi::c_int;
        } else {
            if !old_path.is_null() {
                if path_x == old_path {
                    (*old_path)
                        .set_is_pto_required(1 as ::core::ffi::c_uint as ::core::ffi::c_uint);
                }
                (*old_path).nb_retransmit = (*old_path).nb_retransmit.wrapping_add(1);
                (*old_path).last_loss_event_detected = current_time;
                ...
                if (*old_path).nb_retransmit > 9 as uint64_t
                    && (*cnx).cnx_state as ::core::ffi::c_uint
                        >= picoquic_state_ready as ::core::ffi::c_int as ::core::ffi::c_uint
                {
                    picoquic_log_app_message(
                        ...
                        b"Too many data retransmits, abandon path\0".as_ptr()
                            as *const ::core::ffi::c_char,
                    );
                    if (*cnx).is_multipath_enabled() != 0 {
                        let mut all_paths_dubious: ::core::ffi::c_int = 1 as ::core::ffi::c_int;
                        let mut path_id: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
                        while path_id < (*cnx).nb_paths {
                            if (**(*cnx).path.offset(path_id as isize)).nb_retransmit
                                == 0 as uint64_t
                            {
                                all_paths_dubious = 0 as ::core::ffi::c_int;
                                break;
                            } else {
                                path_id += 1;
                            }
                        }
                        if all_paths_dubious == 0 {
                            (*old_path).set_challenge_failed(
                                1 as ::core::ffi::c_uint as ::core::ffi::c_uint,
                            );
                            (*cnx).set_path_demotion_needed(
                                1 as ::core::ffi::c_uint as ::core::ffi::c_uint,
                            );
                        }
                    } else {
                        (*old_path)
                            .set_challenge_failed(1 as ::core::ffi::c_uint as ::core::ffi::c_uint);
                        (*cnx).set_path_demotion_needed(
                            1 as ::core::ffi::c_uint as ::core::ffi::c_uint,
                        );
                    }
            ...
            if (old_path.is_null() || (*old_path).nb_retransmit > 9 as uint64_t)
                && (*cnx).cnx_state as ::core::ffi::c_uint
                    >= picoquic_state_ready as ::core::ffi::c_int as ::core::ffi::c_uint
            {
                let mut all_paths_bad: ::core::ffi::c_int = 1 as ::core::ffi::c_int;
                if (*cnx).is_multipath_enabled() != 0 {
                    let mut path_id_0: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
                    while path_id_0 < (*cnx).nb_paths {
                        if (**(*cnx).path.offset(path_id_0 as isize)).nb_retransmit <= 9 as uint64_t
                        {
                            all_paths_bad = 0 as ::core::ffi::c_int;
                            break;
                        } else {
                            path_id_0 += 1;
                        }
...
unsafe extern "C" fn picoquic_is_packet_probably_lost(
    mut cnx: *mut picoquic_cnx_t,
    mut old_p: *mut picoquic_packet_t,
    mut current_time: uint64_t,
    mut next_retransmit_time: *mut uint64_t,
    mut is_timer_expired: *mut ::core::ffi::c_int,
) -> ::core::ffi::c_int {
    let mut retransmit_time: uint64_t = UINT64_MAX as uint64_t;
    let mut delta_seq: int64_t = 0 as int64_t;
    let mut delta_sent: int64_t = 0 as int64_t;
    let mut rack_timer_min: uint64_t = 0;
    let mut is_probably_lost: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    *is_timer_expired = 0 as ::core::ffi::c_int;
    if (*old_p).ptype as ::core::ffi::c_uint
        == picoquic_packet_0rtt_protected as ::core::ffi::c_int as ::core::ffi::c_uint
        && (*cnx).zero_rtt_data_accepted() == 0
    {
        retransmit_time = current_time;
        is_probably_lost = 1 as ::core::ffi::c_int;
    } else if (*old_p).ptype as ::core::ffi::c_uint
        == picoquic_packet_0rtt_protected as ::core::ffi::c_int as ::core::ffi::c_uint
        && (*cnx).cnx_state as ::core::ffi::c_uint
            != picoquic_state_ready as ::core::ffi::c_int as ::core::ffi::c_uint
        && (*cnx).cnx_state as ::core::ffi::c_uint
            != picoquic_state_client_ready_start as ::core::ffi::c_int as ::core::ffi::c_uint
    {
        retransmit_time = (current_time.wrapping_add((*(*old_p).send_path).smoothed_rtt)
            as ::core::ffi::c_ulonglong)
            .wrapping_add(PICOQUIC_RACK_DELAY) as uint64_t;
    } else {
        let mut pkt_ctx: *mut picoquic_packet_context_t = if (*cnx).is_multipath_enabled()
            as ::core::ffi::c_int
            != 0
            && (*old_p).pc as ::core::ffi::c_uint
                == picoquic_packet_context_application as ::core::ffi::c_int as ::core::ffi::c_uint
        {
            &raw mut (*(*old_p).send_path).pkt_ctx
        } else {
            (&raw mut (*cnx).pkt_ctx as *mut picoquic_packet_context_t).offset((*old_p).pc as isize)
                as *mut picoquic_packet_context_t
        };
        delta_seq = (*pkt_ctx)
            .highest_acknowledged
            .wrapping_sub((*old_p).sequence_number) as int64_t;
        if delta_seq > 0 as int64_t {
            let mut rack_delay: int64_t =
                ((*(*old_p).send_path).smoothed_rtt >> 2 as ::core::ffi::c_int) as int64_t;
            delta_sent = (*pkt_ctx)
                .latest_time_acknowledged
                .wrapping_sub((*old_p).send_time) as int64_t;
            if rack_delay as ::core::ffi::c_ulonglong
                > PICOQUIC_RACK_DELAY.wrapping_div(2 as ::core::ffi::c_ulonglong)
            {
                rack_delay =
                    PICOQUIC_RACK_DELAY.wrapping_div(2 as ::core::ffi::c_ulonglong) as int64_t;
            }
            retransmit_time = (*old_p)
                .send_time
                .wrapping_add((*(*old_p).send_path).retransmit_timer);
            rack_timer_min = (*pkt_ctx)
                .highest_acknowledged_time
                .wrapping_add(rack_delay as uint64_t)
                .wrapping_sub(delta_sent as uint64_t)
                .wrapping_add((*cnx).remote_parameters.max_ack_delay as uint64_t);
            if retransmit_time > rack_timer_min {
                retransmit_time = rack_timer_min;
            }
            if retransmit_time <= current_time || (*old_p).is_ack_trap() as ::core::ffi::c_int != 0
            {
                is_probably_lost = 1 as ::core::ffi::c_int;
            }
        }
    ...
    if is_probably_lost == 0 {
        let mut retransmit_time_timer: uint64_t = 0;
        let mut last_packet: *mut picoquic_packet_t =
            picoquic_get_last_packet(cnx, (*old_p).send_path as *mut picoquic_path_t, (*old_p).pc);
        if last_packet.is_null() {
            last_packet = old_p;
        }
        retransmit_time_timer =
            (*last_packet)
                .send_time
                .wrapping_add(picoquic_current_retransmit_timer(
                    cnx,
                    (*old_p).send_path as *mut picoquic_path_t,
                ));
        if current_time >= retransmit_time_timer {
            if (*(*old_p).send_path).path_is_demoted() != 0 {
                is_probably_lost = 1 as ::core::ffi::c_int;
            } else {
                *is_timer_expired = 1 as ::core::ffi::c_int;
            }
        } else if (*(*old_p).send_path).nb_retransmit == 0 as uint64_t {
            let mut alt_retransmit_timer: uint64_t =
                (*old_p)
                    .send_time
                    .wrapping_add(
                        (2 as uint64_t).wrapping_mul(picoquic_current_retransmit_timer(
                            cnx,
                            (*old_p).send_path as *mut picoquic_path_t,
                        )),
                    );
            if alt_retransmit_timer < (*last_packet).send_time {
                ...
                if current_time >= retransmit_time_timer {
                    if picoquic_is_packet_ack_eliciting(old_p) != 0 {
                        *is_timer_expired = 1 as ::core::ffi::c_int;
                    } else {
                        is_probably_lost = 1 as ::core::ffi::c_int;
                    }
...
unsafe extern "C" fn picoquic_set_wake_up_from_packet_retransmit(
    mut cnx: *mut picoquic_cnx_t,
    mut old_p: *mut picoquic_packet_t,
    mut current_time: uint64_t,
    mut next_wake_time: *mut uint64_t,
    ...
    let mut next_retransmit_time: uint64_t = *next_wake_time;
    let mut is_timer_expired: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut is_probably_lost: ::core::ffi::c_int = picoquic_is_packet_probably_lost(
        cnx,
        old_p,
        current_time,
        &raw mut next_retransmit_time,
    ...
    if is_probably_lost != 0 || is_timer_expired != 0 {
        *next_wake_time = current_time;
        (*(*cnx).quic).wake_file = 5 as ::core::ffi::c_int;
        (*(*cnx).quic).wake_line = 650 as ::core::ffi::c_int;
    } else if next_retransmit_time < *next_wake_time {
        *next_wake_time = next_retransmit_time;
        (*(*cnx).quic).wake_file = 5 as ::core::ffi::c_int;
        (*(*cnx).quic).wake_line = 654 as ::core::ffi::c_int;
    }
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_copy_before_retransmit(
    mut old_p: *mut picoquic_packet_t,
    mut cnx: *mut picoquic_cnx_t,
    mut new_bytes: *mut uint8_t,
    mut send_buffer_max_minus_checksum: size_t,
    mut packet_is_pure_ack: *mut ::core::ffi::c_int,
    mut do_not_detect_spurious: *mut ::core::ffi::c_int,
    mut force_queue: ::core::ffi::c_int,
    mut length: *mut size_t,
    mut add_to_data_repeat_queue: *mut ::core::ffi::c_int,
) -> ::core::ffi::c_int {
    ...
    if (*old_p).is_mtu_probe() != 0 {
        if !(*old_p).send_path.is_null() {
            (*(*old_p).send_path)
                .set_mtu_probe_sent(0 as ::core::ffi::c_uint as ::core::ffi::c_uint);
            if force_queue == 0 || force_queue == 2 as ::core::ffi::c_int {
                (*(*old_p).send_path).send_mtu_max_tried =
                    (*old_p).length.wrapping_add((*old_p).checksum_overhead);
            }
        }
        *packet_is_pure_ack = 1 as ::core::ffi::c_int;
        *do_not_detect_spurious = 0 as ::core::ffi::c_int;
    } else if (*old_p).is_ack_trap() != 0 {
        *packet_is_pure_ack = 1 as ::core::ffi::c_int;
        *do_not_detect_spurious = 1 as ::core::ffi::c_int;
    } else if (*old_p).is_multipath_probe() != 0 {
        *packet_is_pure_ack = 0 as ::core::ffi::c_int;
        *do_not_detect_spurious = 1 as ::core::ffi::c_int;
    } else if (*old_p).was_preemptively_repeated() != 0 {
        *packet_is_pure_ack = 1 as ::core::ffi::c_int;
        *do_not_detect_spurious = 1 as ::core::ffi::c_int;
    } else {
        ...
        while ret == 0 as ::core::ffi::c_int && byte_index < (*old_p).length {
            ...
            if ret == 0 as ::core::ffi::c_int
                && (*old_p).bytes[byte_index as usize] as ::core::ffi::c_int
                ...
                && (*cnx).callback_fn.is_some()
            {
                ...
                let mut content_bytes: *mut uint8_t = (&raw mut (*old_p).bytes as *mut uint8_t)
                    .offset(byte_index as isize)
                    as *mut uint8_t;
                content_bytes = picoquic_decode_datagram_frame_header(
                    content_bytes,
                    content_bytes.offset(frame_length as isize),
                    &raw mut frame_id,
                    &raw mut content_length,
                );
                if !content_bytes.is_null() {
                ...
                picoquic_log_app_message(
                    cnx as *mut picoquic_cnx_t,
                    b"Datagram lost, PN=%lu, Sent: %lu\0".as_ptr() as *const ::core::ffi::c_char,
                    (*old_p).sequence_number,
                    (*old_p).send_time,
                );
            }
            if ret == 0 as ::core::ffi::c_int {
                if frame_is_pure_ack == 0 {
                    if (*old_p).bytes[byte_index as usize] as ::core::ffi::c_int
                        ...
                        == picoquic_frame_type_stream_range_min as ::core::ffi::c_int
                    {
                        *add_to_data_repeat_queue = 1 as ::core::ffi::c_int;
                    } else if force_queue != 0
                        || frame_length > send_buffer_max_minus_checksum.wrapping_sub(*length)
                    {
                    ...
                    } else if frame_length <= send_buffer_max_minus_checksum.wrapping_sub(*length) {
                        memcpy(
                            new_bytes.offset(*length as isize) as *mut uint8_t
                        ...
                        *length = (*length).wrapping_add(frame_length);
                        ...
                        let mut error_frame_type: uint64_t = 0 as uint64_t;
                        picoquic_varint_decode(
                            (&raw mut (*old_p).bytes as *mut uint8_t).offset(byte_index as isize)
                                as *mut uint8_t,
                            frame_length,
                            &raw mut error_frame_type,
                        );
                        picoquic_log_app_message(
                            cnx as *mut picoquic_cnx_t,
                            b"Cannot copy frame 0x%lu, packet type = %d, force queue = %d, repeat buffer : %zu, previous length : %zu.\0"
                        ...
                        ret = picoquic_connection_error_ex(
                            ...
                            error_frame_type,
                            b"Cannot copy frame for retransmit\0".as_ptr()
                                as *const ::core::ffi::c_char,
                        );
                    }
                    *packet_is_pure_ack = 0 as ::core::ffi::c_int;
...
unsafe extern "C" fn picoquic_process_lost_packet(
    mut cnx: *mut picoquic_cnx_t,
    mut pkt_ctx: *mut picoquic_packet_context_t,
    mut old_p: *mut picoquic_packet_t,
    mut is_timer_expired: ::core::ffi::c_int,
    mut pc: picoquic_packet_context_enum,
    mut path_x: *mut picoquic_path_t,
    mut current_time: uint64_t,
    mut packet: *mut picoquic_packet_t,
    ...
    let mut do_not_detect_spurious: ::core::ffi::c_int = 1 as ::core::ffi::c_int;
    let mut add_to_data_repeat_queue: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut new_bytes: *mut uint8_t = ::core::ptr::null_mut::<uint8_t>();
    let mut checksum_length: size_t = 0 as size_t;
    let mut available_buffer: size_t = 0 as size_t;
    let mut ret: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut force_queue: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    ...
    *packet_is_pure_ack = 1 as ::core::ffi::c_int;
    if packet.is_null() {
        force_queue = 2 as ::core::ffi::c_int;
    } else {
        new_bytes = &raw mut (*packet).bytes as *mut uint8_t;
        (*packet).sequence_number = (*pkt_ctx).send_sequence;
        (*packet).send_path = path_x as *mut st_picoquic_path_t;
        (*packet).pc = pc;
        (*packet).ptype = (if (*old_p).ptype as ::core::ffi::c_uint
            == picoquic_packet_0rtt_protected as ::core::ffi::c_int as ::core::ffi::c_uint
        {
        ...
        *header_length = *length;
        match (*packet).ptype as ::core::ffi::c_uint {
            ...
            _ => {
                checksum_length = 0 as size_t;
            }
        }
        available_buffer = send_buffer_max.wrapping_sub(checksum_length);
    }
    ret = picoquic_copy_before_retransmit(
        old_p,
        cnx,
        new_bytes,
        available_buffer,
        ...
        force_queue,
        length,
        &raw mut add_to_data_repeat_queue,
    );
    ...
    old_p = picoquic_dequeue_retransmit_packet(
        cnx,
        pkt_ctx,
        old_p,
...
unsafe extern "C" fn picoquic_check_path_mtu_on_losses(
    mut cnx: *mut picoquic_cnx_t,
    mut old_p: *mut picoquic_packet_t,
    mut timer_based_retransmit: ::core::ffi::c_int,
) {
    if !(*old_p).send_path.is_null()
        && ((*old_p).length.wrapping_add((*old_p).checksum_overhead)
            == (*(*old_p).send_path).send_mtu
            || timer_based_retransmit != 0)
        && (*cnx).cnx_state as ::core::ffi::c_uint
            >= picoquic_state_ready as ::core::ffi::c_int as ::core::ffi::c_uint
    {
        (*(*old_p).send_path).nb_mtu_losses = (*(*old_p).send_path).nb_mtu_losses.wrapping_add(1);
        if (*(*old_p).send_path).nb_mtu_losses > PICOQUIC_MTU_LOSS_THRESHOLD as uint64_t
            || timer_based_retransmit != 0
        {
            let mut old_mtu: size_t = (*(*old_p).send_path).send_mtu;
            picoquic_reset_path_mtu((*old_p).send_path as *mut picoquic_path_t);
            if old_mtu != (*(*old_p).send_path).send_mtu {
                picoquic_log_app_message(
                    cnx as *mut picoquic_cnx_t,
                    b"Reset path %lu MTU after %lu retransmissions, %luMTU losses, Timer mode : %d\0"
                        .as_ptr() as *const ::core::ffi::c_char,
...
unsafe extern "C" fn picoquic_count_and_notify_loss(
    mut cnx: *mut picoquic_cnx_t,
    mut old_p: *mut picoquic_packet_t,
    mut timer_based_retransmit: ::core::ffi::c_int,
    mut current_time: uint64_t,
) {
    if timer_based_retransmit < 2 as ::core::ffi::c_int {
        picoquic_log_packet_lost(
            cnx,
            (*old_p).send_path as *mut picoquic_path_t,
            (*old_p).ptype,
            (*old_p).sequence_number,
            if timer_based_retransmit != 0 {
                b"timer\0".as_ptr() as *const ::core::ffi::c_char
            } else {
                b"repeat\0".as_ptr() as *const ::core::ffi::c_char
            },
            if (*old_p).send_path.is_null() || (*(*old_p).send_path).p_remote_cnxid.is_null() {
                ::core::ptr::null_mut::<picoquic_connection_id_t>()
            } else {
                &raw mut (*(*(*old_p).send_path).p_remote_cnxid).cnx_id
            },
            (*old_p).length,
            current_time,
        );
        if (*old_p).is_preemptive_repeat() == 0 {
            (*cnx).nb_retransmission_total = (*cnx).nb_retransmission_total.wrapping_add(1);
        }
    }
    if !(*old_p).send_path.is_null() {
        (*(*old_p).send_path).nb_losses_found =
            (*(*old_p).send_path).nb_losses_found.wrapping_add(1);
        if timer_based_retransmit != 0 {
            (*(*old_p).send_path).nb_timer_losses =
                (*(*old_p).send_path).nb_timer_losses.wrapping_add(1);
        }
        if ((*(*old_p).send_path).smoothed_rtt as ::core::ffi::c_ulonglong != PICOQUIC_INITIAL_RTT
            || (*(*old_p).send_path).rtt_variant != 0 as uint64_t)
            && (*old_p).send_time
                > (*cnx)
                    .start_time
                    .wrapping_add((*(*old_p).send_path).smoothed_rtt)
        {
            (*(*old_p).send_path).total_bytes_lost = ((*(*old_p).send_path).total_bytes_lost
                as ::core::ffi::c_ulong)
                .wrapping_add((*old_p).length as ::core::ffi::c_ulong)
            ...
            && !(*old_p).send_path.is_null()
        {
            ...
            ack_state.nb_bytes_newly_lost = (*old_p).length as uint64_t;
            (*(*cnx).congestion_alg)
                .alg_notify
                .expect("non-null function pointer")(
                cnx as *mut picoquic_cnx_t,
                (*old_p).send_path as *mut picoquic_path_t,
                (if timer_based_retransmit == 0 as ::core::ffi::c_int {
                    picoquic_congestion_notification_repeat as ::core::ffi::c_int
                } else {
                    picoquic_congestion_notification_timeout as ::core::ffi::c_int
                }) as picoquic_congestion_notification_t,
                &raw mut ack_state,
                current_time,
            );
        }
...
unsafe extern "C" fn picoquic_is_packet_ack_eliciting(
    mut packet: *mut picoquic_packet_t,
) -> ::core::ffi::c_int {
    let mut is_ack_eliciting: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    if (*packet).is_evaluated() != 0 {
        is_ack_eliciting = (*packet).is_ack_eliciting() as ::core::ffi::c_int;
    } else {
        if (*packet).is_ack_trap() == 0 {
            let mut frame_length: size_t = 0 as size_t;
            let mut byte_index: size_t = (*packet).offset;
            while byte_index < (*packet).length {
                let mut frame_is_pure_ack: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
                if picoquic_skip_frame(
                    (&raw mut (*packet).bytes as *mut uint8_t).offset(byte_index as isize)
                        as *mut uint8_t,
                    (*packet).length.wrapping_sub(byte_index),
                    &raw mut frame_length,
                    &raw mut frame_is_pure_ack,
                ) != 0 as ::core::ffi::c_int
                {
                ...
                if frame_is_pure_ack == 0 {
                    is_ack_eliciting = 1 as ::core::ffi::c_int;
                    break;
                } else {
                    byte_index = byte_index.wrapping_add(frame_length);
                }
        ...
        (*packet)
            .set_is_ack_eliciting(is_ack_eliciting as ::core::ffi::c_uint as ::core::ffi::c_uint);
        (*packet).set_is_evaluated(1 as ::core::ffi::c_uint as ::core::ffi::c_uint);
    }
    return is_ack_eliciting;
}
unsafe extern "C" fn picoquic_retransmit_path_packet_queue(
    mut cnx: *mut picoquic_cnx_t,
    mut path_x: *mut picoquic_path_t,
    mut pkt_ctx: *mut picoquic_packet_context_t,
    mut current_time: uint64_t,
    ...
    while !old_p.is_null() {
        let mut next_packet: *mut picoquic_packet_t =
            (*old_p).packet_next as *mut picoquic_packet_t;
        let mut packet_is_pure_ack: ::core::ffi::c_int = 1 as ::core::ffi::c_int;
        let mut do_not_detect_spurious: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
        let mut add_to_data_repeat_queue: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
        let mut length: size_t = 0 as size_t;
        picoquic_count_and_notify_loss(cnx, old_p, 0 as ::core::ffi::c_int, current_time);
        ret = picoquic_copy_before_retransmit(
            old_p,
            cnx,
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_retransmit_demoted_path(
    mut cnx: *mut picoquic_cnx_t,
    mut path_x: *mut picoquic_path_t,
    mut current_time: uint64_t,
) {
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_queue_retransmit_on_ack(
    mut cnx: *mut picoquic_cnx_t,
    mut path_x: *mut picoquic_path_t,
    mut current_time: uint64_t,
) {
    let mut pkt_ctx: *mut picoquic_packet_context_t =
        ::core::ptr::null_mut::<picoquic_packet_context_t>();
    let mut old_p: *mut picoquic_packet_t = ::core::ptr::null_mut::<picoquic_packet_t>();
    let mut next_retransmit_time: uint64_t = UINT64_MAX as uint64_t;
    if (*cnx).is_multipath_enabled() != 0 {
        pkt_ctx = &raw mut (*path_x).pkt_ctx;
    } else {
        pkt_ctx = (&raw mut (*cnx).pkt_ctx as *mut picoquic_packet_context_t)
    ...
    while !old_p.is_null() {
        let mut p_next: *mut picoquic_packet_t = (*old_p).packet_next as *mut picoquic_packet_t;
        let mut packet_is_pure_ack: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
        let mut header_length: size_t = 0 as size_t;
        let mut is_timer_expired: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
        let mut is_probably_lost: ::core::ffi::c_int =
            ((*cnx).initial_repeat_needed() as ::core::ffi::c_int != 0
                || (*old_p).send_path.is_null()
                || picoquic_is_packet_probably_lost(
                    cnx,
                    old_p,
