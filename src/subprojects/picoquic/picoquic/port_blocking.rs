...
#[no_mangle]
pub static mut picoquic_blocked_port_list: [uint16_t; 18] = [
    27015 as ::core::ffi::c_int as uint16_t,
    20800 as ::core::ffi::c_int as uint16_t,
    11211 as ::core::ffi::c_int as uint16_t,
    5353 as ::core::ffi::c_int as uint16_t,
...
#[no_mangle]
pub static mut nb_picoquic_blocked_port_list: size_t = 0;
#[no_mangle]
pub unsafe extern "C" fn picoquic_check_port_blocked(mut port: uint16_t) -> ::core::ffi::c_int {
    let mut ret: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut i: size_t = 0 as size_t;
    while i < nb_picoquic_blocked_port_list
        && port as ::core::ffi::c_int
            <= picoquic_blocked_port_list[i as usize] as ::core::ffi::c_int
    {
        if port as ::core::ffi::c_int
            == picoquic_blocked_port_list[i as usize] as ::core::ffi::c_int
        {
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_check_addr_blocked(
    mut addr_from: *const sockaddr,
) -> ::core::ffi::c_int {
    let mut port: uint16_t = UINT16_MAX as uint16_t;
    if (*addr_from).sa_family as ::core::ffi::c_int == AF_INET {
        port = (*(addr_from as *mut sockaddr_in)).sin_port as uint16_t;
    } else if (*addr_from).sa_family as ::core::ffi::c_int == AF_INET6 {
        port = (*(addr_from as *mut sockaddr_in6)).sin6_port as uint16_t;
    }
    return picoquic_check_port_blocked(__bswap_16(port as __uint16_t) as uint16_t);
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_disable_port_blocking(
    mut quic: *mut picoquic_quic_t,
    mut is_port_blocking_disabled: ::core::ffi::c_int,
) {
    (*quic).set_is_port_blocking_disabled(
        is_port_blocking_disabled as ::core::ffi::c_uint as ::core::ffi::c_uint,
    );
}
unsafe extern "C" fn c2rust_run_static_initializers() {
    nb_picoquic_blocked_port_list = (::core::mem::size_of::<[uint16_t; 18]>() as size_t)
        .wrapping_div(::core::mem::size_of::<uint16_t>() as size_t);
}
#[used]
