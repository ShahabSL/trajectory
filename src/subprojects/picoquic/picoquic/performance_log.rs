...
extern "C" {
    ...
    fn picoquic_get_cnx_start_time(cnx: *mut picoquic_cnx_t) -> uint64_t;
    fn picoquic_get_data_sent(cnx: *mut picoquic_cnx_t) -> uint64_t;
    fn picoquic_get_data_received(cnx: *mut picoquic_cnx_t) -> uint64_t;
...
pub type picoquic_perflog_column_enum = ::core::ffi::c_uint;
pub const picoquic_perflog_pacing_rate: picoquic_perflog_column_enum = 26;
pub const picoquic_perflog_pacing_quantum_max: picoquic_perflog_column_enum = 25;
pub const picoquic_perflog_bwe_max: picoquic_perflog_column_enum = 24;
pub const picoquic_perflog_ccalgo: picoquic_perflog_column_enum = 23;
pub const picoquic_perflog_cwin: picoquic_perflog_column_enum = 22;
pub const picoquic_perflog_minrtt: picoquic_perflog_column_enum = 21;
pub const picoquic_perflog_srtt: picoquic_perflog_column_enum = 20;
pub const picoquic_perflog_zero_rtt: picoquic_perflog_column_enum = 19;
pub const picoquic_perflog_max_mtu_received: picoquic_perflog_column_enum = 18;
pub const picoquic_perflog_max_mtu_sent: picoquic_perflog_column_enum = 17;
pub const picoquic_perflog_max_ack_gap_local: picoquic_perflog_column_enum = 16;
pub const picoquic_perflog_max_ack_delay_local: picoquic_perflog_column_enum = 15;
pub const picoquic_perflog_min_ack_delay_local: picoquic_perflog_column_enum = 14;
pub const picoquic_perflog_max_ack_gap_remote: picoquic_perflog_column_enum = 13;
pub const picoquic_perflog_max_ack_delay_remote: picoquic_perflog_column_enum = 12;
pub const picoquic_perflog_min_ack_delay_remote: picoquic_perflog_column_enum = 11;
pub const picoquic_perflog_delayed_ack_option: picoquic_perflog_column_enum = 10;
pub const picoquic_perflog_nb_spurious: picoquic_perflog_column_enum = 9;
pub const picoquic_perflog_nb_retransmission_total: picoquic_perflog_column_enum = 8;
pub const picoquic_perflog_nb_packets_sent: picoquic_perflog_column_enum = 7;
pub const picoquic_perflog_nb_trains_blocked_others: picoquic_perflog_column_enum = 6;
pub const picoquic_perflog_nb_trains_blocked_pacing: picoquic_perflog_column_enum = 5;
pub const picoquic_perflog_nb_trains_blocked_cwin: picoquic_perflog_column_enum = 4;
pub const picoquic_perflog_nb_trains_short: picoquic_perflog_column_enum = 3;
pub const picoquic_perflog_nb_trains_sent: picoquic_perflog_column_enum = 2;
pub const picoquic_perflog_nb_packets_received: picoquic_perflog_column_enum = 1;
pub const picoquic_perflog_is_client: picoquic_perflog_column_enum = 0;
pub type picoquic_performance_log_ctx_t = st_picoquic_performance_log_ctx_t;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct st_picoquic_performance_log_ctx_t {
    pub first: *mut st_picoquic_performance_log_item_t,
    pub last: *mut st_picoquic_performance_log_item_t,
    pub perflog_file_name: *const ::core::ffi::c_char,
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct st_picoquic_performance_log_item_t {
    pub next: *mut st_picoquic_performance_log_item_t,
    pub duration_sec: ::core::ffi::c_double,
    pub send_mbps: ::core::ffi::c_double,
    pub recv_mbps: ::core::ffi::c_double,
    pub data_sent: uint64_t,
    pub data_received: uint64_t,
    pub quic_version: uint32_t,
    pub alpn: *mut ::core::ffi::c_char,
    pub cnxid: picoquic_connection_id_t,
    pub cnx_time_64: uint64_t,
    pub nb_values: size_t,
    pub v: [uint64_t; 27],
}
pub type picoquic_performance_log_item_t = st_picoquic_performance_log_item_t;
pub const NULL: *mut ::core::ffi::c_void =
    ::core::ptr::null::<::core::ffi::c_void>() as *mut ::core::ffi::c_void;
pub const PICOQUIC_VERSION: [::core::ffi::c_char; 9] =
    unsafe { ::core::mem::transmute::<[u8; 9], [::core::ffi::c_char; 9]>(*b"1.1.28.4\0") };
pub const SEEK_END: ::core::ffi::c_int = 2 as ::core::ffi::c_int;
pub const PICOQUIC_PER_LOG_VERSION: ::core::ffi::c_int = 1 as ::core::ffi::c_int;
pub const PICOQUIC_PERF_LOG_MAX_ITEMS: ::core::ffi::c_int = 27 as ::core::ffi::c_int;
#[no_mangle]
pub unsafe extern "C" fn picoquic_perflog_item_free(
    mut perflog_item: *mut picoquic_performance_log_item_t,
) {
    if !(*perflog_item).alpn.is_null() {
        free((*perflog_item).alpn as *mut ::core::ffi::c_void);
    }
    free(perflog_item as *mut ::core::ffi::c_void);
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_perflog_save(
    mut perflog_ctx: *mut picoquic_performance_log_ctx_t,
) -> ::core::ffi::c_int {
    let mut ret: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut F: *mut FILE = picoquic_file_open(
        (*perflog_ctx).perflog_file_name,
        b"a\0".as_ptr() as *const ::core::ffi::c_char,
    );
    if F.is_null() {
        ret = -(1 as ::core::ffi::c_int);
    } else {
        while !(*perflog_ctx).first.is_null() {
            let mut cnxid_str: [::core::ffi::c_char; 513] = [0; 513];
            let mut perflog_item: *mut picoquic_performance_log_item_t =
                (*perflog_ctx).first as *mut picoquic_performance_log_item_t;
            (*perflog_ctx).first = (*perflog_item).next;
            if (*perflog_ctx).first.is_null() {
                (*perflog_ctx).last = ::core::ptr::null_mut::<st_picoquic_performance_log_item_t>();
            }
            fprintf(
                F,
                b"%d, %s, \0".as_ptr() as *const ::core::ffi::c_char,
                PICOQUIC_PER_LOG_VERSION,
                PICOQUIC_VERSION.as_ptr(),
            );
            fprintf(
                F,
                b"%f, %lu, %lu, %f, %f\0".as_ptr() as *const ::core::ffi::c_char,
            ...
            if picoquic_print_connection_id_hexa(
                &raw mut cnxid_str as *mut ::core::ffi::c_char,
                ::core::mem::size_of::<[::core::ffi::c_char; 513]>() as size_t,
                &raw mut (*perflog_item).cnxid,
            ) != 0 as ::core::ffi::c_int
            {
                cnxid_str[0 as ::core::ffi::c_int as usize] = 0 as ::core::ffi::c_char;
            }
            fprintf(
                F,
                b", 0x%x, %s, 0x%s, %lu\0".as_ptr() as *const ::core::ffi::c_char,
                (*perflog_item).quic_version,
                if (*perflog_item).alpn.is_null() {
                    b"\0".as_ptr() as *const ::core::ffi::c_char
                } else {
                    (*perflog_item).alpn as *const ::core::ffi::c_char
                },
                &raw mut cnxid_str as *mut ::core::ffi::c_char,
                (*perflog_item).cnx_time_64,
            );
            let mut i: size_t = 0 as size_t;
            while i < (*perflog_item).nb_values {
                fprintf(
                    F,
                    b", %lu\0".as_ptr() as *const ::core::ffi::c_char,
                    (*perflog_item).v[i as usize],
                );
                i = i.wrapping_add(1);
            }
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_perflog_record(
    mut cnx: *mut picoquic_cnx_t,
    mut perflog_ctx: *mut picoquic_performance_log_ctx_t,
) -> ::core::ffi::c_int {
    let mut ret: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut perflog_item: *mut picoquic_performance_log_item_t =
        malloc(::core::mem::size_of::<picoquic_performance_log_item_t>() as size_t)
            as *mut picoquic_performance_log_item_t;
    if perflog_item.is_null() {
        ret = -(1 as ::core::ffi::c_int);
    } else {
        let mut start_time: uint64_t = picoquic_get_cnx_start_time(cnx as *mut picoquic_cnx_t);
        let mut close_time: uint64_t = picoquic_get_quic_time((*cnx).quic as *mut picoquic_quic_t);
        let mut duration_usec: uint64_t = close_time.wrapping_sub(start_time);
        memset(
            perflog_item as *mut ::core::ffi::c_void,
            0 as ::core::ffi::c_int,
            ::core::mem::size_of::<picoquic_performance_log_item_t>() as size_t,
        );
        (*perflog_item).duration_sec = duration_usec as ::core::ffi::c_double / 1000000.0f64;
        if (*perflog_item).duration_sec > 0 as ::core::ffi::c_int as ::core::ffi::c_double {
            (*perflog_item).data_sent = picoquic_get_data_sent(cnx as *mut picoquic_cnx_t);
            (*perflog_item).data_received = picoquic_get_data_received(cnx as *mut picoquic_cnx_t);
            (*perflog_item).send_mbps = (*perflog_item).data_sent as ::core::ffi::c_double * 8.0f64
                / duration_usec as ::core::ffi::c_double;
            (*perflog_item).recv_mbps = (*perflog_item).data_received as ::core::ffi::c_double
                * 8.0f64
                / duration_usec as ::core::ffi::c_double;
        }
        (*perflog_item).alpn = picoquic_string_duplicate((*cnx).alpn);
        (*perflog_item).quic_version = if (*cnx).version_index >= 0 as ::core::ffi::c_int {
        ...
        (*perflog_item).cnxid = picoquic_get_logging_cnxid(cnx as *mut picoquic_cnx_t);
        (*perflog_item).cnx_time_64 = start_time;
        (*perflog_item).nb_values = PICOQUIC_PERF_LOG_MAX_ITEMS as size_t;
        (*perflog_item).v[picoquic_perflog_is_client as ::core::ffi::c_int as usize] =
            (*cnx).client_mode() as uint64_t;
        (*perflog_item).v[picoquic_perflog_nb_packets_received as ::core::ffi::c_int as usize] =
            (*cnx).nb_packets_received;
        (*perflog_item).v[picoquic_perflog_nb_trains_sent as ::core::ffi::c_int as usize] =
            (*cnx).nb_trains_sent;
        (*perflog_item).v[picoquic_perflog_nb_trains_short as ::core::ffi::c_int as usize] =
            (*cnx).nb_trains_short;
        (*perflog_item).v[picoquic_perflog_nb_trains_blocked_cwin as ::core::ffi::c_int as usize] =
            (*cnx).nb_trains_blocked_cwin;
        (*perflog_item).v
            [picoquic_perflog_nb_trains_blocked_pacing as ::core::ffi::c_int as usize] =
            (*cnx).nb_trains_blocked_pacing;
        (*perflog_item).v
            [picoquic_perflog_nb_trains_blocked_others as ::core::ffi::c_int as usize] =
            (*cnx).nb_trains_blocked_others;
        (*perflog_item).v[picoquic_perflog_nb_packets_sent as ::core::ffi::c_int as usize] =
            (*cnx).nb_packets_sent;
        (*perflog_item).v
            [picoquic_perflog_nb_retransmission_total as ::core::ffi::c_int as usize] =
            (*cnx).nb_retransmission_total;
        (*perflog_item).v[picoquic_perflog_nb_spurious as ::core::ffi::c_int as usize] =
            (*cnx).nb_spurious;
        (*perflog_item).v[picoquic_perflog_delayed_ack_option as ::core::ffi::c_int as usize] =
            (*cnx).is_ack_frequency_negotiated() as uint64_t;
        (*perflog_item).v[picoquic_perflog_min_ack_delay_remote as ::core::ffi::c_int as usize] =
            (*cnx).min_ack_delay_remote;
        (*perflog_item).v[picoquic_perflog_max_ack_delay_remote as ::core::ffi::c_int as usize] =
            (*cnx).max_ack_delay_remote;
        (*perflog_item).v[picoquic_perflog_max_ack_gap_remote as ::core::ffi::c_int as usize] =
            (*cnx).max_ack_gap_remote;
        (*perflog_item).v[picoquic_perflog_min_ack_delay_local as ::core::ffi::c_int as usize] =
            (*cnx).min_ack_delay_local;
        (*perflog_item).v[picoquic_perflog_max_ack_delay_local as ::core::ffi::c_int as usize] =
            (*cnx).max_ack_delay_local;
        (*perflog_item).v[picoquic_perflog_max_ack_gap_local as ::core::ffi::c_int as usize] =
            (*cnx).max_ack_gap_local;
        (*perflog_item).v[picoquic_perflog_max_mtu_sent as ::core::ffi::c_int as usize] =
            (*cnx).max_mtu_sent as uint64_t;
        (*perflog_item).v[picoquic_perflog_max_mtu_received as ::core::ffi::c_int as usize] =
            (*cnx).max_mtu_received as uint64_t;
        (*perflog_item).v[picoquic_perflog_zero_rtt as ::core::ffi::c_int as usize] =
            ((*cnx).nb_zero_rtt_received > 0 as uint32_t
                || (*cnx).nb_zero_rtt_acked > 0 as uint32_t) as ::core::ffi::c_int
                as uint64_t;
        if !(*cnx).path.is_null()
            && !(*(*cnx).path.offset(0 as ::core::ffi::c_int as isize)).is_null()
        {
            (*perflog_item).v[picoquic_perflog_srtt as ::core::ffi::c_int as usize] =
                (**(*cnx).path.offset(0 as ::core::ffi::c_int as isize)).smoothed_rtt;
            (*perflog_item).v[picoquic_perflog_minrtt as ::core::ffi::c_int as usize] =
                (**(*cnx).path.offset(0 as ::core::ffi::c_int as isize)).rtt_min;
            (*perflog_item).v[picoquic_perflog_cwin as ::core::ffi::c_int as usize] =
                (**(*cnx).path.offset(0 as ::core::ffi::c_int as isize)).cwin;
            (*perflog_item).v[picoquic_perflog_bwe_max as ::core::ffi::c_int as usize] =
                (**(*cnx).path.offset(0 as ::core::ffi::c_int as isize)).bandwidth_estimate_max;
            (*perflog_item).v[picoquic_perflog_pacing_quantum_max as ::core::ffi::c_int as usize] =
                (**(*cnx).path.offset(0 as ::core::ffi::c_int as isize))
                    .pacing
                    .quantum_max;
            (*perflog_item).v[picoquic_perflog_pacing_rate as ::core::ffi::c_int as usize] =
                (**(*cnx).path.offset(0 as ::core::ffi::c_int as isize))
                    .pacing
                    .rate_max;
        }
        if !(*cnx).congestion_alg.is_null() {
            (*perflog_item).v[picoquic_perflog_ccalgo as ::core::ffi::c_int as usize] =
                (*(*cnx).congestion_alg).congestion_algorithm_number as uint64_t;
        }
        if (*perflog_ctx).first.is_null() {
            (*perflog_ctx).first = perflog_item as *mut st_picoquic_performance_log_item_t;
        }
        if (*perflog_ctx).last.is_null() {
            (*perflog_ctx).last = perflog_item as *mut st_picoquic_performance_log_item_t;
        } else {
            (*(*perflog_ctx).last).next = perflog_item as *mut st_picoquic_performance_log_item_t;
        }
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_perflog_free(
    mut perflog_ctx: *mut picoquic_performance_log_ctx_t,
) {
    if !(*perflog_ctx).perflog_file_name.is_null() {
        free(
            (*perflog_ctx).perflog_file_name as *mut ::core::ffi::c_char
    ...
    free(perflog_ctx as *mut ::core::ffi::c_void);
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_perflog(
    mut quic: *mut picoquic_quic_t,
    mut cnx: *mut picoquic_cnx_t,
    mut should_delete: ::core::ffi::c_int,
) -> ::core::ffi::c_int {
    let mut ret: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut perflog_ctx: *mut picoquic_performance_log_ctx_t =
        (*quic).v_perflog_ctx as *mut picoquic_performance_log_ctx_t;
    if !cnx.is_null() {
    ...
    if should_delete != 0 {
        ...
        (*quic).perflog_fn = None;
    }
    return ret;
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_perflog_param_name(
    mut rank: picoquic_perflog_column_enum,
) -> *const ::core::ffi::c_char {
    match rank as ::core::ffi::c_uint {
        0 => return b"is_client\0".as_ptr() as *const ::core::ffi::c_char,
        1 => return b"pkt_recv\0".as_ptr() as *const ::core::ffi::c_char,
        2 => return b"trains_s\0".as_ptr() as *const ::core::ffi::c_char,
        3 => return b"t_short\0".as_ptr() as *const ::core::ffi::c_char,
        4 => return b"tb_cwin\0".as_ptr() as *const ::core::ffi::c_char,
        5 => return b"tb_pacing\0".as_ptr() as *const ::core::ffi::c_char,
        6 => return b"tb_others\0".as_ptr() as *const ::core::ffi::c_char,
        7 => return b"pkt_sent\0".as_ptr() as *const ::core::ffi::c_char,
        8 => return b"retrans.\0".as_ptr() as *const ::core::ffi::c_char,
        9 => return b"spurious\0".as_ptr() as *const ::core::ffi::c_char,
        10 => return b"delayed_ack_option\0".as_ptr() as *const ::core::ffi::c_char,
        11 => return b"min_ack_delay_remote\0".as_ptr() as *const ::core::ffi::c_char,
        12 => return b"max_ack_delay_remote\0".as_ptr() as *const ::core::ffi::c_char,
        13 => return b"max_ack_gap_remote\0".as_ptr() as *const ::core::ffi::c_char,
        14 => return b"min_ack_delay_local\0".as_ptr() as *const ::core::ffi::c_char,
        15 => return b"max_ack_delay_local\0".as_ptr() as *const ::core::ffi::c_char,
        16 => return b"max_ack_gap_local\0".as_ptr() as *const ::core::ffi::c_char,
        17 => return b"max_mtu_sent\0".as_ptr() as *const ::core::ffi::c_char,
        18 => return b"max_mtu_received\0".as_ptr() as *const ::core::ffi::c_char,
        19 => return b"zero_rtt\0".as_ptr() as *const ::core::ffi::c_char,
        20 => return b"srtt\0".as_ptr() as *const ::core::ffi::c_char,
        21 => return b"minrtt\0".as_ptr() as *const ::core::ffi::c_char,
        22 => return b"cwin\0".as_ptr() as *const ::core::ffi::c_char,
        23 => return b"ccalgo\0".as_ptr() as *const ::core::ffi::c_char,
        24 => return b"bwe_max\0".as_ptr() as *const ::core::ffi::c_char,
        25 => return b"p_quantum\0".as_ptr() as *const ::core::ffi::c_char,
        26 => return b"p_rate\0".as_ptr() as *const ::core::ffi::c_char,
        _ => {}
    }
    return ::core::ptr::null::<::core::ffi::c_char>();
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_perflog_file_is_empty(
    mut perflog_file_name: *const ::core::ffi::c_char,
) -> ::core::ffi::c_int {
    let mut is_empty: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut F: *mut FILE = picoquic_file_open(
        perflog_file_name,
        b"rb\0".as_ptr() as *const ::core::ffi::c_char,
    );
    if F.is_null() {
        is_empty = 1 as ::core::ffi::c_int;
    } else {
        let mut sz: ::core::ffi::c_long = 0;
        fseek(F, 0 as ::core::ffi::c_long, SEEK_END);
        sz = ftell(F);
        if sz == 0 as ::core::ffi::c_long {
            is_empty = 1 as ::core::ffi::c_int;
        }
        picoquic_file_close(F);
    }
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_perflog_file_set_header(
    mut perflog_file_name: *const ::core::ffi::c_char,
) {
    let mut F: *mut FILE = picoquic_file_open(
        perflog_file_name,
    ...
    if !F.is_null() {
        fprintf(
            F,
            b"Log_v, PQ_v, Duration, Sent, Received, Mpbs_S, Mbps_R\0".as_ptr()
                as *const ::core::ffi::c_char,
        );
        fprintf(
            F,
            b", QUIC_v, ALPN, CNX_ID, T64\0".as_ptr() as *const ::core::ffi::c_char,
        );
        let mut i: size_t = 0 as size_t;
        while i < PICOQUIC_PERF_LOG_MAX_ITEMS as size_t {
            let mut buf: [::core::ffi::c_char; 16] = [0; 16];
            let mut s: *const ::core::ffi::c_char =
                picoquic_perflog_param_name(i as picoquic_perflog_column_enum);
            if s.is_null() {
                picoquic_sprintf(
                    &raw mut buf as *mut ::core::ffi::c_char,
                    ::core::mem::size_of::<[::core::ffi::c_char; 16]>() as size_t,
                    ::core::ptr::null_mut::<size_t>(),
                    b"v%zu\0".as_ptr() as *const ::core::ffi::c_char,
                    i,
                );
                s = &raw mut buf as *mut ::core::ffi::c_char;
            }
            fprintf(F, b", %s\0".as_ptr() as *const ::core::ffi::c_char, s);
            i = i.wrapping_add(1);
        }
        fprintf(F, b"\n\0".as_ptr() as *const ::core::ffi::c_char);
        fclose(F);
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_perflog_setup(
    mut quic: *mut picoquic_quic_t,
    mut perflog_file_name: *const ::core::ffi::c_char,
) -> ::core::ffi::c_int {
    let mut ret: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut perflog_ctx: *mut picoquic_performance_log_ctx_t =
        malloc(::core::mem::size_of::<picoquic_performance_log_ctx_t>() as size_t)
            as *mut picoquic_performance_log_ctx_t;
    if perflog_ctx.is_null() {
        ret = -(1 as ::core::ffi::c_int);
    } else {
        memset(
            perflog_ctx as *mut ::core::ffi::c_void,
            0 as ::core::ffi::c_int,
            ::core::mem::size_of::<picoquic_performance_log_ctx_t>() as size_t,
        );
        ...
        if (*perflog_ctx).perflog_file_name.is_null() {
            ...
            if picoquic_perflog_file_is_empty(perflog_file_name) != 0 {
                picoquic_perflog_file_set_header(perflog_file_name);
            }
            (*quic).perflog_fn = Some(
                picoquic_perflog
            ...
            ) as picoquic_performance_log_fn;
            (*quic).v_perflog_ctx = perflog_ctx as *mut ::core::ffi::c_void;
        }
    }
    return ret;
}
