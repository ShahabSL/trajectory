...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct svg_context_st {
    pub f_txtlog: *mut FILE,
    pub f_template: *mut FILE,
...
pub type svg_context_t = svg_context_st;
pub const NULL: *mut ::core::ffi::c_void =
    ::core::ptr::null::<::core::ffi::c_void>() as *mut ::core::ffi::c_void;
#[no_mangle]
pub unsafe extern "C" fn svg_pdu(
    mut time: uint64_t,
...
#[no_mangle]
pub unsafe extern "C" fn svg_alpn_update(
    mut time: uint64_t,
    mut s: *mut bytestream,
    mut ptr: *mut ::core::ffi::c_void,
) -> ::core::ffi::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn svg_param_update(
    mut time: uint64_t,
    mut s: *mut bytestream,
    mut ptr: *mut ::core::ffi::c_void,
) -> ::core::ffi::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn svg_packet_lost(
    mut time: uint64_t,
...
#[no_mangle]
pub unsafe extern "C" fn svg_packet_dropped(
    mut time: uint64_t,
    mut path_id: uint64_t,
    mut s: *mut bytestream,
    mut ptr: *mut ::core::ffi::c_void,
...
#[no_mangle]
pub unsafe extern "C" fn svg_packet_buffered(
    mut time: uint64_t,
    mut path_id: uint64_t,
    mut s: *mut bytestream,
    mut ptr: *mut ::core::ffi::c_void,
...
#[no_mangle]
pub unsafe extern "C" fn svg_connection_start(
    mut time: uint64_t,
...
#[no_mangle]
pub unsafe extern "C" fn svg_connection_end(
    mut time: uint64_t,
    mut ptr: *mut ::core::ffi::c_void,
) -> ::core::ffi::c_int {
    return 0 as ::core::ffi::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn svg_packet_start(
    mut time: uint64_t,
    mut path_id: uint64_t,
    mut size: uint64_t,
    ...
    let event_height: ::core::ffi::c_int = 32 as ::core::ffi::c_int;
    let mut svg: *mut svg_context_t = ptr as *mut svg_context_t;
    let mut f: *mut FILE = (*svg).f_txtlog;
    time = time.wrapping_sub((*svg).start_time);
    let mut x_pos: ::core::ffi::c_int = 50 as ::core::ffi::c_int;
    let mut y_pos: ::core::ffi::c_int =
        32 as ::core::ffi::c_int + (*svg).packet_count * event_height;
    let mut dir: *const ::core::ffi::c_char = if rxtx == 0 as ::core::ffi::c_int {
        b"out\0".as_ptr() as *const ::core::ffi::c_char
    } else {
        b"in\0".as_ptr() as *const ::core::ffi::c_char
    };
    let mut time1: uint64_t = time.wrapping_div(1000 as uint64_t);
    let mut time01: uint64_t = time
        .wrapping_rem(1000 as uint64_t)
        .wrapping_div(100 as uint64_t);
    fprintf(
        f,
        b"  <use x=\"%d\" y=\"%d\" xlink:href=\"#packet-%s\" />\n\0".as_ptr()
    ...
    fprintf(
        f,
        b"  <text x=\"%d\" y=\"%d\" text-anchor=\"end\" class=\"time\">%lu.%lu ms</text>\n\0"
            .as_ptr() as *const ::core::ffi::c_char,
        x_pos - 4 as ::core::ffi::c_int,
        y_pos + 8 as ::core::ffi::c_int,
        time1,
        time01,
    );
    if rxtx == 0 as ::core::ffi::c_int {
        fprintf(
            f,
            b"  <text x=\"%d\" y=\"%d\" text-anchor=\"end\" class=\"seq_%s\">%lu</text>\n\0"
                .as_ptr() as *const ::core::ffi::c_char,
            x_pos - 4 as ::core::ffi::c_int,
            y_pos - 4 as ::core::ffi::c_int,
            dir,
            (*ph).pn64,
        );
        fprintf(
            f,
            b"  <text x=\"%d\" y=\"%d\" text-anchor=\"end\" class=\"arw\">%lu b</text>\n\0".as_ptr()
                as *const ::core::ffi::c_char,
            80 as ::core::ffi::c_int,
            y_pos - 2 as ::core::ffi::c_int,
            size,
        );
        fprintf(
            f,
            b"  <text x=\"%d\" y=\"%d\" text-anchor=\"start\" class=\"frm\" xml:space=\"preserve\"> %s</text>\n\0"
                .as_ptr() as *const ::core::ffi::c_char,
            80 as ::core::ffi::c_int,
            y_pos - 2 as ::core::ffi::c_int,
            ptype2str((*ph).ptype),
        ...
        fprintf(
            f,
            b"  <text x=\"%d\" y=\"%d\" text-anchor=\"start\" class=\"frm\" xml:space=\"preserve\">\0"
                .as_ptr() as *const ::core::ffi::c_char,
            x_pos + 30 as ::core::ffi::c_int,
            y_pos + 10 as ::core::ffi::c_int,
        );
    } else {
        fprintf(
            f,
            b"  <text x=\"%d\" y=\"%d\" text-anchor=\"start\" class=\"seq_%s\">%lu</text>\n\0"
                .as_ptr() as *const ::core::ffi::c_char,
            600 as ::core::ffi::c_int - x_pos + 4 as ::core::ffi::c_int,
            y_pos - 4 as ::core::ffi::c_int,
            dir,
            (*ph).pn64,
        );
        fprintf(
            f,
            b"  <text x=\"%d\" y=\"%d\" text-anchor=\"start\" class=\"arw\">%lu b</text>\n\0"
                .as_ptr() as *const ::core::ffi::c_char,
            600 as ::core::ffi::c_int - 80 as ::core::ffi::c_int,
            y_pos - 2 as ::core::ffi::c_int,
            size,
        );
        fprintf(
            f,
            b"  <text x=\"%d\" y=\"%d\" text-anchor=\"end\" class=\"frm\" xml:space=\"preserve\">%s </text>\n\0"
                .as_ptr() as *const ::core::ffi::c_char,
            600 as ::core::ffi::c_int - 80 as ::core::ffi::c_int,
            y_pos - 2 as ::core::ffi::c_int,
            ptype2str((*ph).ptype),
        ...
        fprintf(
            f,
            b"  <text x=\"%d\" y=\"%d\" text-anchor=\"end\" class=\"frm\" xml:space=\"preserve\">\0"
                .as_ptr() as *const ::core::ffi::c_char,
            600 as ::core::ffi::c_int - x_pos - 30 as ::core::ffi::c_int,
            y_pos + 10 as ::core::ffi::c_int,
        );
    }
    (*svg).packet_count += 1;
...
#[no_mangle]
pub unsafe extern "C" fn svg_packet_frame(
    mut s: *mut bytestream,
    mut ptr: *mut ::core::ffi::c_void,
) -> ::core::ffi::c_int {
    let mut svg: *mut svg_context_t = ptr as *mut svg_context_t;
        ...
        && ftype <= picoquic_frame_type_stream_range_max as ::core::ffi::c_int as uint64_t
    {
        ...
        fprintf(
            (*svg).f_txtlog,
            b" stream[%lu] \0".as_ptr() as *const ::core::ffi::c_char,
            stream_id,
        );
    } else {
        fprintf(
...
#[no_mangle]
pub unsafe extern "C" fn svg_packet_end(mut ptr: *mut ::core::ffi::c_void) -> ::core::ffi::c_int {
    let mut svg: *mut svg_context_t = ptr as *mut svg_context_t;
    let mut f: *mut FILE = (*svg).f_txtlog;
...
#[no_mangle]
pub unsafe extern "C" fn svg_cc_update(
    mut time: uint64_t,
    mut path_id: uint64_t,
    mut s: *mut bytestream,
    mut ptr: *mut ::core::ffi::c_void,
...
#[no_mangle]
pub unsafe extern "C" fn svg_info_message(
    mut time: uint64_t,
    mut s: *mut bytestream,
    mut ptr: *mut ::core::ffi::c_void,
) -> ::core::ffi::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn svg_convert(
    mut cid: *const picoquic_connection_id_t,
    mut f_binlog: *mut FILE,
    mut f_template: *mut FILE,
    ...
    let mut svg: svg_context_t = svg_context_st {
        f_txtlog: ::core::ptr::null_mut::<FILE>(),
        f_template: ::core::ptr::null_mut::<FILE>(),
    ...
    svg.f_txtlog = open_outfile(
        &raw mut cid_name as *mut ::core::ffi::c_char,
        binlog_name,
        out_dir,
        b"svg\0".as_ptr() as *const ::core::ffi::c_char,
    );
    svg.f_template = f_template;
    svg.cid_name = &raw mut cid_name as *mut ::core::ffi::c_char;
    svg.start_time = 0 as uint64_t;
    svg.packet_count = 0 as ::core::ffi::c_int;
    ...
    ctx.connection_end = Some(
        ...
        as Option<unsafe extern "C" fn(uint64_t, *mut ::core::ffi::c_void) -> ::core::ffi::c_int>;
    ...
    ctx.packet_frame = Some(
        ...
        >;
    ctx.packet_end = Some(
        svg_packet_end as unsafe extern "C" fn(*mut ::core::ffi::c_void) -> ::core::ffi::c_int,
    )
    ...
    ctx.info_message = Some(
        ...
        >;
    ctx.ptr = &raw mut svg as *mut ::core::ffi::c_void;
