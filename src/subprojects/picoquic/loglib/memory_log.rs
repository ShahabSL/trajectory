...
#[derive(Copy, Clone, BitfieldStruct)]
#[repr(C)]
pub struct st_picoquic_memory_line_t {
    ...
    pub cwin_blocked_flow_blocked_stream_blocked_last_bw_estimate_path_limited: [u8; 1],
    #[bitfield(padding)]
    pub c2rust_padding: [u8; 7],
    pub cc_state: uint64_t,
    pub cc_param: uint64_t,
    pub peak_bandwidth_estimate: uint64_t,
    pub bytes_in_transit: uint64_t,
}
pub type picoquic_memory_line_t = st_picoquic_memory_line_t;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct st_picoquic_memory_log_t {
    pub F: *mut FILE,
    pub nb_lines: size_t,
    pub nb_alloc: size_t,
    pub lines: *mut picoquic_memory_line_t,
}
pub type picoquic_memory_log_t = st_picoquic_memory_log_t;
pub const UINT64_MAX: ::core::ffi::c_ulong = 18446744073709551615 as ::core::ffi::c_ulong;
pub const NULL: *mut ::core::ffi::c_void =
    ::core::ptr::null::<::core::ffi::c_void>() as *mut ::core::ffi::c_void;
#[no_mangle]
pub unsafe extern "C" fn memlog_fill_line(
    mut cnx: *mut picoquic_cnx_t,
    mut path: *mut picoquic_path_t,
    mut memline: *mut picoquic_memory_line_t,
    mut previous_line: *mut picoquic_memory_line_t,
    ...
    if (*cnx).is_multipath_enabled() != 0 {
        pkt_ctx = &raw mut (*path).pkt_ctx;
    }
    (*memline).current_time = current_time.wrapping_sub((*cnx).start_time);
    ...
    if (*pkt_ctx).highest_acknowledged != UINT64_MAX as uint64_t {
        ...
        (*memline).highest_acknowledged_time = (*pkt_ctx)
            .highest_acknowledged_time
            .wrapping_sub((*cnx).start_time);
        (*memline).latest_time_acknowledged = (*pkt_ctx)
            .latest_time_acknowledged
            .wrapping_sub((*cnx).start_time);
    } else {
        (*memline).highest_acknowledged = UINT64_MAX as uint64_t;
        (*memline).highest_acknowledged_time = 0 as uint64_t;
        (*memline).latest_time_acknowledged = 0 as uint64_t;
    }
    if !previous_line.is_null()
        ...
        && (*previous_line).highest_acknowledged == (*memline).highest_acknowledged
    {
        ...
        (*memline).send_mtu = (*path).send_mtu as uint64_t;
        ...
        (*memline).set_cwin_blocked((*cnx).cwin_blocked() as ::core::ffi::c_uint);
        (*memline).set_flow_blocked((*cnx).flow_blocked() as ::core::ffi::c_uint);
        (*memline).set_stream_blocked((*cnx).stream_blocked() as ::core::ffi::c_uint);
        if (*cnx).congestion_alg.is_null()
            || (**(*cnx).path.offset(0 as ::core::ffi::c_int as isize))
                .congestion_alg_state
                .is_null()
        {
            (*memline).cc_state = 0 as uint64_t;
            (*memline).cc_param = 0 as uint64_t;
        } else {
            (*(*cnx).congestion_alg)
                .alg_observe
                .expect("non-null function pointer")(
                *(*cnx).path.offset(0 as ::core::ffi::c_int as isize) as *mut picoquic_path_t,
                &raw mut (*memline).cc_state,
                &raw mut (*memline).cc_param,
            );
        }
        (*memline).peak_bandwidth_estimate = (*path).peak_bandwidth_estimate;
        (*memline).bytes_in_transit = (*path).bytes_in_transit;
        (*memline).set_last_bw_estimate_path_limited(
            (*path).last_bw_estimate_path_limited() as ::core::ffi::c_uint
        );
    }
    return ret;
}
#[no_mangle]
pub unsafe extern "C" fn memlog_print_header(mut F: *mut FILE) {
    fprintf(
        F,
        b"current_time, \0".as_ptr() as *const ::core::ffi::c_char,
    );
    fprintf(
        F,
        b"send_sequence, \0".as_ptr() as *const ::core::ffi::c_char,
    );
    fprintf(F, b"highest_ack, \0".as_ptr() as *const ::core::ffi::c_char);
    fprintf(
        F,
        b"high_ack_time, \0".as_ptr() as *const ::core::ffi::c_char,
    );
    fprintf(
        F,
        b"latest_time_ack, \0".as_ptr() as *const ::core::ffi::c_char,
    );
    fprintf(F, b"cwin, \0".as_ptr() as *const ::core::ffi::c_char);
    fprintf(
        F,
        b"one_way_delay, \0".as_ptr() as *const ::core::ffi::c_char,
    );
    fprintf(F, b"rtt_sample, \0".as_ptr() as *const ::core::ffi::c_char);
    fprintf(
        F,
        b"smoothed_rtt, \0".as_ptr() as *const ::core::ffi::c_char,
    );
    fprintf(F, b"rtt_min, \0".as_ptr() as *const ::core::ffi::c_char);
    fprintf(F, b"bw_e, \0".as_ptr() as *const ::core::ffi::c_char);
    fprintf(F, b"recv_rate, \0".as_ptr() as *const ::core::ffi::c_char);
    fprintf(F, b"send_mtu, \0".as_ptr() as *const ::core::ffi::c_char);
    fprintf(F, b"packet_time, \0".as_ptr() as *const ::core::ffi::c_char);
    fprintf(F, b"nb_retrans, \0".as_ptr() as *const ::core::ffi::c_char);
    fprintf(F, b"nb_spurious, \0".as_ptr() as *const ::core::ffi::c_char);
    fprintf(
        F,
        b"cwin_blocked, \0".as_ptr() as *const ::core::ffi::c_char,
    );
    fprintf(
        F,
        b"flow_blocked, \0".as_ptr() as *const ::core::ffi::c_char,
    );
    fprintf(
        F,
        b"stream_blocked, \0".as_ptr() as *const ::core::ffi::c_char,
    );
    fprintf(F, b"cc_state, \0".as_ptr() as *const ::core::ffi::c_char);
    fprintf(F, b"cc_param, \0".as_ptr() as *const ::core::ffi::c_char);
    fprintf(
        F,
        b"peak_bandwidth_estimate, \0".as_ptr() as *const ::core::ffi::c_char,
    );
    fprintf(
        F,
        b"bytes_in_transit, \0".as_ptr() as *const ::core::ffi::c_char,
    );
    fprintf(
        F,
        b"bwe_path_limited\0".as_ptr() as *const ::core::ffi::c_char,
    );
    fprintf(F, b"\n\0".as_ptr() as *const ::core::ffi::c_char);
}
#[no_mangle]
pub unsafe extern "C" fn memlog_print_line(
    mut F: *mut FILE,
    mut memline: *mut picoquic_memory_line_t,
) {
    fprintf(
        ...
        (*memline).current_time,
    );
    fprintf(
        F,
        b"%lu,\0".as_ptr() as *const ::core::ffi::c_char,
        (*memline).send_sequence,
    );
    fprintf(
        F,
        b"%li,\0".as_ptr() as *const ::core::ffi::c_char,
        (*memline).highest_acknowledged as int64_t,
    );
    fprintf(
        F,
        b"%lu,\0".as_ptr() as *const ::core::ffi::c_char,
        (*memline).highest_acknowledged_time,
    );
    fprintf(
        F,
        b"%lu,\0".as_ptr() as *const ::core::ffi::c_char,
        (*memline).latest_time_acknowledged,
    );
    fprintf(
        F,
        b"%lu,\0".as_ptr() as *const ::core::ffi::c_char,
    ...
    fprintf(
        F,
        b"%lu,\0".as_ptr() as *const ::core::ffi::c_char,
        (*memline).bandwidth_estimate,
    );
    fprintf(
        F,
        b"%lu,\0".as_ptr() as *const ::core::ffi::c_char,
        (*memline).receive_rate_estimate,
    );
    fprintf(
        F,
        b"%lu,\0".as_ptr() as *const ::core::ffi::c_char,
    ...
    fprintf(
        F,
        b"%lu,\0".as_ptr() as *const ::core::ffi::c_char,
        (*memline).packet_time_microsec,
    );
    fprintf(
        F,
        b"%lu,\0".as_ptr() as *const ::core::ffi::c_char,
        (*memline).nb_retransmission_total,
    );
    fprintf(
        F,
        b"%lu,\0".as_ptr() as *const ::core::ffi::c_char,
    ...
    fprintf(
        ...
        (*memline).cwin_blocked() as ::core::ffi::c_int,
    );
    fprintf(
        F,
        b"%u,\0".as_ptr() as *const ::core::ffi::c_char,
        (*memline).flow_blocked() as ::core::ffi::c_int,
    );
    fprintf(
        F,
        b"%u,\0".as_ptr() as *const ::core::ffi::c_char,
        (*memline).stream_blocked() as ::core::ffi::c_int,
    );
    fprintf(
        F,
        b"%lu,\0".as_ptr() as *const ::core::ffi::c_char,
    ...
    fprintf(
        F,
        b"%lu,\0".as_ptr() as *const ::core::ffi::c_char,
        (*memline).peak_bandwidth_estimate,
    );
    fprintf(
        F,
        b"%lu,\0".as_ptr() as *const ::core::ffi::c_char,
        (*memline).bytes_in_transit,
    );
    fprintf(
        F,
        b"%u,\0".as_ptr() as *const ::core::ffi::c_char,
        (*memline).last_bw_estimate_path_limited() as ::core::ffi::c_int,
    );
    fprintf(F, b"\n\0".as_ptr() as *const ::core::ffi::c_char);
}
#[no_mangle]
pub unsafe extern "C" fn memlog_call_back(
    mut cnx: *mut picoquic_cnx_t,
    mut path: *mut picoquic_path_t,
    mut v_memlog: *mut ::core::ffi::c_void,
    mut op_code: ::core::ffi::c_int,
    mut current_time: uint64_t,
) {
    let mut memlog: *mut picoquic_memory_log_t = v_memlog as *mut picoquic_memory_log_t;
    if !memlog.is_null() {
        if op_code == 0 as ::core::ffi::c_int {
            if (*memlog).nb_lines < (*memlog).nb_alloc {
                if memlog_fill_line(
                    cnx,
                    path,
                    (*memlog).lines.offset((*memlog).nb_lines as isize)
                        as *mut picoquic_memory_line_t,
                    (if (*memlog).nb_lines == 0 as size_t {
                        ::core::ptr::null_mut::<picoquic_memory_line_t>()
                    } else {
                        (*memlog)
                            .lines
                            .offset((*memlog).nb_lines.wrapping_sub(1 as size_t) as isize)
                            as *mut picoquic_memory_line_t
                    }),
                    current_time,
                ) == 0 as ::core::ffi::c_int
                {
                    (*memlog).nb_lines = (*memlog).nb_lines.wrapping_add(1);
                }
            }
        } else {
            if !(*memlog).F.is_null() {
                ...
                while i < (*memlog).nb_lines {
                    memlog_print_line(
                        (*memlog).F,
                        (*memlog).lines.offset(i as isize) as *mut picoquic_memory_line_t,
                    );
                    i = i.wrapping_add(1);
                }
                (*memlog).F = picoquic_file_close((*memlog).F);
            }
            free((*memlog).lines as *mut ::core::ffi::c_void);
            free(memlog as *mut ::core::ffi::c_void);
        }
    }
}
#[no_mangle]
pub unsafe extern "C" fn memlog_init(
    mut cnx: *mut picoquic_cnx_t,
    mut nb_lines: size_t,
    mut memlog_file: *const ::core::ffi::c_char,
) -> ::core::ffi::c_int {
    let mut ret: ::core::ffi::c_int = -(1 as ::core::ffi::c_int);
    let mut memlog: *mut picoquic_memory_log_t =
        malloc(::core::mem::size_of::<picoquic_memory_log_t>() as size_t)
            as *mut picoquic_memory_log_t;
    if !memlog.is_null() {
        memset(
            memlog as *mut ::core::ffi::c_void,
            0 as ::core::ffi::c_int,
            ::core::mem::size_of::<picoquic_memory_log_t>() as size_t,
        );
        (*memlog).lines = malloc(
            nb_lines.wrapping_mul(::core::mem::size_of::<picoquic_memory_line_t>() as size_t),
        ) as *mut picoquic_memory_line_t;
        if !(*memlog).lines.is_null() {
            (*memlog).nb_alloc = nb_lines;
            (*memlog).F =
                picoquic_file_open(memlog_file, b"wt\0".as_ptr() as *const ::core::ffi::c_char);
            if (*memlog).F.is_null() {
                free((*memlog).lines as *mut ::core::ffi::c_void);
                ret = -(1 as ::core::ffi::c_int);
            } else {
