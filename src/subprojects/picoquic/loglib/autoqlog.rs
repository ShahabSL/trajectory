...
extern "C" {
    ...
    fn qlog_convert(
        ...
        txt_name: *const ::core::ffi::c_char,
        out_dir: *const ::core::ffi::c_char,
        flags: uint16_t,
    ) -> ::core::ffi::c_int;
    fn picoquic_enable_binlog(quic: *mut picoquic_quic_t);
}
...
#[no_mangle]
pub unsafe extern "C" fn autoqlog(mut cnx: *mut picoquic_cnx_t) -> ::core::ffi::c_int {
    let mut ret: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut log_time: uint64_t = (*cnx).start_time;
    let mut flags: uint16_t = 0 as uint16_t;
    let mut error_code: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut f_binlog: *mut FILE = picoquic_open_cc_log_file_for_read(
        (*cnx).binlog_file_name,
        &raw mut flags,
        &raw mut log_time,
    );
    if f_binlog.is_null() {
        error_code = 1 as ::core::ffi::c_int;
        ...
        {
            error_code = 2 as ::core::ffi::c_int;
            ret = -(1 as ::core::ffi::c_int);
        } else {
            ...
            if (*(*cnx).quic).use_unique_log_names() != 0 {
                sprintf_ret = picoquic_sprintf(
                    ...
                    b"%s%s%s.%x.%s.%s\0".as_ptr() as *const ::core::ffi::c_char,
                    (*(*cnx).quic).qlog_dir,
                ...
                sprintf_ret = picoquic_sprintf(
                    ...
                    ::core::mem::size_of::<[::core::ffi::c_char; 512]>() as size_t,
                    ::core::ptr::null_mut::<size_t>(),
                    b"%s%s%s.%s.%s\0".as_ptr() as *const ::core::ffi::c_char,
                    (*(*cnx).quic).qlog_dir,
                    PICOQUIC_FILE_SEPARATOR.as_ptr(),
                    &raw mut cid_name as *mut ::core::ffi::c_char,
                    if (*cnx).client_mode() as ::core::ffi::c_int != 0 {
            ...
            if sprintf_ret != 0 as ::core::ffi::c_int {
                ret = -(1 as ::core::ffi::c_int);
                error_code = 3 as ::core::ffi::c_int;
            } else {
                ret = qlog_convert(
                    &raw mut (*cnx).initial_cnxid,
                    f_binlog,
                ...
                if ret != 0 as ::core::ffi::c_int {
                    error_code = 4 as ::core::ffi::c_int;
                } else if (*(*cnx).quic).binlog_dir.is_null() {
                    let mut last_err: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
                    ret = picoquic_file_delete((*cnx).binlog_file_name, &raw mut last_err);
                    if ret != 0 as ::core::ffi::c_int {
                        error_code = 5 as ::core::ffi::c_int;
                    }
                }
            }
        }
    ...
    if ret != 0 as ::core::ffi::c_int {
        let mut F_err: *mut FILE = ::core::ptr::null_mut::<FILE>();
        let mut err_file_name: [::core::ffi::c_char; 512] = [0; 512];
        let mut name_len: size_t = strlen((*cnx).binlog_file_name);
        if name_len > 500 as size_t {
            name_len = 500 as size_t;
        }
        memcpy(
            &raw mut err_file_name as *mut ::core::ffi::c_char as *mut ::core::ffi::c_void,
            (*cnx).binlog_file_name as *const ::core::ffi::c_void,
            name_len,
        );
        memcpy(
            (&raw mut err_file_name as *mut ::core::ffi::c_char).offset(name_len as isize)
                as *mut ::core::ffi::c_void,
            b".errlog\0".as_ptr() as *const ::core::ffi::c_char as *const ::core::ffi::c_void,
            7 as size_t,
        );
        err_file_name[name_len.wrapping_add(0 as size_t) as usize] = 0 as ::core::ffi::c_char;
        F_err = picoquic_file_open(
            &raw mut err_file_name as *mut ::core::ffi::c_char,
            b"wt\0".as_ptr() as *const ::core::ffi::c_char,
        );
        if !F_err.is_null() {
            fprintf(
                F_err,
                b"Cannot create qlog file for %s, error: %d\n\0".as_ptr()
                    as *const ::core::ffi::c_char,
                (*cnx).binlog_file_name,
                error_code,
            );
        }
        picoquic_file_close(F_err);
    }
    return ret;
}
#[no_mangle]
pub unsafe extern "C" fn picoquic_set_qlog(
    mut quic: *mut picoquic_quic_t,
    mut qlog_dir: *const ::core::ffi::c_char,
) -> ::core::ffi::c_int {
    (*quic).autoqlog_fn =
        Some(autoqlog as unsafe extern "C" fn(*mut picoquic_cnx_t) -> ::core::ffi::c_int)
            as picoquic_autoqlog_fn;
