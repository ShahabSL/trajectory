...
extern "C" {
    ...
    fn bytestream_size(s: *mut bytestream) -> size_t;
    fn bytestream_remain(s: *mut bytestream) -> size_t;
    fn bytestream_skip(s: *mut bytestream, nb_bytes: size_t) -> ::core::ffi::c_int;
    ...
    fn byteread_int32(s: *mut bytestream, value: *mut uint32_t) -> ::core::ffi::c_int;
    fn byteread_int64(s: *mut bytestream, value: *mut uint64_t) -> ::core::ffi::c_int;
    fn byteread_vint(s: *mut bytestream, value: *mut uint64_t) -> ::core::ffi::c_int;
    fn byteread_vlen(s: *mut bytestream, value: *mut size_t) -> ::core::ffi::c_int;
    fn byteread_cid(s: *mut bytestream, cid: *mut picoquic_connection_id_t) -> ::core::ffi::c_int;
    fn cidset_insert(
        cids: *mut picohash_table,
...
pub type convert_log_file_event_t = convert_log_file_event_st;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct convert_log_file_event_st {
    pub cid: *const picoquic_connection_id_t,
    pub callbacks: *mut binlog_convert_cb_t,
}
...
#[no_mangle]
pub unsafe extern "C" fn fileread_binlog(
    mut bin_log: *mut FILE,
    mut cb: Option<
        unsafe extern "C" fn(*mut bytestream, *mut ::core::ffi::c_void) -> ::core::ffi::c_int,
    >,
    ...
    fseek(bin_log, 16 as ::core::ffi::c_long, SEEK_SET);
    while ret == 0 as ::core::ffi::c_int
        && fread(
            &raw mut head as *mut uint8_t as *mut ::core::ffi::c_void,
            ::core::mem::size_of::<[uint8_t; 4]>() as size_t,
            1 as size_t,
            bin_log,
        ) > 0 as ::core::ffi::c_ulong
    {
        let mut len: uint32_t = ((head[0 as ::core::ffi::c_int as usize] as ::core::ffi::c_int)
            << 24 as ::core::ffi::c_int
            | (head[1 as ::core::ffi::c_int as usize] as ::core::ffi::c_int)
                << 16 as ::core::ffi::c_int
            | (head[2 as ::core::ffi::c_int as usize] as ::core::ffi::c_int)
                << 8 as ::core::ffi::c_int
            | head[3 as ::core::ffi::c_int as usize] as ::core::ffi::c_int)
            as uint32_t;
        if len as usize > ::core::mem::size_of::<[uint8_t; 2560]>() as usize {
            ret = -(1 as ::core::ffi::c_int);
        }
        if ret == 0 as ::core::ffi::c_int
            && fread(
                &raw mut stream_msg.buf as *mut uint8_t as *mut ::core::ffi::c_void,
                len as size_t,
                1 as size_t,
                bin_log,
            ) <= 0 as ::core::ffi::c_ulong
        ...
        if ret == 0 as ::core::ffi::c_int {
            let mut s: *mut bytestream = bytestream_buf_init(&raw mut stream_msg, len as size_t);
            ret |= cb.expect("non-null function pointer")(s, cbptr);
        }
    }
    return ret;
}
unsafe extern "C" fn binlog_convert_event(
    mut s: *mut bytestream,
    mut ptr: *mut ::core::ffi::c_void,
) -> ::core::ffi::c_int {
    let mut ret: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut ctx: *mut convert_log_file_event_t = ptr as *mut convert_log_file_event_t;
    let mut cbptr: *mut ::core::ffi::c_void = (*(*ctx).callbacks).ptr;
    ...
    if ret != 0 as ::core::ffi::c_int
        || picoquic_compare_connection_id(&raw mut cid, (*ctx).cid) != 0 as ::core::ffi::c_int
    {
        return ret;
    }
    ...
    match id {
        16 => {
            let mut client_mode: uint8_t = 0 as uint8_t;
            ret |= byteread_int8(s, &raw mut client_mode);
            let mut proposed_version: uint32_t = 0 as uint32_t;
            ret |= byteread_int32(s, &raw mut proposed_version);
            let mut remote_cnxid: picoquic_connection_id_t = st_picoquic_connection_id_t {
                id: [0; 20],
                id_len: 0,
            };
            ret |= byteread_cid(s, &raw mut remote_cnxid);
            if ret == 0 as ::core::ffi::c_int {
                ret |= (*(*ctx).callbacks)
                    .connection_start
                    ...
                    time,
                    &raw mut cid,
                    client_mode as ::core::ffi::c_int,
                    proposed_version,
                    &raw mut remote_cnxid,
                    cbptr,
                );
            }
        }
        17 => {
            if ret == 0 as ::core::ffi::c_int {
                ret |= (*(*ctx).callbacks)
                    .connection_end
                    .expect("non-null function pointer")(time, cbptr);
            }
        }
        3 | 2 => {
            let mut rxtx: ::core::ffi::c_int = (id
                == picoquic_log_event_pdu_recv as ::core::ffi::c_int as uint64_t)
                as ::core::ffi::c_int;
            ret |=
                (*(*ctx).callbacks).pdu.expect("non-null function pointer")(time, rxtx, s, cbptr);
        }
        9 | 8 => {
            let mut rxtx_0: ::core::ffi::c_int = (id
                == picoquic_log_event_packet_recv as ::core::ffi::c_int as uint64_t)
                as ::core::ffi::c_int;
            let mut packet_length: uint64_t = 0 as uint64_t;
            ret |= byteread_vint(s, &raw mut packet_length);
            ...
            ret |= byteread_packet_header(s, &raw mut ph);
            if ret == 0 as ::core::ffi::c_int {
                ret = (*(*ctx).callbacks)
                    .packet_start
                    .expect("non-null function pointer")(
            ...
            while ret == 0 as ::core::ffi::c_int && bytestream_remain(s) > 0 as size_t {
                let mut len: size_t = 0 as size_t;
                ret = byteread_vlen(s, &raw mut len);
                if ret == 0 as ::core::ffi::c_int {
                    let mut stream: bytestream = bytestream {
                        data: ::core::ptr::null_mut::<uint8_t>(),
                        size: 0,
                        ptr: 0,
                    };
                    let mut frame: *mut bytestream = bytestream_ref_init(
                        &raw mut stream,
            ...
            if ret == 0 as ::core::ffi::c_int {
                ret = (*(*ctx).callbacks)
                    .packet_end
                    .expect("non-null function pointer")(cbptr);
            }
        }
        20 => {
            if ret == 0 as ::core::ffi::c_int {
        ...
        55 => {
            if ret == 0 as ::core::ffi::c_int {
                ret = (*(*ctx).callbacks)
                    .alpn_update
                    .expect("non-null function pointer")(time, s, cbptr);
            }
        }
        54 => {
            if ret == 0 as ::core::ffi::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn binlog_convert(
    mut f_binlog: *mut FILE,
    mut cid: *const picoquic_connection_id_t,
    mut callbacks: *mut binlog_convert_cb_t,
) -> ::core::ffi::c_int {
    let mut ctx: convert_log_file_event_t = convert_log_file_event_st {
        cid: ::core::ptr::null::<picoquic_connection_id_t>(),
        callbacks: ::core::ptr::null_mut::<binlog_convert_cb_t>(),
    };
    ctx.cid = cid;
    ctx.callbacks = callbacks;
    return fileread_binlog(
        f_binlog,
        Some(
            binlog_convert_event
...
unsafe extern "C" fn binlog_list_cids_cb(
    mut s: *mut bytestream,
    mut cbptr: *mut ::core::ffi::c_void,
) -> ::core::ffi::c_int {
    let mut cid: picoquic_connection_id_t = st_picoquic_connection_id_t {
    ...
    let mut ret: ::core::ffi::c_int = byteread_cid(s, &raw mut cid);
    if ret == 0 as ::core::ffi::c_int {
        ret = cidset_insert(cbptr as *mut picohash_table, &raw mut cid);
    }
    return ret;
}
#[no_mangle]
pub unsafe extern "C" fn binlog_list_cids(
    mut binlog: *mut FILE,
    ...
    return fileread_binlog(
        ...
        cids as *mut ::core::ffi::c_void,
    );
}
unsafe extern "C" fn byteread_packet_header(
    mut s: *mut bytestream,
    mut ph: *mut picoquic_packet_header,
) -> ::core::ffi::c_int {
    let mut ret: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut header_flags: uint8_t = 0 as uint8_t;
    byteread_int8(s, &raw mut header_flags);
    (*ph).set_quic_bit_is_zero(
        (header_flags as ::core::ffi::c_int & 64 as ::core::ffi::c_int != 0 as ::core::ffi::c_int)
            as ::core::ffi::c_int as ::core::ffi::c_uint as ::core::ffi::c_uint,
    );
    (*ph).set_spin(
        (header_flags as ::core::ffi::c_int & 2 as ::core::ffi::c_int != 0 as ::core::ffi::c_int)
            as ::core::ffi::c_int as ::core::ffi::c_uint as ::core::ffi::c_uint,
    );
    (*ph).set_key_phase(
        (header_flags as ::core::ffi::c_int & 1 as ::core::ffi::c_int != 0 as ::core::ffi::c_int)
            as ::core::ffi::c_int as ::core::ffi::c_uint as ::core::ffi::c_uint,
    );
    let mut payload_length: size_t = 0 as size_t;
    byteread_vlen(s, &raw mut payload_length);
    (*ph).payload_length = payload_length;
    let mut ptype: uint64_t = 0;
    byteread_vint(s, &raw mut ptype);
    (*ph).ptype = ptype as picoquic_packet_type_enum;
    byteread_vint(s, &raw mut (*ph).pn64);
    byteread_cid(s, &raw mut (*ph).dest_cnx_id);
    byteread_cid(s, &raw mut (*ph).srce_cnx_id);
    if ptype != picoquic_packet_1rtt_protected as ::core::ffi::c_int as uint64_t
        && ptype != picoquic_packet_version_negotiation as ::core::ffi::c_int as uint64_t
    {
        byteread_int32(s, &raw mut (*ph).vn);
    } else {
        (*ph).vn = 0 as uint32_t;
    }
    (*ph).token_length = 0 as size_t;
    (*ph).token_bytes = ::core::ptr::null::<uint8_t>();
    if ptype == picoquic_packet_initial as ::core::ffi::c_int as uint64_t {
        byteread_vlen(s, &raw mut (*ph).token_length);
        (*ph).token_bytes = (*s).data.offset((*s).ptr as isize);
        bytestream_skip(s, (*ph).token_length);
    }
    return ret;
}
#[no_mangle]
pub unsafe extern "C" fn open_outfile(
    mut cid_name: *const ::core::ffi::c_char,
    mut binlog_name: *const ::core::ffi::c_char,
    mut out_dir: *const ::core::ffi::c_char,
    mut out_ext: *const ::core::ffi::c_char,
) -> *mut FILE {
    if out_dir.is_null() {
        return stdout;
    }
    ...
    if f.is_null() {
        fprintf(
            stderr,
            b"Could not open '%s' for writing (err=%d)\0".as_ptr() as *const ::core::ffi::c_char,
            &raw mut filename as *mut ::core::ffi::c_char,
            *__errno_location(),
        );
    }
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_open_cc_log_file_for_read(
    mut bin_cc_log_name: *const ::core::ffi::c_char,
    mut flags: *mut uint16_t,
    mut log_time: *mut uint64_t,
) -> *mut FILE {
    let mut ret: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut bin_log: *mut FILE = picoquic_file_open(
        bin_cc_log_name,
    ...
    if ret == 0 as ::core::ffi::c_int {
        ...
        let mut fcc: uint32_t = 0 as uint32_t;
        let mut version: uint16_t = 0 as uint16_t;
        if fread(
            &raw mut stream.buf as *mut uint8_t as *mut ::core::ffi::c_void,
            bytestream_size(ps),
            1 as size_t,
            bin_log,
        ) <= 0 as ::core::ffi::c_ulong
        {
            ret = -(1 as ::core::ffi::c_int);
        } else if byteread_int32(ps, &raw mut fcc) != 0 as ::core::ffi::c_int
            || fcc
        ...
        {
            ret = -(1 as ::core::ffi::c_int);
        } else if byteread_int16(ps, flags) != 0 as ::core::ffi::c_int {
            ret = -(1 as ::core::ffi::c_int);
        } else if byteread_int16(ps, &raw mut version) != 0 as ::core::ffi::c_int
            || version as ::core::ffi::c_int != 0x1 as ::core::ffi::c_int
        {
            ret = -(1 as ::core::ffi::c_int);
        } else {
