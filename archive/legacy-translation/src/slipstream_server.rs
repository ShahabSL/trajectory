...
extern "C" {
    ...
    fn picoquic_get_quic_ctx(cnx: *mut picoquic_cnx_t) -> *mut picoquic_quic_t;
    ...
    fn picoquic_get_default_callback_context(
        quic: *mut picoquic_quic_t,
    ) -> *mut ::core::ffi::c_void;
    fn picoquic_set_app_stream_ctx(
        cnx: *mut picoquic_cnx_t,
        stream_id: uint64_t,
        app_stream_ctx: *mut ::core::ffi::c_void,
    ) -> ::core::ffi::c_int;
    ...
    fn slipstream_inline_undotify(buf: *mut ::core::ffi::c_char, len: size_t) -> size_t;
    static mut slipstream_server_cc_algorithm: *mut picoquic_congestion_algorithm_t;
    ...
    fn sockaddr_dummy(addr_storage: *mut sockaddr_storage);
...
pub type slipstream_server_ctx_t = st_slipstream_server_ctx_t;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct st_slipstream_server_ctx_t {
    pub cnx: *mut picoquic_cnx_t,
    pub first_stream: *mut slipstream_server_stream_ctx_t,
    pub thread_ctx: *mut picoquic_network_thread_ctx_t,
    pub upstream_addr: sockaddr_storage,
    pub prev_ctx: *mut st_slipstream_server_ctx_t,
    pub next_ctx: *mut st_slipstream_server_ctx_t,
}
pub type slipstream_server_stream_ctx_t = st_slipstream_server_stream_ctx_t;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct st_slipstream_server_stream_ctx_t {
    pub next_stream: *mut st_slipstream_server_stream_ctx_t,
    pub previous_stream: *mut st_slipstream_server_stream_ctx_t,
    pub fd: ::core::ffi::c_int,
    pub pipefd: [::core::ffi::c_int; 2],
    pub stream_id: uint64_t,
    pub set_active: sig_atomic_t,
}
pub type slipstream_server_poller_args = st_slipstream_server_poller_args;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct st_slipstream_server_poller_args {
    pub fd: ::core::ffi::c_int,
    pub cnx: *mut picoquic_cnx_t,
    pub server_ctx: *mut slipstream_server_ctx_t,
    pub stream_ctx: *mut slipstream_server_stream_ctx_t,
}
pub type slipstream_io_copy_args = st_slipstream_io_copy_args;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct st_slipstream_io_copy_args {
    pub pipe: ::core::ffi::c_int,
...
pub const __ASSERT_FUNCTION: [::core::ffi::c_char; 151] = unsafe {
    ::core::mem::transmute::<
        [u8; 151],
        [::core::ffi::c_char; 151],
    >(
        *b"ssize_t server_encode(void *, void *, unsigned char **, const unsigned char *, size_t, size_t *, struct sockaddr_storage *, struct sockaddr_storage *)\0",
    )
};
...
pub const MAX_UDP_PACKET_SIZE: ::core::ffi::c_int = 1492 as ::core::ffi::c_int;
#[no_mangle]
pub static mut should_shutdown: sig_atomic_t = 0 as sig_atomic_t;
#[no_mangle]
pub unsafe extern "C" fn server_sighandler(mut signum: ::core::ffi::c_int) {
    debug_printf(
        b"%s:%u [%s]: Signal %d received\n\0".as_ptr() as *const ::core::ffi::c_char,
        (b"../src/slipstream_server.c\0".as_ptr() as *const ::core::ffi::c_char).offset(
        ...
        b"server_sighandler\0".as_ptr() as *const ::core::ffi::c_char,
        signum,
    );
...
#[no_mangle]
pub static mut server_domain_name: *mut ::core::ffi::c_char =
    ::core::ptr::null::<::core::ffi::c_char>() as *mut ::core::ffi::c_char;
#[no_mangle]
pub static mut server_domain_name_len: size_t = 0 as size_t;
#[no_mangle]
pub unsafe extern "C" fn server_encode(
    ...
    *dest_buf = ::core::ptr::null_mut::<::core::ffi::c_uchar>();
    '_c2rust_label: {
        if segment_len.is_null() || *segment_len == 0 as size_t || *segment_len == src_buf_len {
        } else {
            __assert_fail(
                b"segment_len == NULL || *segment_len == 0 || *segment_len == src_buf_len\0"
                    .as_ptr() as *const ::core::ffi::c_char,
                b"../src/slipstream_server.c\0".as_ptr() as *const ::core::ffi::c_char,
                44 as ::core::ffi::c_uint,
                __ASSERT_FUNCTION.as_ptr(),
            );
        }
    };
    let mut slot: *mut slot_t = slot_p as *mut slot_t;
    let mut query: *mut dns_query_t =
        &raw mut (*slot).dns_decoded as *mut dns_decoded_t as *mut dns_query_t;
    let mut answer_txt: dns_txt_t = dns_txt_t {
    ...
    let mut response: dns_query_t = dns_query_t {
    ...
    response.query = false_0 != 0;
    response.opcode = OP_QUERY;
    response.aa = true_0 != 0;
    response.rd = (*query).rd;
    response.cd = (*query).cd;
    response.rcode = (*slot).error;
    response.qdcount = 1 as size_t;
    response.questions = (*query).questions;
    if src_buf_len > 0 as size_t {
        let mut question: *const dns_question_t =
            (*query).questions.offset(0 as ::core::ffi::c_int as isize) as *mut dns_question_t;
        answer_txt.name = (*question).name;
        answer_txt.type_0 = (*question).type_0;
        answer_txt.class = (*question).class;
        answer_txt.ttl = 60 as TTL;
        answer_txt.text = src_buf as *mut ::core::ffi::c_char;
        answer_txt.len = src_buf_len;
        response.ancount = 1 as size_t;
        response.answers = &raw mut answer_txt as *mut dns_answer_t;
    } else if (*slot).error as ::core::ffi::c_uint
        == RCODE_OKAY as ::core::ffi::c_int as ::core::ffi::c_uint
    {
        response.rcode = RCODE_NAME_ERROR;
    }
    response.arcount = 1 as size_t;
    response.additional = &raw mut edns;
    let mut packet: *mut dns_packet_t = malloc(MAX_UDP_PACKET_SIZE as size_t) as *mut dns_packet_t;
    let mut packet_len: size_t = MAX_UDP_PACKET_SIZE as size_t;
    let mut rc: dns_rcode_t = dns_encode(packet, &raw mut packet_len, &raw mut response);
    if rc as ::core::ffi::c_uint != RCODE_OKAY as ::core::ffi::c_int as ::core::ffi::c_uint {
        free(packet as *mut ::core::ffi::c_void);
        debug_printf(
            b"%s:%u [%s]: dns_encode() = (%d) %s\n\0".as_ptr() as *const ::core::ffi::c_char,
            (b"../src/slipstream_server.c\0".as_ptr() as *const ::core::ffi::c_char).offset(
                (if 24 as usize > ::core::mem::size_of::<[::core::ffi::c_char; 27]>() as usize {
                    24 as usize
                } else {
            ...
            b"server_encode\0".as_ptr() as *const ::core::ffi::c_char,
            rc as ::core::ffi::c_uint,
            dns_rcode_text(rc),
        );
        return EXIT_FAILURE as ssize_t;
    }
    *dest_buf = packet as *mut ::core::ffi::c_uchar;
    memcpy(
        peer_addr as *mut ::core::ffi::c_void,
        &raw mut (*slot).peer_addr as *const ::core::ffi::c_void,
        ::core::mem::size_of::<sockaddr_storage>() as size_t,
    );
    memcpy(
        local_addr as *mut ::core::ffi::c_void,
        &raw mut (*slot).local_addr as *const ::core::ffi::c_void,
        ::core::mem::size_of::<sockaddr_storage>() as size_t,
    );
    return packet_len as ssize_t;
}
#[no_mangle]
pub unsafe extern "C" fn server_decode(
    mut slot_p: *mut ::core::ffi::c_void,
    mut callback_ctx: *mut ::core::ffi::c_void,
    mut dest_buf: *mut *mut ::core::ffi::c_uchar,
    mut src_buf: *const ::core::ffi::c_uchar,
    ...
    *dest_buf = ::core::ptr::null_mut::<::core::ffi::c_uchar>();
    let mut slot: *mut slot_t = slot_p as *mut slot_t;
    memcpy(
        &raw mut (*slot).peer_addr as *mut ::core::ffi::c_void,
        peer_addr as *const ::core::ffi::c_void,
        ::core::mem::size_of::<sockaddr_storage>() as size_t,
    );
    sockaddr_dummy(peer_addr);
    memcpy(
        &raw mut (*slot).local_addr as *mut ::core::ffi::c_void,
        local_addr as *const ::core::ffi::c_void,
        ::core::mem::size_of::<sockaddr_storage>() as size_t,
    );
    let mut packet_len: size_t =
        DNS_DECODEBUF_4K.wrapping_mul(::core::mem::size_of::<dns_decoded_t>() as size_t);
    let mut packet: *mut dns_decoded_t = &raw mut (*slot).dns_decoded as *mut dns_decoded_t;
    ...
    if rc as ::core::ffi::c_uint != RCODE_OKAY as ::core::ffi::c_int as ::core::ffi::c_uint {
        debug_printf(
            ...
            b"server_decode\0".as_ptr() as *const ::core::ffi::c_char,
            rc as ::core::ffi::c_uint,
            dns_rcode_text(rc),
        );
        return -(1 as ::core::ffi::c_int) as ssize_t;
    }
    let mut query: *const dns_query_t = packet as *mut dns_query_t;
    if !(*query).query {
        debug_printf(
            b"%s:%u [%s]: dns record is not a query\n\0".as_ptr() as *const ::core::ffi::c_char,
            (b"../src/slipstream_server.c\0".as_ptr() as *const ::core::ffi::c_char).offset(
                (if 24 as usize > ::core::mem::size_of::<[::core::ffi::c_char; 27]>() as usize {
                    24 as usize
                } else {
    ...
    if (*query).qdcount != 1 as size_t {
        debug_printf(
            b"%s:%u [%s]: dns record should contain exactly one query\n\0".as_ptr()
                as *const ::core::ffi::c_char,
            (b"../src/slipstream_server.c\0".as_ptr() as *const ::core::ffi::c_char).offset(
                (if 24 as usize > ::core::mem::size_of::<[::core::ffi::c_char; 27]>() as usize {
                    24 as usize
    ...
    let mut question: *const dns_question_t =
        (*query).questions.offset(0 as ::core::ffi::c_int as isize) as *mut dns_question_t;
    if (*question).type_0 as ::core::ffi::c_uint
        != RR_TXT as ::core::ffi::c_int as ::core::ffi::c_uint
    {
        (*slot).error = RCODE_NAME_ERROR;
        return 0 as ssize_t;
    }
    let data_len: ssize_t = strlen((*question).name)
        .wrapping_sub(server_domain_name_len)
        .wrapping_sub(1 as size_t)
        .wrapping_sub(1 as size_t) as ssize_t;
    if data_len <= 0 as ssize_t {
        debug_printf(
            b"%s:%u [%s]: subdomain is empty\n\0".as_ptr() as *const ::core::ffi::c_char,
            (b"../src/slipstream_server.c\0".as_ptr() as *const ::core::ffi::c_char).offset(
                (if 24 as usize > ::core::mem::size_of::<[::core::ffi::c_char; 27]>() as usize {
                    24 as usize
                } else {
    ...
    let vla = (data_len + 1 as ssize_t) as usize;
    let mut data_buf: Vec<::core::ffi::c_char> = ::std::vec::from_elem(0, vla);
    memcpy(
        data_buf.as_mut_ptr() as *mut ::core::ffi::c_void,
        (*question).name as *const ::core::ffi::c_void,
        data_len as size_t,
    );
    *data_buf.as_mut_ptr().offset(data_len as isize) = '\0' as i32 as ::core::ffi::c_char;
    let encoded_len: size_t =
        slipstream_inline_undotify(data_buf.as_mut_ptr(), data_len as size_t) as size_t;
    let mut decoded_buf: *mut ::core::ffi::c_char = malloc(encoded_len) as *mut ::core::ffi::c_char;
    let decoded_len: size_t = b32_decode(
        decoded_buf,
        data_buf.as_mut_ptr(),
        encoded_len,
        false_0 as uint32_t,
    ) as size_t;
    if decoded_len == -(1 as ::core::ffi::c_int) as size_t {
        free(decoded_buf as *mut ::core::ffi::c_void);
        debug_printf(
            b"%s:%u [%s]: error decoding base32: %lu\n\0".as_ptr() as *const ::core::ffi::c_char,
            (b"../src/slipstream_server.c\0".as_ptr() as *const ::core::ffi::c_char).offset(
                (if 24 as usize > ::core::mem::size_of::<[::core::ffi::c_char; 27]>() as usize {
                    24 as usize
                } else {
    ...
    *dest_buf = decoded_buf as *mut ::core::ffi::c_uchar;
    return decoded_len as ssize_t;
}
#[no_mangle]
pub unsafe extern "C" fn slipstream_server_create_stream_ctx(
    mut server_ctx: *mut slipstream_server_ctx_t,
    mut stream_id: uint64_t,
) -> *mut slipstream_server_stream_ctx_t {
    let mut stream_ctx: *mut slipstream_server_stream_ctx_t =
        malloc(::core::mem::size_of::<slipstream_server_stream_ctx_t>() as size_t)
            as *mut slipstream_server_stream_ctx_t;
    if stream_ctx.is_null() {
        debug_printf(
            b"%s:%u [%s]: Memory Error, cannot create stream\n\0".as_ptr()
                as *const ::core::ffi::c_char,
            (b"../src/slipstream_server.c\0".as_ptr() as *const ::core::ffi::c_char).offset(
                (if 24 as usize > ::core::mem::size_of::<[::core::ffi::c_char; 27]>() as usize {
                    24 as usize
            ...
            b"slipstream_server_create_stream_ctx\0".as_ptr() as *const ::core::ffi::c_char,
            ::core::ptr::null_mut::<::core::ffi::c_void>(),
        );
        return ::core::ptr::null_mut::<slipstream_server_stream_ctx_t>();
    }
    memset(
        stream_ctx as *mut ::core::ffi::c_void,
        0 as ::core::ffi::c_int,
        ::core::mem::size_of::<slipstream_server_stream_ctx_t>() as size_t,
    );
    (*stream_ctx).stream_id = stream_id;
    if pipe(&raw mut (*stream_ctx).pipefd as *mut ::core::ffi::c_int) < 0 as ::core::ffi::c_int {
        perror(b"pipe() failed\0".as_ptr() as *const ::core::ffi::c_char);
        free(stream_ctx as *mut ::core::ffi::c_void);
        return ::core::ptr::null_mut::<slipstream_server_stream_ctx_t>();
    }
    let mut sock_fd: ::core::ffi::c_int = socket(
        AF_INET,
        SOCK_STREAM as ::core::ffi::c_int,
        0 as ::core::ffi::c_int,
    );
    if sock_fd < 0 as ::core::ffi::c_int {
        perror(b"socket() failed\0".as_ptr() as *const ::core::ffi::c_char);
        close((*stream_ctx).pipefd[0 as ::core::ffi::c_int as usize]);
        close((*stream_ctx).pipefd[1 as ::core::ffi::c_int as usize]);
        free(stream_ctx as *mut ::core::ffi::c_void);
        return ::core::ptr::null_mut::<slipstream_server_stream_ctx_t>();
    }
    (*stream_ctx).fd = sock_fd;
    if (*server_ctx).first_stream.is_null() {
        (*server_ctx).first_stream = stream_ctx;
    } else {
        (*stream_ctx).next_stream =
            (*server_ctx).first_stream as *mut st_slipstream_server_stream_ctx_t;
        (*(*stream_ctx).next_stream).previous_stream =
            stream_ctx as *mut st_slipstream_server_stream_ctx_t;
        (*server_ctx).first_stream = stream_ctx;
    }
    return stream_ctx;
}
unsafe extern "C" fn slipstream_server_free_stream_context(
    mut server_ctx: *mut slipstream_server_ctx_t,
    mut stream_ctx: *mut slipstream_server_stream_ctx_t,
) {
    ...
    if (*server_ctx).first_stream == stream_ctx {
        (*server_ctx).first_stream =
            (*stream_ctx).next_stream as *mut slipstream_server_stream_ctx_t;
    }
    (*stream_ctx).fd = close((*stream_ctx).fd);
    free(stream_ctx as *mut ::core::ffi::c_void);
}
unsafe extern "C" fn slipstream_server_free_context(mut server_ctx: *mut slipstream_server_ctx_t) {
    let mut stream_ctx: *mut slipstream_server_stream_ctx_t =
        ::core::ptr::null_mut::<slipstream_server_stream_ctx_t>();
    loop {
        stream_ctx = (*server_ctx).first_stream;
        if stream_ctx.is_null() {
            break;
        }
        slipstream_server_free_stream_context(server_ctx, stream_ctx);
    }
    if !(*server_ctx).prev_ctx.is_null() {
        (*(*server_ctx).prev_ctx).next_ctx = (*server_ctx).next_ctx;
    }
    if !(*server_ctx).next_ctx.is_null() {
        (*(*server_ctx).next_ctx).prev_ctx = (*server_ctx).prev_ctx;
    }
    free(server_ctx as *mut ::core::ffi::c_void);
}
#[no_mangle]
pub unsafe extern "C" fn slipstream_server_mark_active_pass(
    mut server_ctx: *mut slipstream_server_ctx_t,
) {
    let mut stream_ctx: *mut slipstream_server_stream_ctx_t = (*server_ctx).first_stream;
    while !stream_ctx.is_null() {
        if (*stream_ctx).set_active != 0 {
            ...
            debug_printf(
                b"%s:%u [%s]: [stream_id=%d][fd=%d] activate: stream\n\0".as_ptr()
                    as *const ::core::ffi::c_char,
                (b"../src/slipstream_server.c\0".as_ptr() as *const ::core::ffi::c_char).offset(
                    (if 24 as usize > ::core::mem::size_of::<[::core::ffi::c_char; 27]>() as usize {
                        24 as usize
                ...
                b"slipstream_server_mark_active_pass\0".as_ptr() as *const ::core::ffi::c_char,
                (*stream_ctx).stream_id,
                (*stream_ctx).fd,
            );
            picoquic_mark_active_stream(
                (*server_ctx).cnx as *mut picoquic_cnx_t,
                (*stream_ctx).stream_id,
                1 as ::core::ffi::c_int,
                stream_ctx as *mut ::core::ffi::c_void,
            );
        }
        stream_ctx = (*stream_ctx).next_stream as *mut slipstream_server_stream_ctx_t;
    }
}
#[no_mangle]
pub unsafe extern "C" fn slipstream_server_sockloop_callback(
    mut quic: *mut picoquic_quic_t,
    mut cb_mode: picoquic_packet_loop_cb_enum,
    mut callback_ctx: *mut ::core::ffi::c_void,
    mut callback_arg: *mut ::core::ffi::c_void,
) -> ::core::ffi::c_int {
    let mut default_ctx: *mut slipstream_server_ctx_t =
        callback_ctx as *mut slipstream_server_ctx_t;
    let mut server_ctx: *mut slipstream_server_ctx_t =
        ::core::ptr::null_mut::<slipstream_server_ctx_t>();
    match cb_mode as ::core::ffi::c_uint {
        7 => {
            if callback_ctx.is_null() {
                return 0 as ::core::ffi::c_int;
            }
            server_ctx = (*default_ctx).next_ctx as *mut slipstream_server_ctx_t;
            while !server_ctx.is_null() {
                slipstream_server_mark_active_pass(server_ctx);
                server_ctx = (*server_ctx).next_ctx as *mut slipstream_server_ctx_t;
            }
        }
        1 => {
            if should_shutdown != 0 {
                ...
                if !has_unclosed {
                    debug_printf(
                        ...
                        b"slipstream_server_sockloop_callback\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        ::core::ptr::null_mut::<::core::ffi::c_void>(),
                    );
...
#[no_mangle]
pub unsafe extern "C" fn slipstream_server_poller(
    mut arg: *mut ::core::ffi::c_void,
) -> *mut ::core::ffi::c_void {
    let mut args: *mut slipstream_server_poller_args = arg as *mut slipstream_server_poller_args;
    loop {
        ...
        if ret < 0 as ::core::ffi::c_int {
            ...
            if fds.revents as ::core::ffi::c_int & POLLNVAL != 0 {
                printf(
                    b"File descriptor %d was closed\n\0".as_ptr() as *const ::core::ffi::c_char,
                    fds.fd,
                );
                break;
            } else {
                ...
                if ret != 0 as ::core::ffi::c_int {
                    debug_printf(
                        b"%s:%u [%s]: poll: could not wake up network thread, ret = %d\n\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        (b"../src/slipstream_server.c\0".as_ptr() as *const ::core::ffi::c_char)
                            .offset(
                                (if 24 as usize
                        ...
                        b"slipstream_server_poller\0".as_ptr() as *const ::core::ffi::c_char,
                        ret,
                    );
                }
                debug_printf(
                    b"%s:%u [%s]: [stream_id=%d][fd=%d] wakeup\n\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    (b"../src/slipstream_server.c\0".as_ptr() as *const ::core::ffi::c_char).offset(
                        (if 24 as usize
                            > ::core::mem::size_of::<[::core::ffi::c_char; 27]>() as usize
...
#[no_mangle]
pub unsafe extern "C" fn slipstream_io_copy(
    mut arg: *mut ::core::ffi::c_void,
) -> *mut ::core::ffi::c_void {
    let mut buffer: [::core::ffi::c_char; 1024] = [0; 1024];
    let mut args: *mut slipstream_io_copy_args = arg as *mut slipstream_io_copy_args;
    let mut pipe_0: ::core::ffi::c_int = (*args).pipe;
    let mut socket_0: ::core::ffi::c_int = (*args).socket;
    let mut server_ctx: *mut slipstream_server_ctx_t = (*args).server_ctx;
    let mut stream_ctx: *mut slipstream_server_stream_ctx_t = (*args).stream_ctx;
    let mut addr_len: socklen_t = 0;
    if (*server_ctx).upstream_addr.ss_family as ::core::ffi::c_int == AF_INET {
        addr_len = ::core::mem::size_of::<sockaddr_in>() as socklen_t;
    } else if (*server_ctx).upstream_addr.ss_family as ::core::ffi::c_int == AF_INET6 {
        addr_len = ::core::mem::size_of::<sockaddr_in6>() as socklen_t;
    } else {
        perror(b"Invalid address family\0".as_ptr() as *const ::core::ffi::c_char);
        return NULL;
    }
    printf(
        b"slipstream_io_copy: socket=%d stream_fd=%d pipe=%d family=%d\n\0".as_ptr()
            as *const ::core::ffi::c_char,
        socket_0,
        (*stream_ctx).fd,
        pipe_0,
        (*server_ctx).upstream_addr.ss_family as ::core::ffi::c_int,
    );
    if connect(
        socket_0,
        &raw mut (*server_ctx).upstream_addr as *mut sockaddr,
        addr_len,
    ) < 0 as ::core::ffi::c_int
    {
        perror(b"connect() failed\0".as_ptr() as *const ::core::ffi::c_char);
        return NULL;
    }
    debug_printf(
        b"%s:%u [%s]: [%lu:%d] setup pipe done\n\0".as_ptr() as *const ::core::ffi::c_char,
        (b"../src/slipstream_server.c\0".as_ptr() as *const ::core::ffi::c_char).offset(
            (if 24 as usize > ::core::mem::size_of::<[::core::ffi::c_char; 27]>() as usize {
                24 as usize
            } else {
        ...
        b"slipstream_io_copy\0".as_ptr() as *const ::core::ffi::c_char,
        (*stream_ctx).stream_id,
        (*stream_ctx).fd,
    );
    ::core::ptr::write_volatile(
    ...
    let mut ret: ::core::ffi::c_int =
        picoquic_wake_up_network_thread((*(*args).server_ctx).thread_ctx);
    if ret != 0 as ::core::ffi::c_int {
        debug_printf(
            b"%s:%u [%s]: poll: could not wake up network thread, ret = %d\n\0".as_ptr()
                as *const ::core::ffi::c_char,
    ...
    loop {
        ...
        if bytes_read < 0 as ssize_t {
            perror(b"recv failed\0".as_ptr() as *const ::core::ffi::c_char);
            return NULL;
        } else {
            if bytes_read == 0 as ssize_t {
                break;
            ...
            let mut remaining: ssize_t = bytes_read;
            while remaining > 0 as ssize_t {
                ...
                if bytes_written < 0 as ssize_t {
                    perror(b"send failed\0".as_ptr() as *const ::core::ffi::c_char);
                    return NULL;
                }
...
#[no_mangle]
pub unsafe extern "C" fn slipstream_server_callback(
    ...
    let mut server_ctx: *mut slipstream_server_ctx_t = callback_ctx as *mut slipstream_server_ctx_t;
    let mut stream_ctx: *mut slipstream_server_stream_ctx_t =
        v_stream_ctx as *mut slipstream_server_stream_ctx_t;
    if callback_ctx.is_null()
        || callback_ctx
            == picoquic_get_default_callback_context(picoquic_get_quic_ctx(
                cnx as *mut picoquic_cnx_t,
            ))
    {
        server_ctx = malloc(::core::mem::size_of::<slipstream_server_ctx_t>() as size_t)
            as *mut slipstream_server_ctx_t;
        if server_ctx.is_null() {
            picoquic_close(
                cnx as *mut picoquic_cnx_t,
                PICOQUIC_ERROR_MEMORY as uint64_t,
            );
            return -(1 as ::core::ffi::c_int);
        }
        let mut d_ctx: *mut slipstream_server_ctx_t = picoquic_get_default_callback_context(
            picoquic_get_quic_ctx(cnx as *mut picoquic_cnx_t),
        ) as *mut slipstream_server_ctx_t;
        if !d_ctx.is_null() {
            memcpy(
                server_ctx as *mut ::core::ffi::c_void,
                d_ctx as *const ::core::ffi::c_void,
                ::core::mem::size_of::<slipstream_server_ctx_t>() as size_t,
            );
        } else {
            memset(
                server_ctx as *mut ::core::ffi::c_void,
        ...
        if !(*d_ctx).next_ctx.is_null() {
            (*(*d_ctx).next_ctx).prev_ctx = server_ctx as *mut st_slipstream_server_ctx_t;
        }
        (*server_ctx).next_ctx = (*d_ctx).next_ctx;
        (*server_ctx).prev_ctx = d_ctx as *mut st_slipstream_server_ctx_t;
        (*d_ctx).next_ctx = server_ctx as *mut st_slipstream_server_ctx_t;
        debug_printf(
            b"%s:%u [%s]: Created ctx\n\0".as_ptr() as *const ::core::ffi::c_char,
            (b"../src/slipstream_server.c\0".as_ptr() as *const ::core::ffi::c_char).offset(
                (if 24 as usize > ::core::mem::size_of::<[::core::ffi::c_char; 27]>() as usize {
            ...
            b"slipstream_server_callback\0".as_ptr() as *const ::core::ffi::c_char,
            ::core::ptr::null_mut::<::core::ffi::c_void>(),
        );
    }
    let mut c2rust_current_block_113: u64;
    match fin_or_event as ::core::ffi::c_uint {
        0 | 1 => {
            if stream_ctx.is_null() {
                ...
                debug_printf(
                    ...
                    b"slipstream_server_callback\0".as_ptr() as *const ::core::ffi::c_char,
                    stream_id,
                    (*stream_ctx).pipefd[1 as ::core::ffi::c_int as usize],
                );
                let mut args: *mut slipstream_io_copy_args =
                    malloc(::core::mem::size_of::<slipstream_io_copy_args>() as size_t)
                        as *mut slipstream_io_copy_args;
                (*args).pipe = (*stream_ctx).pipefd[0 as ::core::ffi::c_int as usize];
            ...
            if length > 0 as size_t {
                debug_printf(
                    b"%s:%u [%s]: [stream_id=%d][leftover_length=%d]\n\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    (b"../src/slipstream_server.c\0".as_ptr() as *const ::core::ffi::c_char).offset(
                        (if 24 as usize
                            > ::core::mem::size_of::<[::core::ffi::c_char; 27]>() as usize
                ...
                let mut bytes_sent: ssize_t = write(
                    (*stream_ctx).pipefd[1 as ::core::ffi::c_int as usize],
                    bytes as *const ::core::ffi::c_void,
                    length,
                );
                debug_printf(
                    b"%s:%u [%s]: [stream_id=%d][bytes_sent=%d]\n\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    (b"../src/slipstream_server.c\0".as_ptr() as *const ::core::ffi::c_char).offset(
                        (if 24 as usize
                            > ::core::mem::size_of::<[::core::ffi::c_char; 27]>() as usize
                ...
                if bytes_sent < 0 as ssize_t {
                    if *__errno_location() == EPIPE {
                        debug_printf(
                            b"%s:%u [%s]: [stream_id=%d] send: closed stream\n\0".as_ptr()
                                as *const ::core::ffi::c_char,
                            (b"../src/slipstream_server.c\0".as_ptr() as *const ::core::ffi::c_char)
                                .offset(
                                    (if 24 as usize
                                        > ::core::mem::size_of::<[::core::ffi::c_char; 27]>()
                                            as usize
                                    {
                                        24 as usize
                                    } else {
                    ...
                    *__errno_location() == EAGAIN;
                    debug_printf(
                        b"%s:%u [%s]: [stream_id=%d] send: error: %s (%d)\n\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        (b"../src/slipstream_server.c\0".as_ptr() as *const ::core::ffi::c_char)
                            .offset(
                                (if 24 as usize
            ...
            c2rust_current_block_113 = 13349765058737954042;
        }
        3 => {
            picoquic_reset_stream(cnx as *mut picoquic_cnx_t, stream_id, 0 as uint64_t);
            c2rust_current_block_113 = 1669170578083207677;
        }
        2 => {
            c2rust_current_block_113 = 1669170578083207677;
        }
        4 | 5 | 6 => {
            ...
            picoquic_set_callback(cnx as *mut picoquic_cnx_t, None, NULL);
            picoquic_close(cnx as *mut picoquic_cnx_t, 0 as uint64_t);
        ...
        8 => {
            if stream_ctx.is_null() {
                ...
                if ret < 0 as ::core::ffi::c_int {
                    debug_printf(
                        b"%s:%u [%s]: [stream_id=%d] ioctl error: %s (%d)\n\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        (b"../src/slipstream_server.c\0".as_ptr() as *const ::core::ffi::c_char)
                            .offset(
                                (if 24 as usize
                    ...
                    if length_to_read == 0 as ::core::ffi::c_int {
                        ...
                        if *__errno_location() == EAGAIN || *__errno_location() == EWOULDBLOCK {
                            ...
                            debug_printf(
                                b"%s:%u [%s]: [stream_id=%d] recv->quic_send: empty, disactivate\n\0"
                                    .as_ptr() as *const ::core::ffi::c_char,
                                (b"../src/slipstream_server.c\0".as_ptr()
                                    as *const ::core::ffi::c_char)
                                    .offset(
                                        (if 24 as usize
                                            > ::core::mem::size_of::<[::core::ffi::c_char; 27]>()
                                ...
                                b"slipstream_server_callback\0".as_ptr()
                                    as *const ::core::ffi::c_char,
                                (*stream_ctx).stream_id,
                            );
                            let mut args_0: *mut slipstream_server_poller_args =
                                malloc(::core::mem::size_of::<slipstream_server_poller_args>()
                                    as size_t)
                                    as *mut slipstream_server_poller_args;
                            (*args_0).fd = (*stream_ctx).fd;
                            (*args_0).cnx = cnx;
                            (*args_0).server_ctx = server_ctx;
                            (*args_0).stream_ctx = stream_ctx;
                            let mut thread_0: pthread_t = 0;
                            if pthread_create(
                                &raw mut thread_0,
                                ::core::ptr::null::<pthread_attr_t>(),
                                Some(
                                    slipstream_server_poller
                                        as unsafe extern "C" fn(
                                            *mut ::core::ffi::c_void,
                                        )
                                            -> *mut ::core::ffi::c_void,
                                ),
                                args_0 as *mut ::core::ffi::c_void,
                            ) != 0 as ::core::ffi::c_int
                            {
                                perror(b"pthread_create() failed for thread1\0".as_ptr()
                                    as *const ::core::ffi::c_char);
                                free(args_0 as *mut ::core::ffi::c_void);
                            }
                            pthread_setname_np(
                                thread_0,
                        ...
                        if bytes_read == 0 as ssize_t {
                            debug_printf(
                                b"%s:%u [%s]: [stream_id=%d] recv: closed stream\n\0".as_ptr()
                                    as *const ::core::ffi::c_char,
                                (b"../src/slipstream_server.c\0".as_ptr()
                                    as *const ::core::ffi::c_char)
                                    .offset(
                        ...
                        if !buffer.is_null() {
                            ...
                            if bytes_read_0 == 0 as ssize_t {
                                debug_printf(
                                    b"%s:%u [%s]: Closed connection on sock %d on recv\n\0".as_ptr()
                                        as *const ::core::ffi::c_char,
                                    (b"../src/slipstream_server.c\0".as_ptr()
                                        as *const ::core::ffi::c_char)
                                        .offset(
        ...
        9 => {
            debug_printf(
                b"%s:%u [%s]: Connection completed, almost ready\n\0".as_ptr()
                    as *const ::core::ffi::c_char,
                (b"../src/slipstream_server.c\0".as_ptr() as *const ::core::ffi::c_char).offset(
                    (if 24 as usize > ::core::mem::size_of::<[::core::ffi::c_char; 27]>() as usize {
                        24 as usize
    ...
    match c2rust_current_block_113 {
        1669170578083207677 => {
            if !stream_ctx.is_null() {
                debug_printf(
                    b"%s:%u [%s]: [stream_id=%d] stream reset\n\0".as_ptr()
                        as *const ::core::ffi::c_char,
                    (b"../src/slipstream_server.c\0".as_ptr() as *const ::core::ffi::c_char).offset(
                        (if 24 as usize
                            > ::core::mem::size_of::<[::core::ffi::c_char; 27]>() as usize
...
#[no_mangle]
pub unsafe extern "C" fn picoquic_slipstream_server(
    mut server_port: ::core::ffi::c_int,
    mut listen_ipv6: bool,
    mut server_cert: *const ::core::ffi::c_char,
    mut server_key: *const ::core::ffi::c_char,
    mut target_address: *mut sockaddr_storage,
    mut domain_name: *const ::core::ffi::c_char,
) -> ::core::ffi::c_int {
    let mut ret: ::core::ffi::c_int = 0 as ::core::ffi::c_int;
    let mut current_time: uint64_t = 0 as uint64_t;
    let mut default_context: slipstream_server_ctx_t = st_slipstream_server_ctx_t {
        cnx: ::core::ptr::null_mut::<picoquic_cnx_t>(),
        first_stream: ::core::ptr::null_mut::<slipstream_server_stream_ctx_t>(),
        thread_ctx: ::core::ptr::null_mut::<picoquic_network_thread_ctx_t>(),
        upstream_addr: sockaddr_storage {
            ss_family: 0,
            __ss_padding: [0; 118],
            __ss_align: 0,
        },
        prev_ctx: ::core::ptr::null_mut::<st_slipstream_server_ctx_t>(),
        next_ctx: ::core::ptr::null_mut::<st_slipstream_server_ctx_t>(),
    };
    memcpy(
        &raw mut default_context.upstream_addr as *mut ::core::ffi::c_void,
        target_address as *const ::core::ffi::c_void,
        ::core::mem::size_of::<sockaddr_storage>() as size_t,
    );
    server_domain_name = strdup(domain_name);
    server_domain_name_len = strlen(domain_name);
    let mut mtu: ::core::ffi::c_int = 900 as ::core::ffi::c_int;
    ...
    let mut quic: *mut picoquic_quic_t = picoquic_create_and_configure(
        ...
        &raw mut default_context as *mut ::core::ffi::c_void,
        current_time,
        ::core::ptr::null_mut::<uint64_t>(),
    );
    if quic.is_null() {
        debug_printf(
            b"%s:%u [%s]: Could not create server context\n\0".as_ptr()
                as *const ::core::ffi::c_char,
            (b"../src/slipstream_server.c\0".as_ptr() as *const ::core::ffi::c_char).offset(
                (if 24 as usize > ::core::mem::size_of::<[::core::ffi::c_char; 27]>() as usize {
                    24 as usize
            ...
            b"picoquic_slipstream_server\0".as_ptr() as *const ::core::ffi::c_char,
            ::core::ptr::null_mut::<::core::ffi::c_void>(),
        );
        return -(1 as ::core::ffi::c_int);
    }
    ...
    picoquic_set_default_congestion_algorithm(
        ...
        slipstream_server_cc_algorithm,
    );
    ...
    param.local_port = server_port as uint16_t;
    param.do_not_use_gso = 1 as ::core::ffi::c_int;
    param.is_client = 0 as ::core::ffi::c_int;
    param.decode = Some(
        server_decode
            as unsafe extern "C" fn(
                *mut ::core::ffi::c_void,
    ...
    thread_ctx.loop_callback = Some(
        slipstream_server_sockloop_callback
            as unsafe extern "C" fn(
                *mut picoquic_quic_t,
                picoquic_packet_loop_cb_enum,
                *mut ::core::ffi::c_void,
    ...
    thread_ctx.loop_callback_ctx = &raw mut default_context as *mut ::core::ffi::c_void;
    picoquic_open_network_wake_up(&raw mut thread_ctx, &raw mut ret);
    default_context.thread_ctx = &raw mut thread_ctx;
    signal(
        SIGTERM,
        Some(server_sighandler as unsafe extern "C" fn(::core::ffi::c_int) -> ()),
    );
    slipstream_packet_loop(&raw mut thread_ctx);
    ret = thread_ctx.return_code;
    debug_printf(
        b"%s:%u [%s]: Server exit, ret = %d\n\0".as_ptr() as *const ::core::ffi::c_char,
        (b"../src/slipstream_server.c\0".as_ptr() as *const ::core::ffi::c_char).offset(
            (if 24 as usize > ::core::mem::size_of::<[::core::ffi::c_char; 27]>() as usize {
                24 as usize
            } else {
