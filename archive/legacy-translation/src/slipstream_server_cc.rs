...
pub type slipstream_server_cc_alg_state_t = ::core::ffi::c_uint;
pub const slipstream_server_cc_alg_none: slipstream_server_cc_alg_state_t = 0;
pub type slipstream_server_cc_t = st_slipstream_server_cc_t;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct st_slipstream_server_cc_t {
    pub state: slipstream_server_cc_alg_state_t,
}
pub const UINT64_MAX: ::core::ffi::c_ulong = 18446744073709551615 as ::core::ffi::c_ulong;
pub const NULL: *mut ::core::ffi::c_void =
    ::core::ptr::null::<::core::ffi::c_void>() as *mut ::core::ffi::c_void;
unsafe extern "C" fn slipstream_server_cc_init(
    mut cnx: *mut picoquic_cnx_t,
    mut path_x: *mut picoquic_path_t,
    mut current_time: uint64_t,
) {
    let mut state: *mut slipstream_server_cc_t =
        malloc(::core::mem::size_of::<slipstream_server_cc_t>() as size_t)
            as *mut slipstream_server_cc_t;
    (*path_x).congestion_alg_state = state as *mut ::core::ffi::c_void;
}
unsafe extern "C" fn slipstream_server_cc_notify(
    mut cnx: *mut picoquic_cnx_t,
    mut path_x: *mut picoquic_path_t,
    ...
    (*path_x).cwin = UINT64_MAX as uint64_t;
}
unsafe extern "C" fn slipstream_server_cc_delete(mut path_x: *mut picoquic_path_t) {
    if !(*path_x).congestion_alg_state.is_null() {
        free((*path_x).congestion_alg_state);
        (*path_x).congestion_alg_state = NULL;
    }
}
unsafe extern "C" fn slipstream_server_cc_observe(
    mut path_x: *mut picoquic_path_t,
    mut cc_state: *mut uint64_t,
    mut cc_param: *mut uint64_t,
) {
    let mut state: *mut slipstream_server_cc_t =
        (*path_x).congestion_alg_state as *mut slipstream_server_cc_t;
    *cc_state = (*state).state as uint64_t;
    *cc_param = UINT64_MAX as uint64_t;
}
pub const picoquic_slipstream_server_cc_ID: [::core::ffi::c_char; 18] = unsafe {
    ::core::mem::transmute::<[u8; 18], [::core::ffi::c_char; 18]>(*b"slipstream_server\0")
};
pub const PICOQUIC_CC_ALGO_NUMBER_SLIPSTREAM_SERVER: ::core::ffi::c_int = 10 as ::core::ffi::c_int;
#[no_mangle]
pub static mut slipstream_server_cc_algorithm_struct: picoquic_congestion_algorithm_t = unsafe {
    st_picoquic_congestion_algorithm_t {
        congestion_algorithm_id: picoquic_slipstream_server_cc_ID.as_ptr(),
        congestion_algorithm_number: PICOQUIC_CC_ALGO_NUMBER_SLIPSTREAM_SERVER as uint8_t,
        alg_init: Some(
        ...
        alg_delete: Some(
            slipstream_server_cc_delete as unsafe extern "C" fn(*mut picoquic_path_t) -> (),
        ),
        alg_observe: Some(
...
#[no_mangle]
pub static mut slipstream_server_cc_algorithm: *mut picoquic_congestion_algorithm_t = unsafe {
    &raw const slipstream_server_cc_algorithm_struct as *mut picoquic_congestion_algorithm_t
};
